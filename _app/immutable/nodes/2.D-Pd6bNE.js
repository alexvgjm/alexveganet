import{_ as ht}from"../chunks/preload-helper.D6kgxu3v.js";import{s as Q,n as S,o as ce,x as ze,b as N,d as ft,y as ke,u as mt,g as dt,e as gt,r as pt,z as _t}from"../chunks/scheduler.CaHUfm9I.js";import{S as J,i as K,e as E,c as b,y as B,o as f,g as v,d as h,t as R,s as C,a as $,b as F,f as O,h as g,j as ct,z as Xe,H as vt,A as $t,B as ie,n as T,l as D,C as L,D as q,p as se,u as A,v as M,w as I,x as H,E as nt}from"../chunks/index.B8kFTOav.js";function Ce(n){return(n==null?void 0:n.length)!==void 0?n:Array.from(n)}function Et(n){let e,t=`<h1 class="hero__title svelte-1lsr2wm">Álex Vega</h1> <h2 class="hero__subtitle svelte-1lsr2wm">Formación y consultoría</h2> <p class="hero__description svelte-1lsr2wm"><strong>Desarrollo web</strong>, 
    ...
    `),f(c,"class","obstacles__bolt"),se(c,"stroke","var(--color-font-primary)"),f(c,"d",` m 380 148.5
			...
			tan rápidamente`}];let r=-1;function c(){t(3,a=Math.max(...l.map(P=>P.getBoundingClientRect().height)))}function u(){c(),o=l.findIndex(P=>+P.getAttribute("data-n")==4)-1,o<0&&(o=l.length-1),t(2,s=(s+1)%i.length)}function m(){c(),o=l.findIndex(P=>+P.getAttribute("data-n")==4),o=(o+1)%i.length,t(2,s=s==0?l.length-1:s-1)}ce(()=>{r=setInterval(u,1e4),u()}),ze(()=>{clearInterval(r)});let p;function _(P){const k=P.clientX,ve=window.innerWidth,X=l[o].getBoundingClientRect(),Oe=X.left,W=X.right;k+30<=Oe||k<40?t(1,p="LEFT"):k-30>=W||k>ve-40?t(1,p="RIGHT"):t(1,p="CENTER")}function y(){clearInterval(r),r=setInterval(u,1e4),p!="CENTER"&&(p=="LEFT"?m():u())}function w(P,k){N[P?"unshift":"push"](()=>{l[k]=P,t(0,l)})}return t(2,s=0),o=0,t(3,a=130),t(1,p="CENTER"),[l,p,s,a,i,_,y,w]}class Ut extends J{constructor(e){super(),K(this,e,Gt,Nt,Q,{})}}function Vt(n){let e,t,s,o,a,l;return{c(){e=E("div"),t=E("img"),o=C(),a=E("img"),this.h()},l(i){e=b(i,"DIV",{class:!0});var r=$(e);t=b(r,"IMG",{class:!0,src:!0,alt:!0}),o=O(r),a=b(r,"IMG",{class:!0,src:!0,alt:!0}),r.forEach(h),this.h()},h(){f(t,"class","heart-hands__left svelte-1g6aiia"),ke(t.src,s="/left-hand.svg")||f(t,"src",s),f(t,"alt",""),f(a,"class","heart-hands__right svelte-1g6aiia"),ke(a.src,l="/right-hand.svg")||f(a,"src",l),f(a,"alt",""),f(e,"class","heart-hands svelte-1g6aiia")},m(i,r){v(i,e,r),g(e,t),n[2](t),g(e,o),g(e,a),n[3](a)},p:S,i:S,o:S,d(i){i&&h(e),n[2](null),n[3](null)}}}function Xt(n,e,t){let s,o;ce(()=>{Qe({selectorOrElements:[s,o],screenPercent:.9,elseClasses:["separated"]})});function a(i){N[i?"unshift":"push"](()=>{s=i,t(0,s)})}function l(i){N[i?"unshift":"push"](()=>{o=i,t(1,o)})}return[s,o,a,l]}class Yt extends J{constructor(e){super(),K(this,e,Xt,Vt,Q,{})}}function Qt(n){let e,t,s="pairing",o;return{c(){e=R(`Para estudiantes de todos los niveles y para juniors recién 
			...
			incorporados al mundo profesional, formando y dando soporte en su
			trabajo mediante `),t=b(a,"STRONG",{class:!0,"data-svelte-h":!0}),B(t)!=="svelte-sdcs7q"&&(t.textContent=s),o=F(a,"."),this.h()},h(){f(t,"class","svelte-1cz8zhj")},m(a,l){v(a,e,l),v(a,t,l),v(a,o,l)},p:S,d(a){a&&(h(e),h(t),h(o))}}}function Jt(n){let e,t,s="principios ágiles",o;return{c(){e=R(`Me integro con equipos que necesitan tecnologías o metodologías con
			...
			y adaptándome a sus objetivos.`),this.h()},h(){f(t,"class","svelte-1cz8zhj")},m(a,l){v(a,e,l),v(a,t,l),v(a,o,l)},p:S,d(a){a&&(h(e),h(t),h(o))}}}function Kt(n){let e;return{c(){e=R(`Acorde al estado del arte y el mercado laboral, para particulares o 
			...
			mejorando procesos y toma de decisiones.`),this.h()},h(){f(t,"class","svelte-1cz8zhj"),f(a,"class","svelte-1cz8zhj"),f(r,"class","svelte-1cz8zhj")},m(m,p){v(m,e,p),v(m,t,p),v(m,o,p),v(m,a,p),v(m,i,p),v(m,r,p),v(m,u,p)},p:S,d(m){m&&(h(e),h(t),h(o),h(a),h(i),h(r),h(u))}}}function en(n){let e,t,s="armonizar equipos",o,a,l=`gestión de requisitos y 
			...
			y la calidad de desarrollo.`),this.h()},h(){f(t,"class","svelte-1cz8zhj"),f(a,"class","svelte-1cz8zhj"),f(r,"class","svelte-1cz8zhj")},m(m,p){v(m,e,p),v(m,t,p),v(m,o,p),v(m,a,p),v(m,i,p),v(m,r,p),v(m,u,p)},p:S,d(m){m&&(h(e),h(t),h(o),h(a),h(i),h(r),h(u))}}}function tn(n){let e,t,s,o,a,l,i="Formación con metodologías ágiles",r,c,u=`La agilidad no se trata de rapidez, sino de la capacidad
		para adaptarse a nuevos requisitos y sortear obstáculos`,m,p,_,y,w,P,k,ve,G,X,Oe,W,Je="Consultoría",Te,Y,ae,De,le,Ae,re,Se,j,ue,Me,$e,Ke="Mi camino reciente",Ie,Ee,We=`Aquellos conocimientos y tecnologías que he utilizado o impartido en los últimos 4 años.
