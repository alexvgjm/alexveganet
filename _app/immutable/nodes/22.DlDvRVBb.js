import"../chunks/CWj6FrbW.js";import{o as X}from"../chunks/k_-SACZf.js";import{p as ee,f as m,a as P,s as n,d as k,t as oe,b as i,c as te,r as x,n as p,m as ae,o as se,h as I,g as M}from"../chunks/BduZyM7k.js";import{r as re}from"../chunks/CJDWlBBp.js";import{s as ne}from"../chunks/BSOZMg1Q.js";import{C as d,c as ie,b as le}from"../chunks/49ULR90T.js";import{b as ce}from"../chunks/DzBwx_jc.js";import{u as de,V as U,v as me,n as V,m as N,c as F,F as he,p as A,a as pe,D as ue,b as fe,M as z,B as H,d as O,e as ge}from"../chunks/CAlu0Wgt.js";import{C as q}from"../chunks/DlsCqhfG.js";import{H as we}from"../chunks/rBwrARmC.js";import{u as ve}from"../chunks/bJGP4r0Y.js";var be=m('<h2 class="example-title">Vertex position modification with TSL | Look at | Billboard case</h2>'),ye=m(`<p>In this scene, we have a 🟨 cube (a 3D equirectangular shape with eight vertices) that is always facing <small>(z-facing)</small> the camera — a billboard effect performed on the GPU.
  ...
  As far as I know, you should avoid using <code>cameraPosition</code> in this case.</dd> <dt>Q: Why perform <code>lookAt</code> on the GPU? We already have <code>lookAt</code> on the CPU, and its transform matrix is used by the GPU anyway.</dt> <dd>A: Who knows? Think about extreme cases — like a CPU state based particle system. Iterating over a million object matrices on the CPU to perform a <code>lookAt</code> 60 times per second doesn't sound so good.</dd> <dt>Q: Can I use this with <code>InstancedMesh</code>?</dt> <dd>A: Yes, but it requires some tweaks. Currently, the look vector uses the <code>modelPosition</code> instead of the per-instance position.
            I'm not sure if TSL exposes the instance base position directly. If not, you can pass it as a custom attribute.</dd></dl>`),xe=m('<canvas></canvas> <header class="example-header"><!></header> <main><!> <!> <!> <!></main>',1);function Ve(D,R){ee(R,!0);let u,f=se(!1);X(()=>{E(),we.highlightAll();const e=Array.from(document.querySelectorAll(".hljs-comment")),t=e.filter(a=>{var s;return(s=a.textContent)==null?void 0:s.includes("THE IMPORTANT PART")}),o=e.filter(a=>{var s;return(s=a.textContent)==null?void 0:s.includes("-------------------------")});console.log({importantComment:t,dashedLinesComment:o}),o.forEach(a=>a.style.setProperty("color","#ff0","important")),t.forEach(a=>a.style.setProperty("color","#ff0","important"))});const g=de(new U);function E(){const{camera:e,orbitControls:t,renderer:o,scene:a,clock:s,lights:c}=ie(u,{centerOrbits:!0,cameraHeight:10});t.autoRotate=!0,t.autoRotateSpeed=1,c.pointLights.forEach(h=>a.remove(h)),c.ambientLight.intensity=.2;const l=B(),r=new ue;r.position.set(10,15,12),r.target=l,r.castShadow=!0,r.shadow.camera.left=-12,r.shadow.camera.right=12,r.shadow.camera.top=12,r.shadow.camera.bottom=-12,r.shadow.bias=-.001,r.shadow.mapSize.set(1024,1024),t.enableZoom=!0,t.target.set(0,0,0);const Z=new fe(r,2,"yellow");a.add(Z),a.add(r);function K(){const h=Math.min(.03,s.getDelta());t.update(h),e.getWorldPosition(g.value),I(f)&&g.value.add(new U(5,5,1)),l.rotation.x+=h*.5,o.render(a,e)}o.setAnimationLoop(K);const y=new z(new H(20,1,20),new O({color:"gray"}));y.position.set(0,-1,0),y.receiveShadow=!0,a.add(y,l)}const G=me(0,1,0).toVar(),w=V(g.sub(N)).toVar(),_=V(F(G,w)).toVar(),Q=F(w,_).toVar(),j=he(()=>{const e=_.mul(A.x).add(Q.mul(A.y)).add(w.mul(A.z)),t=N.add(e);return pe.mul(t)});function B(){const e=new H,t=new O({color:"orange"});t.positionNode=j(),t.normalNode=ge;const o=new z(e,t);return o.position.set(0,2,0),o.castShadow=!0,o}var T=xe(),$=P(T);ce($,e=>u=e,()=>u);var v=n($,2),J=k(v);d(J,{children:(e,t)=>{var o=be();i(e,o)}}),x(v);var b=n(v,2);let S;var C=k(b);d(C,{title:"What is shown here",children:(e,t)=>{var o=ye(),a=n(P(o),2),s=k(a);re(s),p(2),x(a),p(2),le(s,()=>I(f),c=>ae(f,c)),i(e,o)}});var L=n(C,2);d(L,{title:"Material creation",children:(e,t)=>{var o=Pe(),a=n(P(o),2);q(a,{language:"TypeScript",children:(s,c)=>{p();var l=M();l.nodeValue=`export const lookAtTargetUniform = uniform(new Vector3())
...
export const lookAtPositionFn = Fn(() => {
...
})`,i(s,l)},$$slots:{default:!0}}),i(e,o)}});var W=n(L,2);d(W,{title:"Usage",children:(e,t)=>{q(e,{language:"TypeScript",children:(o,a)=>{p();var s=M();s.nodeValue=`    const material = new MeshStandardNodeMaterial() // or any NodeMaterial
    ...
    camera.getWorldPosition(lookAtTargetUniform.value)`,i(o,s)},$$slots:{default:!0}})}});var Y=n(W,2);d(Y,{title:"F.A.Q",children:(e,t)=>{var o=ke();i(e,o)}}),x(b),oe(e=>S=ne(b,1,"example-info",null,S,e),[()=>({"show-info":ve.showInfo})]),i(D,T),te()}export{Ve as component};
