import{f as y,t as r,a as o}from"../chunks/C8u6z3Tc.js";import{p as j,u as S,s,f as P,a as _,n as t}from"../chunks/Cpbaq3x5.js";import{I as q}from"../chunks/BS3TpUoV.js";import{C as i}from"../chunks/DdkXf41n.js";import{u as w}from"../chunks/eJOsRxFa.js";var E=y(`<p>Si ya tienes algo de experiencia con esto, puede que sepas que 
    "create" es en realidad un alias, ¿sabrías explicar qué es lo que hace realmente?</p>`),L=y(`<h1>⚙️ Instalación y configuración de GSAP</h1> <p>Podemos instalar GSAP mediante CDN (❌ no recomendado) o como una dependencia en
...
exports de ECMAScript Modules (ESM).</p> <!>`,1);function D($,b){j(b,!0),S(()=>{w().hljs.highlightAll()});var l=L(),d=s(P(l),10);i(d,{language:"HTML",children:(a,n)=>{t();var e=r();e.nodeValue=`...
<body>
    ...
