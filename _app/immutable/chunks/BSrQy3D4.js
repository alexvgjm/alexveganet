...
o competir.</p>`,1);function Aa(o,e){D(e,!1);const a=Ne();function s(){ee(a,!F(a)),V.getInstance().showHelpers(F(a))}Ue(()=>{},()=>{ee(a,!0)}),He(),U();var n=Ea(),r=d(w(n),14);wa(r,{id:"free-light-example-canvas",get sceneManager(){return V}});var c=d(r,2),l=x(c);z(c);var p=d(c,14);y(p,{language:"TypeScript",children:(q,$)=>{t();var S=b();S.nodeValue=`const sun = new DirectionalLight('#ffffff', 2)
...
Aquí una screenshot:</p> <!>`,1);function io(o,e){D(e,!1),pe(()=>{Ee("rect",{target:"#example-target",strokeWidth:4,strokeColor:"#3f37",padding:2})}),U();var a=ro(),s=d(w(a),10),n=d(x(s));W(n,{children:(f,A)=>{var h=so();i(f,h)},$$slots:{default:!0}}),t(),z(s);var r=d(s,4);E(r,{children:(f,A)=>{var h=no();i(f,h)},$$slots:{default:!0}});var c=d(r,4);y(c,{language:"TypeScript",children:(f,A)=>{t();var h=b();h.nodeValue="create(shape: ShapeName, {target: string | HTMLElement})",i(f,h)},$$slots:{default:!0}});var l=d(c,12);y(l,{language:"TypeScript",children:(f,A)=>{t();var h=b();h.nodeValue=`describe('create(...)', ()=>{
    ...
    it('creates an SVG and appends it to the body', ()=>{
        ...
    })
})`,i(f,h)},$$slots:{default:!0}});var p=d(l,12),u=d(x(p));W(u,{children:(f,A)=>{t();var h=b("Cosexa Pgropia™");i(f,h)},$$slots:{default:!0}}),t(),z(p);var g=d(p,6);y(g,{language:"TypeScript",children:(f,A)=>{t();var h=b();h.nodeValue=`describe("create('rect', {...})", ()=> {
    ...
...
})`,i(f,h)},$$slots:{default:!0}});var q=d(g,4);ne(q,{gap:4,$$slots:{left:(f,A)=>{y(f,{slot:"left",language:"HTML",children:(h,B)=>{t();var _=b();_.nodeValue='<div class="test-box"></div>',i(h,_)},$$slots:{default:!0}})},right:(f,A)=>{y(f,{slot:"right",language:"CSS",children:(h,B)=>{t();var _=b();_.nodeValue=`.test-box {
    background: #333;
    width: 250px;
    height: 150px;
}`,i(h,_)},$$slots:{default:!0}})}}});var $=d(q,2);ce($,{width:250,height:150});var S=d($,4);ne(S,{gap:4,$$slots:{left:(f,A)=>{y(f,{slot:"left",language:"HTML",children:(h,B)=>{t();var _=b();_.nodeValue='<div class="test-box test-box--expected"></div>',i(h,_)},$$slots:{default:!0}})},right:(f,A)=>{y(f,{slot:"right",language:"CSS",children:(h,B)=>{t();var _=b();_.nodeValue=`...
.test-box--expected {
    box-sizing: content-box;
    border: 4px solid orange;
}
`,i(h,_)},$$slots:{default:!0}})}}});var X=d(S,2);ce(X,{width:250,height:150,showBorder:!0});var K=d(X,14);y(K,{language:"TypeScript",children:(f,A)=>{t();var h=b();h.nodeValue="it(`creates an orange rect of 4px width around target (${xW}x${xH})`, async ({ page }) => {\n    await comparePages({\n        testingURL: `/${xW}x${xH}`,\n        expectedURL: `/expected/rect/${xW}x${xH}-default`,\n        action: () => {\n            return page.evaluate(() => {\n                pio.create('rect', {target: `.test-box--${xW}x${xH}`})\n            })\n        }\n    })\n})",i(f,h)},$$slots:{default:!0}});var J=d(K,6);L(J,{get src(){return oo},alt:"Test report de Playwright mostrando resultado actual y esperado con slider"});var Q=d(J,2);E(Q,{children:(f,A)=>{t();var h=b(`Lamentablemente Playwright no tiene una función tan mágica y bonita como
...
leyendo este blog, para empezar.`);i(p,g)},$$slots:{default:!0}});var c=d(r,18),l=d(x(c),5);Ae(l,{children:(p,u)=>{t();var g=b("déjame un comentario");i(p,g)},$$slots:{default:!0}}),t(),z(c),i(o,e)}const xo=Object.freeze(Object.defineProperty({__proto__:null,default:wo,metadata:Le},Symbol.toStringTag,{value:"Module"})),Te={title:"Sobre las consecuencias y su recurrencia",slug:"sobre-consecuencias-y-su-recurrencia",coverImage:"",excerpt:"Es terriblemente cruel el modo en que la sociedad, incluso en nombre de la moral o la prudencia, ejerce esa vigilancia eterna; el modo en el que el pasado se convierte en presente renovado.",date:"2025-04-07T01:09:04.325Z",updated:"2025-04-07T01:09:04.326Z",hidden:!1,tags:["Personal","Salud mental"],keywords:[],type:"default"},{title:yi,slug:ji,coverImage:wi,excerpt:xi,date:zi,updated:Ei,hidden:Ai,tags:_i,keywords:Si,type:$i}=Te;var zo=m(`<p>Actualmente un conocido se está enfrentando a consecuencias de actos que le
