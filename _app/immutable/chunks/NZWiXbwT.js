var Ie=Object.defineProperty;var Me=(o,e,a)=>e in o?Ie(o,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):o[e]=a;var v=(o,e,a)=>Me(o,typeof e!="symbol"?e+"":e,a);import"./CWj6FrbW.js";import"./69_IOA4Y.js";import{f as m,s as d,a as w,b as i,n as t,p as D,t as I,c as M,aI as Ue,aJ as He,g as b,m as ee,T as Ne,d as x,r as z,h as F,K as ue,al as Be,a5 as Fe}from"./D6lclsr7.js";import{I as E}from"./906axlLU.js";import{s as O}from"./be-IE9As.js";import{e as Ye}from"./ACuAKHAZ.js";import{i as U}from"./c-Y5sQDX.js";import{o as pe,a as Ge}from"./CKr1QB4i.js";import{s as We}from"./D45KK41n.js";import{p as C}from"./BOusXc13.js";import{q as Ze,cS as Xe,ao as Ke,cT as Je,cU as Qe,cV as ea,K as aa,c6 as ae,f as oe,am as Y,cj as se,aA as oa,cW as sa,cQ as na,V as ra,A as ia,ch as ta}from"./DSMWHmMA.js";import{C as y}from"./BOe4pad0.js";import{I as L}from"./BN-p2LMV.js";import{s as me}from"./PX4X-f7F.js";import{C as ne}from"./DdZH65b0.js";import{s as la}from"./jfKew5hu.js";import{s as da}from"./FAXpU9HL.js";const ge={title:"Autonomía y ajenidad (parte 1)",slug:"autonomia-ajenidad-1",coverImage:"/src/assets/posts-covers/starfish.jpg",coverPosition:"normal",coverAuthor:"Pedro Lastra",excerpt:"El trabajador autónomo no existe y el trabajo no es un orgullo.",date:"2024-08-24T13:06:23.177Z",updated:"2024-08-24T13:06:23.903Z",hidden:!1,tags:["Personal","Laboral","Software libre"],keywords:["trabajo","autónomo"],type:"default"},{title:Hs,slug:Ns,coverImage:Bs,coverPosition:Fs,coverAuthor:Ys,excerpt:Gs,date:Ws,updated:Zs,hidden:Xs,tags:Ks,keywords:Js,type:Qs}=ge;var ca=m(`<p>NOTA: Dead Cells no es libre, es software privativo. No entraré en el 
...
mayoría dada la libertad de libre distribución.</p>`,1),ua=m(`<p>Opinión algo impopular: el trabajador autónomo no existe y el trabajo no es un
...
fuego por ninguna empresa ni sus caras visibles.</p>`,1);function ha(o){var e=ba(),a=w(e);E(a,{children:(s,n)=>{t();var r=ga();t(),i(s,r)},$$slots:{default:!0}}),t(60),i(o,e)}const va=Object.freeze(Object.defineProperty({__proto__:null,default:ha,metadata:be},Symbol.toStringTag,{value:"Module"})),he={title:"Cuántas muertes evitables...",slug:"cuantas-muertes-evitables",coverAuthor:"",excerpt:"He publicado una lista de errores comunes un pelín alarmista.",date:"2025-03-27T22:38:29.122Z",updated:"2025-03-27T22:38:29.122Z",hidden:!1,tags:["TDD/BDD/ATDD","Ingeniería software"],keywords:["smells","tests"],type:"default",coverPosition:"top"},{title:gn,slug:bn,coverAuthor:hn,excerpt:vn,date:fn,updated:qn,hidden:yn,tags:jn,keywords:wn,type:xn,coverPosition:zn}=he;var fa=m(`<p>Acabo de publicar un material de presentación relacionado a prácticas que han
...
rara vez realizo porque soy muy comodón de cara a salir de las islas.</p>`,1);function qa(o){var e=fa();t(42),i(o,e)}const ya=Object.freeze(Object.defineProperty({__proto__:null,default:qa,metadata:he},Symbol.toStringTag,{value:"Module"}));var ja=m('<canvas class="three-example"></canvas>');function wa(o,e){D(e,!1);let a=C(e,"sceneManager",8),s=C(e,"id",8);pe(()=>{a().isInitialized()?location.reload():a().getInstance().startRenderLoop()}),Ge(()=>{a().dispose()}),U();var n=ja();I(()=>We(n,"id",s())),i(o,n),M()}class xa{constructor(e,a,s){v(this,"camera");v(this,"canvas");v(this,"pivot");this.camera=e,this.pivot=a,this.canvas=s,e.translateZ(30),a.rotateX(-Math.PI/8),window.addEventListener("resize",()=>this.onResize()),this.onResize()}update(e){this.pivot.rotateOnWorldAxis(new ra(0,1,0),e/20)}onResize(){const e=this.canvas.getBoundingClientRect();this.camera.aspect=e.width/e.height,this.camera.updateProjectionMatrix()}}class za extends ia{constructor(a,s){super(a,s);v(this,"freeRotationTarget");this.freeRotationTarget=new ta,this.freeRotationTarget.position.set(0,-1,0),this.add(this.freeRotationTarget),this.target=this.freeRotationTarget}restoreFreeRotation(){this.target=this.freeRotationTarget}}let P;class V{constructor(){v(this,"canvas");v(this,"scene");v(this,"renderer");v(this,"cameraControl");v(this,"sun");v(this,"clock");v(this,"hideables",[]);v(this,"rafId",-1);v(this,"accDelta",0);v(this,"resizeListenerRef");this.scene=new Ze,this.canvas=document.querySelector("#free-light-example-canvas"),this.renderer=new Xe({canvas:this.canvas,powerPreference:"high-performance",antialias:!0,alpha:!0}),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=2;const e=new Ke,a=new Je;a.add(e),this.cameraControl=new xa(e,a,this.canvas),this.scene.add(a),this.sun=new za("#ffffff",2),this.sun.position.setY(9),this.sun.castShadow=!0,this.sun.shadow.camera.left=-8,this.sun.shadow.camera.top=8,this.sun.shadow.camera.right=8,this.sun.shadow.camera.bottom=-8,this.sun.shadow.camera.far=18,this.sun.shadow.bias=1e-4,this.sun.shadow.intensity=.8,this.sun.shadow.mapSize.width=512,this.sun.shadow.mapSize.height=512;const s=new Qe(this.sun.shadow.camera),n=new ea(this.sun);this.scene.add(s),this.scene.add(n),this.scene.add(this.sun);const r=new aa("#ffffff",.2);this.scene.add(r);const c=new ae({color:new oe("#444444")}),l=new ae({color:new oe("#fd855d")}),p=new Y(new se(20,1,20),c);p.receiveShadow=!0,p.castShadow=!0;const u=new Y(new se(2,2,2),l);u.receiveShadow=!0,u.castShadow=!0,u.position.setY(5.5),this.scene.add(u);const g=new Y(new oa(3,1.5,4,24),l);g.castShadow=!0,g.receiveShadow=!0,g.position.setY(2.5),this.scene.add(g);const q=new sa(30,30,"#ffb399","#fd855d");q.material.opacity=.2,q.material.transparent=!0,q.position.setY(.51),this.scene.add(q),this.scene.add(p),this.clock=new na,this.onResize(),this.initListeners(),this.hideables=[q,s,n]}static isInitialized(){return P!==void 0}static dispose(){P&&P.dispose()}static getInstance(){return P||(P=new V),P}onResize(){const e=this.canvas.getBoundingClientRect();this.renderer.setSize(e.width,e.height)}renderLoop(){this.rafId=requestAnimationFrame(this.renderLoop.bind(this));const e=Math.min(120,this.clock.getDelta());this.render(e)}startRenderLoop(){this.renderLoop()}stopRenderLoop(){this.clock.stop(),cancelAnimationFrame(this.rafId)}render(e=33){this.accDelta+=e,this.accDelta>Math.PI*4&&(this.accDelta-=Math.PI*4,console.log("rendering")),this.sun.rotation.set(Math.sin(this.accDelta),0,Math.cos(this.accDelta/2)),this.cameraControl.update(e),this.renderer.render(this.scene,this.cameraControl.camera)}initListeners(){this.resizeListenerRef=this.onResize.bind(this),window.addEventListener("resize",this.resizeListenerRef),window.addEventListener("error",()=>{this.stopRenderLoop()})}dispose(){this.stopRenderLoop(),P=void 0}showHelpers(e=!0){this.hideables.forEach(a=>a.visible=e)}}const ve={title:"Deja de esperar por otros",slug:"deja-esperar-otros",coverImage:"/src/assets/posts-covers/jon-tyson.jpg",coverPosition:"normal",coverAuthor:"Jon Tyson",excerpt:"Hacerte tus propias herramientas puede acelerar tu trabajo, explico por qué.",date:"2024-09-13T13:00:23.177Z",updated:"2024-09-13T13:00:23.903Z",hidden:!1,tags:["Tooling","Three.js","DX"],keywords:["herramientas","esperar","Three"],type:"default",fullReload:!1},{title:En,slug:_n,coverImage:An,coverPosition:Sn,coverAuthor:$n,excerpt:Pn,date:Ln,updated:Tn,hidden:Cn,tags:Rn,keywords:kn,type:On,fullReload:Vn}=ve;var Ea=m(`<p>Hasta hace unos años me obsesionaba el tiempo, no me dejaba vivir en paz, siempre
...
o competir.</p>`,1);function _a(o,e){D(e,!1);const a=Ne();function s(){ee(a,!F(a)),V.getInstance().showHelpers(F(a))}Ue(()=>{},()=>{ee(a,!0)}),He(),U();var n=Ea(),r=d(w(n),14);wa(r,{id:"free-light-example-canvas",get sceneManager(){return V}});var c=d(r,2),l=x(c);z(c);var p=d(c,14);y(p,{language:"TypeScript",children:(q,$)=>{t();var S=b();S.nodeValue=`const sun = new DirectionalLight('#ffffff', 2)
sun.target.position.setZ(1)
sun.add(sun.target)`,i(q,S)},$$slots:{default:!0}});var u=d(p,12);y(u,{language:"TypeScript",children:(q,$)=>{t();var S=b();S.nodeValue=`class RotableDirectionalLight extends DirectionalLight {
...
}`,i(q,S)},$$slots:{default:!0}});var g=d(u,4);y(g,{language:"TypeScript",children:(q,$)=>{t();var S=b("const sun = new RotableDirectionalLight('#ffffff', 2)");i(q,S)},$$slots:{default:!0}}),t(24),I(()=>O(l,`${F(a)?"Ocultar":"Mostrar"} helpers`)),Ye("click",c,s),i(o,n),M()}const Aa=Object.freeze(Object.defineProperty({__proto__:null,default:_a,metadata:ve},Symbol.toStringTag,{value:"Module"})),fe={title:"Discursos segregacionistas",slug:"discursos-segregacionistas",coverImage:"/src/assets/posts-covers/valla.jpg",coverPosition:"normal",coverAuthor:"Alex Shuper",excerpt:"Recogiendo cable. Explico por qué no tolero ni en mí mismo algunos discursos.",date:"2024-09-07T22:06:23.177Z",updated:"2024-09-07T22:06:23.903Z",hidden:!1,tags:["Personal","Salud mental"],keywords:[],type:"default"},{title:Dn,slug:In,coverImage:Mn,coverPosition:Un,coverAuthor:Hn,excerpt:Nn,date:Bn,updated:Fn,hidden:Yn,tags:Gn,keywords:Wn,type:Zn}=fe;var Sa=m(`<p>En mi oficio es normal despertarse un día, ver código del día anterior y
...
era una de sus principales características monetizadas.</p>`,1);function Ra(o){var e=Ca(),a=w(e);E(a,{children:(l,p)=>{t();var u=b(`Entrada resubida, rescatada de tantas tonterías que escribí hace un 
...
relacionada a salud mental.`);i(l,u)},$$slots:{default:!0}});var s=d(a,22);L(s,{get src(){return La},alt:"Modelo describiendo la comunicación tradicional con Firebase",figCaption:"Modelo ideal. No válido dado que Google bloqueaba cualquier tipo de petición externa a Cloud Functions si no tenías tarjeta de crédito o débito."});var n=d(s,14);y(n,{language:"TypeScript",showLanguage:!1,children:(l,p)=>{t();var u=b();u.nodeValue=`...,
userRequests: {
...
}`,i(l,u)},$$slots:{default:!0}});var r=d(n,6);y(r,{language:"TypeScript",showLanguage:!1,children:(l,p)=>{t();var u=b();u.nodeValue=`...,
userRequests: {
    v8934sdafbi4r3vfewsjkvwevqwe: {
        request: {
            id: '4afb4ef5065a',
...
para no pasarnos de condescendientes y siempre intentar apretar lo justo.</p> <p>Es por esto que suelo recomendar a todos los profesionales acoger a alumnos en prácticas y ejercer la mentoría, mejorando estas habilidades y revisitando ideas. También suelo recomendar a empresas fomentar el trabajo en parejas (pairing) y la rotación de las mismas, de modo que todo el mundo tenga oportunidad de instruir o ser instruido, o como mínimo, de compartir ideas, formas de pensar y debatir, de mejorar su comunicación y asertividad, conociendo el trabajo de otros y creando vínculos que refuercen el crecimiento personal y del equipo, fomentando la transmisión de conocimiento.</p>`,1);function Da(o){var e=Va(),a=w(e),s=d(x(a),3);re(s,{content:"haciendo esfuerzo por resaltar una naturaleza gremial"}),t(3),z(a);var n=d(a,4);E(n,{children:(l,p)=>{t();var u=b(`Al leer "transversal", muchas personas suelen pensar en habilidades secundarias aplicables a múltiples ámbitos, que aportan pero no son vitales. Lo incorrecto aquí es pensar que 
son secundarias. Una habilidad puede ser transversal y ser a su vez la más 
importante e imprescindible en un oficio.`);i(l,u)},$$slots:{default:!0}});var r=d(n,6),c=d(x(r),3);re(c,{content:"y se debe"}),t(),z(r),t(16),i(o,e)}const Ia=Object.freeze(Object.defineProperty({__proto__:null,default:Da,metadata:ye},Symbol.toStringTag,{value:"Module"}));var Ma=Object.defineProperty,Ua=(o,e,a)=>e in o?Ma(o,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):o[e]=a,j=(o,e,a)=>Ua(o,typeof e!="symbol"?e+"":e,a);const je={className:void 0,zIndex:9999},H={strokeColor:"darkorange",fillColor:"orange",strokeWidth:4};function Ha(o){const e=document.createElementNS("http://www.w3.org/2000/svg","svg"),a={...je,...H,...o};return e.style.zIndex=a.zIndex.toString(),e.style.position="absolute",e.style.stroke=a.strokeColor,e.style.fill=a.fillColor,e.style.strokeWidth=`${a.strokeWidth}`,e.style.pointerEvents="none",e.style.strokeLinejoin="round",e.style.strokeLinecap="round",a.className&&e.classList.add(a.className),e.style.strokeWidth=a.strokeWidth+"px",e}function G(o){return document.createElementNS("http://www.w3.org/2000/svg",o)}function ie(o){return typeof o=="string"?document.querySelector(o):o}class Na{constructor(e){j(this,"destroyed",!1),j(this,"target"),j(this,"pointerElement"),j(this,"container"),j(this,"listeners"),j(this,"on",(r,c)=>{if(this.listeners[r]===void 0)return this.listeners[r]=[c];this.listeners[r].includes(c)||this.listeners[r].push(c)});const a={...je,...e},s=ie(a.container||document.body);if(!s)throw new Error(`PointItOut: container is ${s}. Check container option.`);const n=ie(e.target);if(!n)throw new Error(`PointItOut: Target is ${n}. Check target option.`);this.listeners={},this.container=s,this.target=n,this.pointerElement=Ha(e)}destroy(){var e;if(this.destroyed)throw new Error("Pointer already destroyed");this.destroyed=!0,this.pointerElement.remove(),(e=this.listeners.destroy)==null||e.forEach(a=>a(this))}}class we extends Na{constructor(e){super(e),j(this,"strokeWidth"),j(this,"strokeColor"),j(this,"fillColor");const a={...H,...e};this.strokeWidth=a.strokeWidth,this.strokeColor=a.strokeColor,this.fillColor=a.fillColor}}function xe(o,e){const a=o.getBoundingClientRect(),s=e.getBoundingClientRect(),n=a.top-s.top,r=a.left-s.left,c=n+e.scrollTop,l=r+e.scrollLeft;return{targetRect:a,containerRect:s,relativeTop:n,relativeLeft:r,targetTop:c,targetLeft:l}}const Ba=Object.freeze({"top-right":315,top:270,"top-left":225,left:180,"bottom-left":135,bottom:90,"bottom-right":45,right:0});function Fa(o){return Ba[o]}const te=Object.freeze({...H,fillColor:"none",round:0,padding:{x:0,y:0}});class Ya extends we{constructor(e){const a=Object.freeze({...te,...e});super(a),j(this,"rectElm"),j(this,"round",0),j(this,"padding"),this.rectElm=G("rect"),this.pointerElement.appendChild(this.rectElm),this.container.appendChild(this.pointerElement),this.round=e.round??te.round,typeof a.padding=="number"?this.padding={x:a.padding,y:a.padding}:this.padding={x:a.padding.x??0,y:a.padding.y??0},this.update()}update(){const{targetRect:e,targetTop:a,targetLeft:s}=xe(this.target,this.container),n=this.strokeWidth,r=e.width+n*2+this.padding.x*2,c=e.height+n*2+this.padding.y*2,l=Math.round(n/2);this.pointerElement.style.left=s-n-this.padding.x+"px",this.pointerElement.style.top=a-n-this.padding.y+"px",this.pointerElement.setAttribute("width",r.toString()),this.pointerElement.setAttribute("height",c.toString()),this.rectElm.setAttribute("x",`${l}`),this.rectElm.setAttribute("y",`${l}`),this.rectElm.setAttribute("width",`${r-n}`),this.rectElm.setAttribute("height",`${c-n}`),typeof this.round=="object"?(this.rectElm.setAttribute("rx",`${this.round.rx}`),this.rectElm.setAttribute("ry",`${this.round.ry}`)):this.rectElm.setAttribute("rx",`${this.round}`)}}function Ga(o,e,a,s){return`M${s+a/2} ${o/2+a/2} L${s+e/2+a/2} ${o+a/2} l0 -${o/3} l${e/2} 0 l0 -${o/3} l-${e/2} 0 l0 -${o/3} Z`}const Wa=Object.freeze({...H,strokeWidth:0,distance:0});class Za extends we{constructor(e){super({...Wa,...e}),j(this,"path"),j(this,"fromAngle"),j(this,"distance");const a=G("g");this.path=G("path"),a.appendChild(this.path),this.pointerElement.appendChild(a),this.container.appendChild(this.pointerElement),typeof e.fromAngle=="string"?this.fromAngle=Fa(e.fromAngle):this.fromAngle=e.fromAngle??45,this.distance=e.distance??0,this.path.setAttribute("d",Ga(96,128,this.strokeWidth,this.distance)),this.pointerElement.style.fill=this.fillColor,this.pointerElement.style.stroke=this.strokeColor,this.pointerElement.style.strokeWidth=`${this.strokeWidth==0?"none":this.strokeWidth}`,this.pointerElement.style.transformOrigin="center left",this.pointerElement.style.transform=`translateY(-50%) rotate(${this.fromAngle}deg)`,this.pointerElement.setAttribute("width",`${128+this.strokeWidth+this.distance}`),this.pointerElement.setAttribute("height",`${96+this.strokeWidth}`),this.update()}update(){const{targetRect:e,targetTop:a,targetLeft:s}=xe(this.target,this.container);this.pointerElement.style.left=s+e.width/2+"px",this.pointerElement.style.top=a+e.height/2+"px"}}const N=new Set,le=()=>{Z()},de=()=>{Z()};let T={updateOnResize:!0,updateAfterLoad:!0};typeof window<"u"&&ze(T);function Xa(o){N.delete(o)}function ze(o){return T={...T,...o},window.removeEventListener("resize",le),window.removeEventListener("load",de),T.updateOnResize&&window.addEventListener("resize",le),T.updateAfterLoad&&window.addEventListener("load",de),structuredClone(T)}function Ee(o,e){let a;return o=="rect"?a=new Ya(e):o=="arrow"&&(a=new Za(e)),a.on("destroy",Xa),N.add(a),a}function Ka(){N.forEach(o=>o.destroy())}function Z(){N.forEach(o=>o.update())}const vr=Object.freeze(Object.defineProperty({__proto__:null,clear:Ka,config:ze,create:Ee,update:Z},Symbol.toStringTag,{value:"Module"}));var Ja=m('<span class="no-wrap svelte-49cqox"><!></span>');function W(o,e){var a=Ja(),s=x(a);me(s,e,"default",{}),z(a),i(o,a)}var Qa=m('<span class="line-through svelte-kze7de"><!></span>');function _e(o,e){var a=Qa(),s=x(a);me(s,e,"default",{}),z(a),i(o,a)}var eo=m('<div class="example svelte-1e8u39k"><div></div></div>');function ce(o,e){let a=C(e,"width",8,250),s=C(e,"height",8,150),n=C(e,"showBorder",8,!1);var r=eo(),c=x(r);let l;z(r),I(p=>{l=la(c,1,"test-box svelte-1e8u39k",null,l,p),da(c,`width: ${a()??""}px; height: ${s()??""}px`)},[()=>({"test-box--expected":n()})],ue),i(o,r)}const ao=""+new URL("../assets/visual-specs-index.DUyx9Wot.png",import.meta.url).href,oo=""+new URL("../assets/captura-error.DS5ipSG-.png",import.meta.url).href,Ae={title:"Especificación visual. Caso Point it out!",slug:"especificacion-visual-caso-point-it-out",coverImage:"/src/assets/posts-covers/pio-round-fail-test.png",coverAuthor:"",excerpt:"Caso de un proyecto en activo para el que repaso el concepto de regresión visual y especificación visual. Contenido denso.",date:"2024-07-25T15:06:23.177Z",updated:"2024-07-25T15:06:23.903Z",hidden:!1,tags:["TDD/BDD/ATDD","Tooling","DX"],keywords:["svg","regresión visual","visual testing"],type:"default",coverPosition:"top"},{title:fr,slug:qr,coverImage:yr,coverAuthor:jr,excerpt:wr,date:xr,updated:zr,hidden:Er,tags:_r,keywords:Ar,type:Sr,coverPosition:$r}=Ae;var so=m('<span id="example-target" class="hl">estas palabras</span>'),no=m(`<p>AVISO: ¿Estás buscando un tutorial paso a paso de cómo
...
de la especificación visual.</p>`),ro=m(`<p>He tenido la necesidad de crear formas posicionables sobre sitios web,
...
Aquí una screenshot:</p> <!>`,1);function io(o,e){D(e,!1),pe(()=>{Ee("rect",{target:"#example-target",strokeWidth:4,strokeColor:"#3f37",padding:2})}),U();var a=ro(),s=d(w(a),10),n=d(x(s));W(n,{children:(f,_)=>{var h=so();i(f,h)},$$slots:{default:!0}}),t(),z(s);var r=d(s,4);E(r,{children:(f,_)=>{var h=no();i(f,h)},$$slots:{default:!0}});var c=d(r,4);y(c,{language:"TypeScript",children:(f,_)=>{t();var h=b();h.nodeValue="create(shape: ShapeName, {target: string | HTMLElement})",i(f,h)},$$slots:{default:!0}});var l=d(c,12);y(l,{language:"TypeScript",children:(f,_)=>{t();var h=b();h.nodeValue=`describe('create(...)', ()=>{
    ...
    it('creates an SVG and appends it to the body', ()=>{
        ...
    })
})`,i(f,h)},$$slots:{default:!0}});var p=d(l,12),u=d(x(p));W(u,{children:(f,_)=>{t();var h=b("Cosexa Pgropia™");i(f,h)},$$slots:{default:!0}}),t(),z(p);var g=d(p,6);y(g,{language:"TypeScript",children:(f,_)=>{t();var h=b();h.nodeValue=`describe("create('rect', {...})", ()=> {
    ...
...
})`,i(f,h)},$$slots:{default:!0}});var q=d(g,4);ne(q,{gap:4,$$slots:{left:(f,_)=>{y(f,{slot:"left",language:"HTML",children:(h,B)=>{t();var A=b();A.nodeValue='<div class="test-box"></div>',i(h,A)},$$slots:{default:!0}})},right:(f,_)=>{y(f,{slot:"right",language:"CSS",children:(h,B)=>{t();var A=b();A.nodeValue=`.test-box {
    background: #333;
    width: 250px;
    height: 150px;
}`,i(h,A)},$$slots:{default:!0}})}}});var $=d(q,2);ce($,{width:250,height:150});var S=d($,4);ne(S,{gap:4,$$slots:{left:(f,_)=>{y(f,{slot:"left",language:"HTML",children:(h,B)=>{t();var A=b();A.nodeValue='<div class="test-box test-box--expected"></div>',i(h,A)},$$slots:{default:!0}})},right:(f,_)=>{y(f,{slot:"right",language:"CSS",children:(h,B)=>{t();var A=b();A.nodeValue=`...
.test-box--expected {
    box-sizing: content-box;
    border: 4px solid orange;
}
`,i(h,A)},$$slots:{default:!0}})}}});var X=d(S,2);ce(X,{width:250,height:150,showBorder:!0});var K=d(X,14);y(K,{language:"TypeScript",children:(f,_)=>{t();var h=b();h.nodeValue="it(`creates an orange rect of 4px width around target (${xW}x${xH})`, async ({ page }) => {\n    await comparePages({\n        testingURL: `/${xW}x${xH}`,\n        expectedURL: `/expected/rect/${xW}x${xH}-default`,\n        action: () => {\n            return page.evaluate(() => {\n                pio.create('rect', {target: `.test-box--${xW}x${xH}`})\n            })\n        }\n    })\n})",i(f,h)},$$slots:{default:!0}});var J=d(K,6);L(J,{get src(){return oo},alt:"Test report de Playwright mostrando resultado actual y esperado con slider"});var Q=d(J,2);E(Q,{children:(f,_)=>{t();var h=b(`Lamentablemente Playwright no tiene una función tan mágica y bonita como
...
}`,i(l,u)},$$slots:{default:!0}});var s=d(a,6);y(s,{language:"TypeScript",children:(l,p)=>{t();var u=b();u.nodeValue=`
...
}`,i(l,u)},$$slots:{default:!0}});var n=d(s,12);y(n,{language:"TypeScript",children:(l,p)=>{t();var u=b();u.nodeValue=`
abstract class Animal {
  comer() { console.log("Comiendo") }
...
}`,i(l,u)},$$slots:{default:!0}});var r=d(n,4);y(r,{language:"TypeScript",children:(l,p)=>{t();var u=b();u.nodeValue=`
class Animal {
  comer() { console.log("Comiendo") }
  // Ahora Animal sí implementa mover, por defecto movimiento terrestre.
  mover(hacia: Posicion) {
...
`,i(l,u)},$$slots:{default:!0}});var c=d(r,8);y(c,{language:"TypeScript",children:(l,p)=>{t();var u=b();u.nodeValue=`
class Animal {
  puedeVolar: boolean
  ...
  comer() { console.log("Comiendo") }
...
`,i(l,u)},$$slots:{default:!0}}),t(20),i(o,e)}const uo=Object.freeze(Object.defineProperty({__proto__:null,default:co,metadata:Se},Symbol.toStringTag,{value:"Module"})),$e={title:"Miedo de decir, miedo de ser",slug:"miedo-de-decir-miedo-de-ser",coverImage:"paisaje-miedo.jpg",coverAuthor:"Karsten Würth",excerpt:"Me han preguntado si no me da miedo escribir algunas cosas,  pues podría estar saboteando mi futuro. Respondo.",date:"2024-11-28T01:09:04.325Z",updated:"2024-11-28T01:09:04.326Z",hidden:!1,tags:["Personal","Laboral"],keywords:[],type:"default"},{title:Mr,slug:Ur,coverImage:Hr,coverAuthor:Nr,excerpt:Br,date:Fr,updated:Yr,hidden:Gr,tags:Wr,keywords:Zr,type:Xr}=$e;var po=m(`<p>Me aconsejaba un compañero, preocupado, que no debería atreverme a exponer aquí
...
red social, aquí tengo mejor control del contenido.</p>`,1);function mo(o){var e=po();t(14),i(o,e)}const go=Object.freeze(Object.defineProperty({__proto__:null,default:mo,metadata:$e},Symbol.toStringTag,{value:"Module"})),Pe={title:"El peligro de trivializar. Edición TypeScript.",slug:"peligro-trivializar-typescript",coverImage:"/src/assets/posts-covers/any-code.png",coverPosition:"normal",excerpt:"Un error común es creer que TypeScript es una tontería que se aprende en cinco minutos. Quienes lo creen van directos a un precipicio.",date:"2024-09-28T16:31:23.177Z",updated:"2024-09-28T16:31:23.903Z",hidden:!1,tags:["TypeScript","DX"],keywords:["dx","any","typescript"],type:"default"},{title:Kr,slug:Jr,coverImage:Qr,coverPosition:ei,excerpt:ai,date:oi,updated:si,hidden:ni,tags:ri,keywords:ii,type:ti}=Pe;var bo=m(`En el repo <a href="https://github.com/type-challenges" style="color: var(--color-font-highlight)">Type Challenges</a> de Anthony Fu puedes encontrar una gran variedad de desafíos y soluciones de
...
de narrowing ni nada extra.`,1),ho=m(`<p>Recientemente un colega de profesión se ha sorprendido al
...
gente, comenzando proyectos con TypeScript desde el inicio sin saber utilizarlo.</p>`,1);function vo(o){var e=ho(),a=d(w(e),8);E(a,{children:(s,n)=>{t();var r=bo();t(2),i(s,r)},$$slots:{default:!0}}),t(28),i(o,e)}const fo=Object.freeze(Object.defineProperty({__proto__:null,default:vo,metadata:Pe},Symbol.toStringTag,{value:"Module"})),Le={title:"Por qué un blog en 2024",slug:"por-que-un-blog-en-2024",coverImage:"/src/assets/posts-covers/maquina-escribir.jpg",coverPosition:"normal",coverAuthor:"Patrick Fore",excerpt:"Esta es la primera entrada de un un blog en el que controlo todo su proceso generativo y contenido.",date:"2024-06-24T15:06:23.177Z",updated:"2024-06-24T15:06:23.903Z",hidden:!1,tags:["Personal"],keywords:["estático","blog"],type:"default"},{title:li,slug:di,coverImage:ci,coverPosition:ui,coverAuthor:pi,excerpt:mi,date:gi,updated:bi,hidden:hi,tags:vi,keywords:fi,type:qi}=Le;var qo=m(`En este artículo hablo de blogs de carácter <strong>personal</strong>, 
no de blogs corporativos, institucionales, etc. Esos tienen otras razones para 
seguir siendo útiles.`,1),yo=m('<a href="#detalles-tecnicos">👇 al final.</a>'),jo=m(`<!> <p>Esta es la primera entrada de un blog en el que controlo todo su proceso
...
empezar <!> mándame un correo.</p>`,1);function wo(o){var e=jo(),a=w(e);E(a,{children:(p,u)=>{t();var g=qo();t(2),i(p,g)},$$slots:{default:!0}});var s=d(a,2),n=d(x(s));W(n,{children:(p,u)=>{var g=yo();i(p,g)},$$slots:{default:!0}}),z(s);var r=d(s,32);E(r,{children:(p,u)=>{t();var g=b(`Esto es un apartado más técnico. Si no te interesa no sé qué haces
leyendo este blog, para empezar.`);i(p,g)},$$slots:{default:!0}});var c=d(r,18),l=d(x(c),5);_e(l,{children:(p,u)=>{t();var g=b("déjame un comentario");i(p,g)},$$slots:{default:!0}}),t(),z(c),i(o,e)}const xo=Object.freeze(Object.defineProperty({__proto__:null,default:wo,metadata:Le},Symbol.toStringTag,{value:"Module"})),Te={title:"Sobre las consecuencias y su recurrencia",slug:"sobre-consecuencias-y-su-recurrencia",coverImage:"",excerpt:"Es terriblemente cruel el modo en que la sociedad, incluso en nombre de la moral o la prudencia, ejerce esa vigilancia eterna; el modo en el que el pasado se convierte en presente renovado.",date:"2025-04-07T01:09:04.325Z",updated:"2025-04-07T01:09:04.326Z",hidden:!1,tags:["Personal","Salud mental"],keywords:[],type:"default"},{title:yi,slug:ji,coverImage:wi,excerpt:xi,date:zi,updated:Ei,hidden:_i,tags:Ai,keywords:Si,type:$i}=Te;var zo=m(`<p>Actualmente un conocido se está enfrentando a consecuencias de actos que le
...
continuar con mi diseño sin consecuencias técnicas es una muy buena noticia.</p>`,1);function Lo(o){var e=Po(),a=d(w(e),12),s=d(x(a));_e(s,{children:(p,u)=>{t();var g=b("Era");i(p,g)},$$slots:{default:!0}}),t(),z(a);var n=d(a,24);L(n,{get src(){return Ao},alt:"Sugerencia de VSCode al empezar a escribir la función create(). Se aprecia que sugiere tanto arrow como rect."});var r=d(n,8);L(r,{get src(){return So},alt:"Sugerencia de VSCode al escribir las opciones de la función create para el tipo rect",figCaption:"Opciones comunes para todos los punteros y para aquellos de tipo SVG, además de las opciones exclusivas de 'rect'. <small>NOTA: los simbolitos son de accesibilidad para personas con algún tipo de deficiencia de visión de color.</small>"});var c=d(r,4);L(c,{get src(){return $o},alt:"Sugerencia de VSCode al escribir las opciones de la función create para el tipo rect",figCaption:"Opciones comunes además de las opciones exclusivas de 'arrow'."});var l=d(c,6);y(l,{language:"TypeScript",children:(p,u)=>{t();var g=b();g.nodeValue=`interface PointerOptions {
    rect: CommonOptions & SVGOptions & RectOptions
    arrow: CommonOptions & SVGOptions & ArrowOptions
}`,i(p,g)},$$slots:{default:!0}}),t(10),i(o,e)}const To=Object.freeze(Object.defineProperty({__proto__:null,default:Lo,metadata:Ce},Symbol.toStringTag,{value:"Module"})),Re={title:"Autonomía y ajenidad (parte 2)",slug:"autonomia-ajenidad-2",coverImage:"/src/assets/posts-covers/starfish.jpg",coverPosition:"normal",coverAuthor:"Pedro Lastra",excerpt:"Segunda parte. Analizo la consultoría y el mentoring.",date:"2024-09-05T13:06:23.177Z",updated:"2024-09-05T13:06:23.903Z",hidden:!0,tags:["Personal","Laboral","Consultoría"],keywords:["trabajo","autónomo"],type:"default"},{title:Ui,slug:Hi,coverImage:Ni,coverPosition:Bi,coverAuthor:Fi,excerpt:Yi,date:Gi,updated:Wi,hidden:Zi,tags:Xi,keywords:Ki,type:Ji}=Re;var Co=m(`<p>En la <a href="/blog/autonomia-ajenidad-1">primera parte</a> de estas entradas que originalmente
...
por tu servicio para mejorar la situación laboral.</p>`,1);function Ro(o){var e=Co(),a=d(w(e),48);E(a,{children:(s,n)=>{t();var r=b(`NOTA: no he notado diferencias de género en este ámbito, más allá de
una mayor cantidad hombres. Asume que cuando digo directivo digo también 
directiva/e.`);i(s,r)},$$slots:{default:!0}}),t(22),i(o,e)}const ko=Object.freeze(Object.defineProperty({__proto__:null,default:Ro,metadata:Re},Symbol.toStringTag,{value:"Module"})),ke={title:"Relaciones interpersonales en la consultoría",slug:"relaciones-interpersonales-consultoria",coverImage:"/src/assets/posts-covers/mono-espejo.jpg",coverPosition:"normal",coverAuthor:"Pedro Lastra",excerpt:"Un análisis sobre la consultoría y la formación a directivos de software.",date:"2024-09-05T13:06:23.177Z",updated:"2024-09-05T13:06:23.903Z",hidden:!0,tags:["Personal","Laboral","Consultoría"],keywords:["trabajo","consultor","consultoría"],type:"default"},{title:Qi,slug:et,coverImage:at,coverPosition:ot,coverAuthor:st,excerpt:nt,date:rt,updated:it,hidden:tt,tags:lt,keywords:dt,type:ct}=ke;var Oo=m(`<p>En la <a href="/blog/autonomia-ajenidad-1">primera parte</a> de un conjunto de
...
funcionar.</p>`,1);function Vo(o){var e=Oo(),a=d(w(e),46);E(a,{children:(s,n)=>{t();var r=b(`NOTA: no he notado diferencias de género en este ámbito, más allá de
una mayor cantidad hombres. Asume que cuando digo directivo digo también 
directiva/e.`);i(s,r)},$$slots:{default:!0}}),t(102),i(o,e)}const Do=Object.freeze(Object.defineProperty({__proto__:null,default:Vo,metadata:ke},Symbol.toStringTag,{value:"Module"})),Oe={title:"Primatología: directivos ",slug:"primatologia-directivos",coverImage:"/src/assets/posts-covers/mono-espejo.jpg",coverPosition:"normal",coverAuthor:"Andre Mouton",excerpt:"Un análisis sobre la consultoría y la formación a directivos y jefes de proyecto en proyectos de desarrollo de software.",date:"2024-09-06T07:06:23.177Z",updated:"2024-09-06T07:06:23.903Z",hidden:!0,tags:["Personal","Laboral","Consultoría"],keywords:["trabajo","consultor","consultoría"],type:"default"},{title:ut,slug:pt,coverImage:mt,coverPosition:gt,coverAuthor:bt,excerpt:ht,date:vt,updated:ft,hidden:qt,tags:yt,keywords:jt,type:wt}=Oe;var Io=m(`<p>Siempre es una buena señal y honra a una persona el que entienda que hay
...
de todas formas aunque no te lo traspase oficialmente.</p>`,1);function No(o){var e=Ho();t(6),i(o,e)}const Bo=Object.freeze(Object.defineProperty({__proto__:null,default:No,metadata:Ve},Symbol.toStringTag,{value:"Module"})),Fo={sources:{avif:""+new URL("../assets/any-code.ClKF-0wF.avif",import.meta.url).href+" 640w, "+new URL("../assets/any-code.KLdJ1ygV.avif",import.meta.url).href+" 1280w",webp:""+new URL("../assets/any-code.C8s4CXVk.webp",import.meta.url).href+" 640w, "+new URL("../assets/any-code.DcSfFKdy.webp",import.meta.url).href+" 1280w",png:""+new URL("../assets/any-code.BA_T7izO.png",import.meta.url).href+" 640w, "+new URL("../assets/any-code.DX1Lcz0d.png",import.meta.url).href+" 1280w"},img:{src:""+new URL("../assets/any-code.DX1Lcz0d.png",import.meta.url).href,w:1280,h:720}},Yo=Object.freeze(Object.defineProperty({__proto__:null,default:Fo},Symbol.toStringTag,{value:"Module"})),Go={sources:{avif:""+new URL("../assets/blizzard.BbRU_fN9.avif",import.meta.url).href+" 640w, "+new URL("../assets/blizzard.B--PL0XO.avif",import.meta.url).href+" 1280w",webp:""+new URL("../assets/blizzard.CybShHHZ.webp",import.meta.url).href+" 640w, "+new URL("../assets/blizzard.C8i5Cr0L.webp",import.meta.url).href+" 1280w",jpeg:""+new URL("../assets/blizzard.CehEdUNF.jpeg",import.meta.url).href+" 640w, "+new URL("../assets/blizzard.DanEHBUr.jpeg",import.meta.url).href+" 1280w"},img:{src:""+new URL("../assets/blizzard.DanEHBUr.jpeg",import.meta.url).href,w:1280,h:720}},Wo=Object.freeze(Object.defineProperty({__proto__:null,default:Go},Symbol.toStringTag,{value:"Module"})),Zo={sources:{avif:""+new URL("../assets/jon-tyson.BYe6w2ID.avif",import.meta.url).href+" 640w, "+new URL("../assets/jon-tyson.CDQuug6G.avif",import.meta.url).href+" 1280w",webp:""+new URL("../assets/jon-tyson.Cp146D7f.webp",import.meta.url).href+" 640w, "+new URL("../assets/jon-tyson.CjWtVi3C.webp",import.meta.url).href+" 1280w",jpeg:""+new URL("../assets/jon-tyson.sgBkeOW9.jpeg",import.meta.url).href+" 640w, "+new URL("../assets/jon-tyson.MygLIirx.jpeg",import.meta.url).href+" 1280w"},img:{src:""+new URL("../assets/jon-tyson.MygLIirx.jpeg",import.meta.url).href,w:1280,h:720}},Xo=Object.freeze(Object.defineProperty({__proto__:null,default:Zo},Symbol.toStringTag,{value:"Module"})),Ko={sources:{avif:""+new URL("../assets/machinery.B2JAbiy0.avif",import.meta.url).href+" 640w, "+new URL("../assets/machinery.B0k06fYR.avif",import.meta.url).href+" 1280w",webp:""+new URL("../assets/machinery.XKRnVKXm.webp",import.meta.url).href+" 640w, "+new URL("../assets/machinery.CVc1jLYE.webp",import.meta.url).href+" 1280w",jpeg:""+new URL("../assets/machinery.CmYyaLYN.jpeg",import.meta.url).href+" 640w, "+new URL("../assets/machinery.lcec4MJm.jpeg",import.meta.url).href+" 1280w"},img:{src:""+new URL("../assets/machinery.lcec4MJm.jpeg",import.meta.url).href,w:1280,h:720}},Jo=Object.freeze(Object.defineProperty({__proto__:null,default:Ko},Symbol.toStringTag,{value:"Module"})),Qo={sources:{avif:""+new URL("../assets/maquina-escribir.Cin8T6Ns.avif",import.meta.url).href+" 640w, "+new URL("../assets/maquina-escribir.DlsgBpUI.avif",import.meta.url).href+" 1280w",webp:""+new URL("../assets/maquina-escribir.BnNhWCjk.webp",import.meta.url).href+" 640w, "+new URL("../assets/maquina-escribir.CI-vJ5nO.webp",import.meta.url).href+" 1280w",jpeg:""+new URL("../assets/maquina-escribir.CR4I1sxo.jpeg",import.meta.url).href+" 640w, "+new URL("../assets/maquina-escribir.D_dAKKRX.jpeg",import.meta.url).href+" 1280w"},img:{src:""+new URL("../assets/maquina-escribir.D_dAKKRX.jpeg",import.meta.url).href,w:1280,h:720}},es=Object.freeze(Object.defineProperty({__proto__:null,default:Qo},Symbol.toStringTag,{value:"Module"})),as={sources:{avif:""+new URL("../assets/mono-espejo.aXQBIyAH.avif",import.meta.url).href+" 640w, "+new URL("../assets/mono-espejo.BU_sVk6o.avif",import.meta.url).href+" 1280w",webp:""+new URL("../assets/mono-espejo.Ddhs2ZMX.webp",import.meta.url).href+" 640w, "+new URL("../assets/mono-espejo.DHYr2_Wv.webp",import.meta.url).href+" 1280w",jpeg:""+new URL("../assets/mono-espejo.DRdjxkSr.jpeg",import.meta.url).href+" 640w, "+new URL("../assets/mono-espejo.DFCEYnu1.jpeg",import.meta.url).href+" 1280w"},img:{src:""+new URL("../assets/mono-espejo.DFCEYnu1.jpeg",import.meta.url).href,w:1280,h:720}},os=Object.freeze(Object.defineProperty({__proto__:null,default:as},Symbol.toStringTag,{value:"Module"})),ss={sources:{avif:""+new URL("../assets/paisaje-miedo.BukGgRh-.avif",import.meta.url).href+" 640w, "+new URL("../assets/paisaje-miedo.DsGgOpGx.avif",import.meta.url).href+" 1280w",webp:""+new URL("../assets/paisaje-miedo.D_7fOhrA.webp",import.meta.url).href+" 640w, "+new URL("../assets/paisaje-miedo.BPgBLAZ-.webp",import.meta.url).href+" 1280w",jpeg:""+new URL("../assets/paisaje-miedo.TpHsYGSs.jpeg",import.meta.url).href+" 640w, "+new URL("../assets/paisaje-miedo.DzkZpwmi.jpeg",import.meta.url).href+" 1280w"},img:{src:""+new URL("../assets/paisaje-miedo.DzkZpwmi.jpeg",import.meta.url).href,w:1280,h:720}},ns=Object.freeze(Object.defineProperty({__proto__:null,default:ss},Symbol.toStringTag,{value:"Module"})),rs={sources:{avif:""+new URL("../assets/pio-round-fail-test.DX0Cn6lJ.avif",import.meta.url).href+" 640w, "+new URL("../assets/pio-round-fail-test.CmaCatt2.avif",import.meta.url).href+" 1280w",webp:""+new URL("../assets/pio-round-fail-test.Dw2-sPvT.webp",import.meta.url).href+" 640w, "+new URL("../assets/pio-round-fail-test.DFm94EAo.webp",import.meta.url).href+" 1280w",png:""+new URL("../assets/pio-round-fail-test.BPuwgNjn.png",import.meta.url).href+" 640w, "+new URL("../assets/pio-round-fail-test.-sGo8TTQ.png",import.meta.url).href+" 1280w"},img:{src:""+new URL("../assets/pio-round-fail-test.-sGo8TTQ.png",import.meta.url).href,w:1280,h:720}},is=Object.freeze(Object.defineProperty({__proto__:null,default:rs},Symbol.toStringTag,{value:"Module"})),ts={sources:{avif:""+new URL("../assets/starfish.QmbbtQry.avif",import.meta.url).href+" 640w, "+new URL("../assets/starfish.C1hjTUgH.avif",import.meta.url).href+" 1280w",webp:""+new URL("../assets/starfish.Dfj_-D5_.webp",import.meta.url).href+" 640w, "+new URL("../assets/starfish.d5pPDI95.webp",import.meta.url).href+" 1280w",jpeg:""+new URL("../assets/starfish.Di2y8SqM.jpeg",import.meta.url).href+" 640w, "+new URL("../assets/starfish.CayEXQ_w.jpeg",import.meta.url).href+" 1280w"},img:{src:""+new URL("../assets/starfish.CayEXQ_w.jpeg",import.meta.url).href,w:1280,h:720}},ls=Object.freeze(Object.defineProperty({__proto__:null,default:ts},Symbol.toStringTag,{value:"Module"})),ds={sources:{avif:""+new URL("../assets/tree-shaking.Dm5PN7LS.avif",import.meta.url).href+" 640w, "+new URL("../assets/tree-shaking.DRHr0SW_.avif",import.meta.url).href+" 1280w",webp:""+new URL("../assets/tree-shaking.rN-B0IuQ.webp",import.meta.url).href+" 640w, "+new URL("../assets/tree-shaking.C6f3tNrs.webp",import.meta.url).href+" 1280w",jpeg:""+new URL("../assets/tree-shaking.DwjQOLAz.jpeg",import.meta.url).href+" 640w, "+new URL("../assets/tree-shaking.BVwql0Kq.jpeg",import.meta.url).href+" 1280w"},img:{src:""+new URL("../assets/tree-shaking.BVwql0Kq.jpeg",import.meta.url).href,w:1280,h:720}},cs=Object.freeze(Object.defineProperty({__proto__:null,default:ds},Symbol.toStringTag,{value:"Module"})),us={sources:{avif:""+new URL("../assets/valla.DhkFZpBY.avif",import.meta.url).href+" 640w, "+new URL("../assets/valla.Dpfd17Fi.avif",import.meta.url).href+" 1280w",webp:""+new URL("../assets/valla.BjJKHA0T.webp",import.meta.url).href+" 640w, "+new URL("../assets/valla.CSlq1MCB.webp",import.meta.url).href+" 1280w",jpeg:""+new URL("../assets/valla.CuKW0Rqf.jpeg",import.meta.url).href+" 640w, "+new URL("../assets/valla.CyjHcVT7.jpeg",import.meta.url).href+" 1280w"},img:{src:""+new URL("../assets/valla.CyjHcVT7.jpeg",import.meta.url).href,w:1280,h:720}},ps=Object.freeze(Object.defineProperty({__proto__:null,default:us},Symbol.toStringTag,{value:"Module"}));var k=null;function ms(o){k={p:k,c:null,d:null}}function gs(){var o=k,e=o.d;e&&R.push(...e),k=o.p}const bs=`<!--${Be}-->`,hs=`<!--${Fe}-->`;class vs{constructor(e=new Set,a="",s="",n=()=>""){v(this,"css",new Set);v(this,"out","");v(this,"uid",()=>"");v(this,"title","");this.css=e,this.out=a,this.title=s,this.uid=n}}class fs{constructor(e=""){v(this,"css",new Set);v(this,"out","");v(this,"uid",()=>"");v(this,"select_value");v(this,"head",new vs);this.uid=qs(e),this.head.uid=this.uid}}function qs(o){let e=1;return()=>`${o}s${e++}`}let R=[];function ys(o,e={}){const a=new fs(e.idPrefix?e.idPrefix+"-":""),s=R;R=[],a.out+=bs,e.context&&(ms(),k.c=e.context),o(a,e.props??{},{},{}),e.context&&gs(),a.out+=hs;for(const r of R)r();R=s;let n=a.head.out+a.head.title;for(const{hash:r,code:c}of a.css)n+=`<style id="${r}">${c}</style>`;return{head:n,html:a.out,body:a.out}}const Tt=(o=!1)=>{var r;const s={...Object.assign({"/src/posts/autonomia-ajenidad-1.md":ma,"/src/posts/caso-suite-cosby.md":va,"/src/posts/cuantas-muertes-evitables.md":ya,"/src/posts/deja-esperar-otros.md":Aa,"/src/posts/discursos-segregacionistas.md":Pa,"/src/posts/el-hacking-a-google.md":ka,"/src/posts/ensenanza-aprendizaje-profundo.md":Ia,"/src/posts/especificacion-visual-caso-point-it-out.md":to,"/src/posts/flipadismos-mecanismos-oop.md":uo,"/src/posts/miedo-de-decir-miedo-de-ser.md":go,"/src/posts/peligro-trivializar-typescript.md":fo,"/src/posts/por-que-un-blog-en-2024.md":xo,"/src/posts/sobre-consecuencias-y-su-recurrencia.md":_o,"/src/posts/tamano-no-importa-tree-shakeables.md":To}),...Object.assign({"/src/posts/borradores/autonomia-ajenidad-2.md":ko,"/src/posts/borradores/relaciones-interpersonales-consultoria.md":Do,"/src/posts/ocultados/primatologia-directivos.md":Uo,"/src/posts/ocultados/traspaso-proyectos.md":Bo})},n=[];for(const c in s){const l=s[c];if(l){let p=l.metadata.coverImage;p&&(p=p.substring(p.lastIndexOf("/")+1)),n.push({...l.metadata,coverImage:p,path:c,html:o&&l.default.render?(r=ys(l.default))==null?void 0:r.body:void 0})}}return n},Ct=o=>o.filter(e=>!e.hidden).sort((e,a)=>new Date(e.date).getTime()>new Date(a.date).getTime()?-1:new Date(e.date).getTime()<new Date(a.date).getTime()?1:0).map(e=>{const a=js(o,e);return{...e,relatedPosts:a}}),Rt=o=>{const e={};return o.forEach(a=>{a.tags.forEach(s=>{const n=xs(s);e[n]||(e[n]={name:s,posts:[]}),e[n].posts.push(a)})}),e},js=(o,e,a=3)=>o.filter(n=>!n.hidden&&n.slug!==e.slug).sort((n,r)=>{var p,u;const c=(p=n.tags)==null?void 0:p.filter(g=>{var q;return(q=e.tags)==null?void 0:q.includes(g)}),l=(u=r.tags)==null?void 0:u.filter(g=>{var q;return(q=e.tags)==null?void 0:q.includes(g)});return(c==null?void 0:c.length)>(l==null?void 0:l.length)?-1:(c==null?void 0:c.length)<(l==null?void 0:l.length)?1:0}).slice(0,a).map(n=>({...n})),ws={á:"a",à:"a",ä:"a",é:"e",è:"e",ë:"e",í:"i",ì:"i",ï:"i",ó:"o",ò:"o",ö:"o",ú:"u",ù:"u",ü:"u",ñ:"n",ç:"c"," ":"-","/":"-"},xs=o=>o.toLowerCase().replace(/[áéíóúàèìòùäëïöüñç\/ ]/g,e=>ws[e]??e),kt=Object.assign({"../../assets/posts-covers/any-code.png":Yo,"../../assets/posts-covers/blizzard.jpg":Wo,"../../assets/posts-covers/jon-tyson.jpg":Xo,"../../assets/posts-covers/machinery.jpg":Jo,"../../assets/posts-covers/maquina-escribir.jpg":es,"../../assets/posts-covers/mono-espejo.jpg":os,"../../assets/posts-covers/paisaje-miedo.jpg":ns,"../../assets/posts-covers/pio-round-fail-test.png":is,"../../assets/posts-covers/starfish.jpg":ls,"../../assets/posts-covers/tree-shaking.jpg":cs,"../../assets/posts-covers/valla.jpg":ps});export{Z as A,Ka as I,ma as _,Rt as a,va as b,kt as c,ya as d,Aa as e,Pa as f,Ct as g,ka as h,Tt as i,Ia as j,to as k,uo as l,go as m,fo as n,xo as o,vr as p,_o as q,To as r,xs as s};
