...
“yo llevo trabajando desde los 15 años”, “tú no sabes lo que es trabajar”, etc.`,Y,ne,oe=`Yo solo escucho “he intercambiado X tiempo de mi vida por dinero y la promesa
de más dinero”. Y no cualquier tiempo de su vida, sino de su juventud. Esto
ni siquiera se puede tildar de reduccionista.`,de,Z,Ue=`No entiendo cómo algunos casos que son claros
...
salvo que con media vida convertida a promesas de una pensión.`,ie,ge,Xe=`Y tengo un serio problema con eso. Concretamente con la ajenidad. Cuando la
patronal describe la ajenidad puede hacerlo de una forma tan bonita como:`,ke,te,Ce=`“Exención al trabajador de las consecuencias directas de su labor, de sus costos
y riesgos de la producción, recibiendo un salario en contraprestación de su esfuerzo”.`,Le,Te,He=`Cuando podría resumirse en: “los frutos del trabajo solo pertenecen al empleador”
...
presente limitado a la duración de la relación laboral.”`,ue,we,at="La ajenidad en los trabajos creativos",q,Ze,nt=`El problema de la ajenidad es que viene acompañado de cadenas para tu
cerebro cuando se trata de un desarrollo creativo. Cadenas que permanecen
tras el cese de la relación laboral.`,Ve,Ie,st=`En realidad, el empleador no es solo dueño de las consecuencias del trabajo
...
o un enablement engineer.`,Fe,Oe,N=`Consideras que tu desarrollo podría ser igual de útil para otros profesionales
...
salario para que la tengas pudriéndose en ella.`,_,H,ye=`De pronto, ya no tienes solo un jefe, tienes a un maestro de esclavos que te
...
trabajas en”. Da igual si esto ocurre tras finalizar contrato).</small>`,Ee,De,Ke="Anarcosindicalismo y cooperativas",k,me,tt=`Me duele, mucho, pero he de reconocer que entre los franceses hay algunos
de los mejores ejemplos recientes que nos ha brindado la humanidad. No hablo
de Gojira, que también, sino en este contexto laboral, de Motion Twin.`,K,ve,We=`Es la empresa que más uso como ejemplo de increíble modelo de desarrollo de
...
desde 2005.`,Ae,Me,_e=`Cuando Flash murió ya tenían más que pulido su lenguaje Haxe y casi una década
de iniciado su propio motor de renderizado/videojuegos, Heaps.io.`,Pe,$e,Qe=`Con eso, trabajando con sus propias herramientas de la manera que a ellos les
...
el medio de producción.</li>`,Ne,vt,ce,qe,At=`Han hecho muchas cosas bien, ¿pero se salvan de algo? Las cooperativas fomentan
...
España.`,se,B,Ye=`En su caso además habrán tenido que bajar la cabeza con todo tipo de individuos
...
o en mi caso, un perfil obsesivo nada sano.`,le,re,ae=`A la mínima que destaques un poco lo raro es que no tengas a empresas de
recruiters o cazatalentos dando la turra con ofertas superbonitas y en
donde tú pones algunas condiciones (otra cosa es que las acepten).`,ze,Be,V=`Lo único que solicito a esas empresas es la anulación de la ajenidad, aunque
...
consecuencias si quiero publicarlo bajo mis propias condiciones.`,he,W,Re=`La mayoría se esfuma y no vuelven a contactarme en la vida, pero a veces cuela.
...
perjudicándome a mí y a los objetivos de la empresa, me piraría a mi casa.`,In;return vt=new ti({props:{$$slots:{default:[Ou]},$$scope:{ctx:i}}}),{c(){e=x("p"),e.textContent=t,n=y(),a=x("h2"),a.textContent=s,c=y(),l=x("p"),l.textContent=u,d=y(),p=x("p"),p.textContent=g,f=y(),v=x("ul"),v.innerHTML=E,C=y(),h=x("p"),h.textContent=m,R=y(),w=x("p"),w.innerHTML=I,j=y(),U=x("p"),U.textContent=z,F=y(),T=x("h2"),T.textContent=A,O=y(),$=x("p"),$.textContent=J,Y=y(),ne=x("p"),ne.textContent=oe,de=y(),Z=x("p"),Z.textContent=Ue,ie=y(),ge=x("p"),ge.textContent=Xe,ke=y(),te=x("p"),te.textContent=Ce,Le=y(),Te=x("p"),Te.textContent=He,ue=y(),we=x("h3"),we.textContent=at,q=y(),Ze=x("p"),Ze.textContent=nt,Ve=y(),Ie=x("p"),Ie.textContent=st,Fe=y(),Oe=x("p"),Oe.textContent=N,_=y(),H=x("p"),H.textContent=ye,fe=y(),pe=x("p"),pe.innerHTML=je,Ee=y(),De=x("h2"),De.textContent=Ke,k=y(),me=x("p"),me.textContent=tt,K=y(),ve=x("p"),ve.textContent=We,Je=y(),ct=x("p"),ct.textContent=G,Ae=y(),Me=x("p"),Me.textContent=_e,Pe=y(),$e=x("p"),$e.textContent=Qe,lt=y(),ut=x("p"),ut.textContent=et,dt=y(),pt=x("ul"),pt.innerHTML=Q,Ne=y(),Mt(vt.$$.fragment),ce=y(),qe=x("p"),qe.textContent=At,se=y(),B=x("p"),B.textContent=Ye,Nt=y(),qt=x("h2"),qt.textContent=cn,Vt=y(),P=x("p"),P.textContent=ee,le=y(),re=x("p"),re.textContent=ae,ze=y(),Be=x("p"),Be.textContent=V,he=y(),W=x("p"),W.textContent=Re,it=y(),ft=x("p"),ft.textContent=zt,Rt=y(),Bt=x("p"),Bt.textContent=wt,rt=y(),Ut=x("p"),Ut.textContent=xt,jt=y(),Ht=x("h2"),Ht.textContent=Qt,un=y(),bt=x("p"),bt.textContent=hn,dn=y(),Ft=x("p"),Ft.textContent=Vn,mn=y(),Wt=x("p"),Wt.textContent=Di,Dn=y(),Kt=x("p"),Kt.textContent=Ui,Un=y(),Jt=x("p"),Jt.textContent=Ii},l(X){e=b(X,"P",{"data-svelte-h":!0}),S(e)!=="svelte-1wpyji2"&&(e.textContent=t),n=M(X),a=b(X,"H2",{"data-svelte-h":!0}),S(a)!=="svelte-3yagm2"&&(a.textContent=s),c=M(X),l=b(X,"P",{"data-svelte-h":!0}),S(l)!=="svelte-10a7wn3"&&(l.textContent=u),d=M(X),p=b(X,"P",{"data-svelte-h":!0}),S(p)!=="svelte-18geujv"&&(p.textContent=g),f=M(X),v=b(X,"UL",{"data-svelte-h":!0}),S(v)!=="svelte-1qdhirk"&&(v.innerHTML=E),C=M(X),h=b(X,"P",{"data-svelte-h":!0}),S(h)!=="svelte-t4skty"&&(h.textContent=m),R=M(X),w=b(X,"P",{"data-svelte-h":!0}),S(w)!=="svelte-z8tuyy"&&(w.innerHTML=I),j=M(X),U=b(X,"P",{"data-svelte-h":!0}),S(U)!=="svelte-11u0qik"&&(U.textContent=z),F=M(X),T=b(X,"H2",{"data-svelte-h":!0}),S(T)!=="svelte-1afsrt5"&&(T.textContent=A),O=M(X),$=b(X,"P",{"data-svelte-h":!0}),S($)!=="svelte-15gqcak"&&($.textContent=J),Y=M(X),ne=b(X,"P",{"data-svelte-h":!0}),S(ne)!=="svelte-19ha8i3"&&(ne.textContent=oe),de=M(X),Z=b(X,"P",{"data-svelte-h":!0}),S(Z)!=="svelte-80o8sg"&&(Z.textContent=Ue),ie=M(X),ge=b(X,"P",{"data-svelte-h":!0}),S(ge)!=="svelte-1kcl7s"&&(ge.textContent=Xe),ke=M(X),te=b(X,"P",{"data-svelte-h":!0}),S(te)!=="svelte-1l9qmbt"&&(te.textContent=Ce),Le=M(X),Te=b(X,"P",{"data-svelte-h":!0}),S(Te)!=="svelte-1y06dud"&&(Te.textContent=He),ue=M(X),we=b(X,"H3",{"data-svelte-h":!0}),S(we)!=="svelte-98m34g"&&(we.textContent=at),q=M(X),Ze=b(X,"P",{"data-svelte-h":!0}),S(Ze)!=="svelte-v7iwr3"&&(Ze.textContent=nt),Ve=M(X),Ie=b(X,"P",{"data-svelte-h":!0}),S(Ie)!=="svelte-cs5hk7"&&(Ie.textContent=st),Fe=M(X),Oe=b(X,"P",{"data-svelte-h":!0}),S(Oe)!=="svelte-19jdwc4"&&(Oe.textContent=N),_=M(X),H=b(X,"P",{"data-svelte-h":!0}),S(H)!=="svelte-17ozwnn"&&(H.textContent=ye),fe=M(X),pe=b(X,"P",{"data-svelte-h":!0}),S(pe)!=="svelte-1otmt5n"&&(pe.innerHTML=je),Ee=M(X),De=b(X,"H2",{"data-svelte-h":!0}),S(De)!=="svelte-1ronoj4"&&(De.textContent=Ke),k=M(X),me=b(X,"P",{"data-svelte-h":!0}),S(me)!=="svelte-1wysd81"&&(me.textContent=tt),K=M(X),ve=b(X,"P",{"data-svelte-h":!0}),S(ve)!=="svelte-aa3yu9"&&(ve.textContent=We),Je=M(X),ct=b(X,"P",{"data-svelte-h":!0}),S(ct)!=="svelte-ilbqh8"&&(ct.textContent=G),Ae=M(X),Me=b(X,"P",{"data-svelte-h":!0}),S(Me)!=="svelte-1lolwil"&&(Me.textContent=_e),Pe=M(X),$e=b(X,"P",{"data-svelte-h":!0}),S($e)!=="svelte-j76t9r"&&($e.textContent=Qe),lt=M(X),ut=b(X,"P",{"data-svelte-h":!0}),S(ut)!=="svelte-t95qk"&&(ut.textContent=et),dt=M(X),pt=b(X,"UL",{"data-svelte-h":!0}),S(pt)!=="svelte-1dshv2p"&&(pt.innerHTML=Q),Ne=M(X),St(vt.$$.fragment,X),ce=M(X),qe=b(X,"P",{"data-svelte-h":!0}),S(qe)!=="svelte-19gb4g2"&&(qe.textContent=At),se=M(X),B=b(X,"P",{"data-svelte-h":!0}),S(B)!=="svelte-om5qlr"&&(B.textContent=Ye),Nt=M(X),qt=b(X,"H2",{"data-svelte-h":!0}),S(qt)!=="svelte-18licbm"&&(qt.textContent=cn),Vt=M(X),P=b(X,"P",{"data-svelte-h":!0}),S(P)!=="svelte-13wgyu3"&&(P.textContent=ee),le=M(X),re=b(X,"P",{"data-svelte-h":!0}),S(re)!=="svelte-1r5k9wu"&&(re.textContent=ae),ze=M(X),Be=b(X,"P",{"data-svelte-h":!0}),S(Be)!=="svelte-1ao3ou8"&&(Be.textContent=V),he=M(X),W=b(X,"P",{"data-svelte-h":!0}),S(W)!=="svelte-144nme8"&&(W.textContent=Re),it=M(X),ft=b(X,"P",{"data-svelte-h":!0}),S(ft)!=="svelte-1fksa9d"&&(ft.textContent=zt),Rt=M(X),Bt=b(X,"P",{"data-svelte-h":!0}),S(Bt)!=="svelte-1koj3tz"&&(Bt.textContent=wt),rt=M(X),Ut=b(X,"P",{"data-svelte-h":!0}),S(Ut)!=="svelte-crdp6j"&&(Ut.textContent=xt),jt=M(X),Ht=b(X,"H2",{"data-svelte-h":!0}),S(Ht)!=="svelte-7u7yf2"&&(Ht.textContent=Qt),un=M(X),bt=b(X,"P",{"data-svelte-h":!0}),S(bt)!=="svelte-171tqxj"&&(bt.textContent=hn),dn=M(X),Ft=b(X,"P",{"data-svelte-h":!0}),S(Ft)!=="svelte-1eeo9ne"&&(Ft.textContent=Vn),mn=M(X),Wt=b(X,"P",{"data-svelte-h":!0}),S(Wt)!=="svelte-dnf6u"&&(Wt.textContent=Di),Dn=M(X),Kt=b(X,"P",{"data-svelte-h":!0}),S(Kt)!=="svelte-1hxg1uq"&&(Kt.textContent=Ui),Un=M(X),Jt=b(X,"P",{"data-svelte-h":!0}),S(Jt)!=="svelte-mgjb17"&&(Jt.textContent=Ii)},m(X,Ge){r(X,e,Ge),r(X,n,Ge),r(X,a,Ge),r(X,c,Ge),r(X,l,Ge),r(X,d,Ge),r(X,p,Ge),r(X,f,Ge),r(X,v,Ge),r(X,C,Ge),r(X,h,Ge),r(X,R,Ge),r(X,w,Ge),r(X,j,Ge),r(X,U,Ge),r(X,F,Ge),r(X,T,Ge),r(X,O,Ge),r(X,$,Ge),r(X,Y,Ge),r(X,ne,Ge),r(X,de,Ge),r(X,Z,Ge),r(X,ie,Ge),r(X,ge,Ge),r(X,ke,Ge),r(X,te,Ge),r(X,Le,Ge),r(X,Te,Ge),r(X,ue,Ge),r(X,we,Ge),r(X,q,Ge),r(X,Ze,Ge),r(X,Ve,Ge),r(X,Ie,Ge),r(X,Fe,Ge),r(X,Oe,Ge),r(X,_,Ge),r(X,H,Ge),r(X,fe,Ge),r(X,pe,Ge),r(X,Ee,Ge),r(X,De,Ge),r(X,k,Ge),r(X,me,Ge),r(X,K,Ge),r(X,ve,Ge),r(X,Je,Ge),r(X,ct,Ge),r(X,Ae,Ge),r(X,Me,Ge),r(X,Pe,Ge),r(X,$e,Ge),r(X,lt,Ge),r(X,ut,Ge),r(X,dt,Ge),r(X,pt,Ge),r(X,Ne,Ge),Ct(vt,X,Ge),r(X,ce,Ge),r(X,qe,Ge),r(X,se,Ge),r(X,B,Ge),r(X,Nt,Ge),r(X,qt,Ge),r(X,Vt,Ge),r(X,P,Ge),r(X,le,Ge),r(X,re,Ge),r(X,ze,Ge),r(X,Be,Ge),r(X,he,Ge),r(X,W,Ge),r(X,it,Ge),r(X,ft,Ge),r(X,Rt,Ge),r(X,Bt,Ge),r(X,rt,Ge),r(X,Ut,Ge),r(X,jt,Ge),r(X,Ht,Ge),r(X,un,Ge),r(X,bt,Ge),r(X,dn,Ge),r(X,Ft,Ge),r(X,mn,Ge),r(X,Wt,Ge),r(X,Dn,Ge),r(X,Kt,Ge),r(X,Un,Ge),r(X,Jt,Ge),In=!0},p(X,[Ge]){const Gn={};Ge&1&&(Gn.$$scope={dirty:Ge,ctx:X}),vt.$set(Gn)},i(X){In||(ht(vt.$$.fragment,X),In=!0)},o(X){mt(vt.$$.fragment,X),In=!1},d(X){X&&(o(e),o(n),o(a),o(c),o(l),o(d),o(p),o(f),o(v),o(C),o(h),o(R),o(w),o(j),o(U),o(F),o(T),o(O),o($),o(Y),o(ne),o(de),o(Z),o(ie),o(ge),o(ke),o(te),o(Le),o(Te),o(ue),o(we),o(q),o(Ze),o(Ve),o(Ie),o(Fe),o(Oe),o(_),o(H),o(fe),o(pe),o(Ee),o(De),o(k),o(me),o(K),o(ve),o(Je),o(ct),o(Ae),o(Me),o(Pe),o($e),o(lt),o(ut),o(dt),o(pt),o(Ne),o(ce),o(qe),o(se),o(B),o(Nt),o(qt),o(Vt),o(P),o(le),o(re),o(ze),o(Be),o(he),o(W),o(it),o(ft),o(Rt),o(Bt),o(rt),o(Ut),o(jt),o(Ht),o(un),o(bt),o(dn),o(Ft),o(mn),o(Wt),o(Dn),o(Kt),o(Un),o(Jt)),Et(vt,X)}}}const Bu={title:"Autonomía y ajenidad (parte 1)",slug:"autonomia-ajenidad-1",coverImage:"/src/assets/posts-covers/starfish.jpg",coverPosition:"normal",coverAuthor:"Pedro Lastra",excerpt:"El trabajador autónomo no existe y el trabajo no es un orgullo.",date:"2024-08-24T13:06:23.177Z",updated:"2024-08-24T13:06:23.903Z",hidden:!1,tags:["Personal","Laboral","Software libre"],keywords:["trabajo","autónomo"],type:"default"};class Hu extends Yt{constructor(e){super(),Zt(this,e,null,zu,Xt,{})}}const ku=Object.freeze(Object.defineProperty({__proto__:null,default:Hu,metadata:Bu},Symbol.toStringTag,{value:"Module"}));function Vu(i){let e,t,n="AVISO: he escrito esto muy rápido en algo de rato libre, espera encontrar más de alguna errata o párrafo sobrecargado hasta que saque tiempo a revisarlo.";return{c(){e=gt(`No voy a centrarme en los hechos principales de este caso, sino en
...
destruye pruebas que le son requeridas durante la investigación.`,oe,de,Z=`Esto se explica porque mientras prometen proteger a sus empleados, también
contratan a las mejores firmas
antisindicalistas del mundo, como lo es WilmerHale, muy conocida por su brutal
eficiencia para erradicar cualquier indicio de sindicalismo en Amazon.`,Ue,ie,ge=`Y aunque parezca no tener relación, lo que hace verdaderamente fuertes a las
...
puente entre las corporaciones y los poderes federales, incluyendo el judicial.`,Xe,ke,te="Nuestra postura",Ce,Le,Te=`En 2021, unos días antes de explotar públicamente todo este caso, poco antes
...
herramienta para la comunidad.`,He,ue,we=`El proyecto, <a href="https://d2runewords.com" rel="nofollow">D2Runewords</a> <em>(Diablo 2 rune words, con palabras juntas de forma
...
para la comunidad de un juego relativamente nicho, seguramente sería irrelevante.`,nt,Ve,Ie="¿Sirvió de algo?",st,Fe,Oe=`Probablemente no cambió nada en absoluto, pero si solo sirvió para que alguna
...
de Activision Blizzard con un mensaje algo agridulce:`,ye,fe,pe=`<p>Dear Alex and Cristo,</p> <p>on behalf of my entire team, we want to express our sincere gratitude for your support.</p> <p>Unfortunately, it’s not as simple as you suggest to detach ourselves from this company. For
...
efforts go unrecognized. This is the company’s greatest problem.</p> <p>We wish you all the best.</p> <p>Sincerely,</p> <br/>-omito su nombre y rol, por prudencia-`,je,Ee,De=`De los seis restantes, tres no se habían enterado de qué iba el tema y pedían
más información. Un mensaje que me gustó mucho fue el de Thomas Giuseppe, quien
posteriormente también contribuyó mucho a dar a conocer la herramienta:`,Ke,k,me=`<p>Hey!</p> <p>I just found d2runewords.com, and I think it’s an awesome tool. Basically, it’s the only one
...
Giu</p>`,tt,K,ve=`Gracias a él nos dimos cuenta de que era importante dejar una referencia al caso
...
la guardan en marcadores y la consultan regularmente.`,G,Ae,Me=`Hemos visto la página aparecer entre algún streaming de Diablo 2, así que estamos
convencidos de que al menos hemos contribuido con un poco más de visibilización.`,_e,Pe,$e="¿Cómo está la situación actualmente?",Qe,lt,ut=`En un correo que no consideramos de feedback, nos preguntaron si la situación
...
apoyadas a otras aunque sea un sentimiento fugaz o considerablemente inútil.`,Q,Ne,vt=`Respecto al uso de la herramienta, en realidad no me sienta mal que se use
y sea útil, no juzgo a nadie por jugar a ningún juego de esta compañía y menos
a Diablo 2, que se comió la mitad de mi adolescencia.`,ce,qe,At=`Diablo 2 fue un juego de una
...
públicamente el detalle. En su lugar se resume en “error o negligencia de programación”.`,Y,ne,oe=`¿Y la razón? A lo mejor te preguntas si es que los jueces son gilipollas o qué,
...
cometan el mismo error.`,de,Z,Ue=`Doy fé de que en muchas auditorías se encuentran fallos que por muchísima suerte
...
potencialmente mortal, paralizando cualquier servicio si es necesario.`,ie,ge,Xe=`Todo esto hace que el número de víctimas habidas y por haber sea un completo
...
más si viene acompañado de tips y soluciones.`,ke,te,Ce="Soluciones",Le,Te,He=`Los problemas seleccionados tienen algo en común: son fácilmente prevenibles
incluso de manera automática, y aún así siguen estando muy presentes en
múltiples desarrollos.`,ue,we,at=`Algunos quedarían totalmente evidenciados con tan solo un correcto linter +
...
de software en general, libre o privativo.`,Ve,Ie,st=`Aclarar que estas soluciones deberían aplicarse siempre, haya o no
vidas humanas en juego, pues influyen en la calidad de cualquier desarrollo.`,Fe,Oe,N="Próximamente",_,H,ye=`Aprovecho a comentar que este mes de abril me encontraré por la península,
...
}`;function rg(i,e,t){let n=new fl;const a=new Ot,s=new Ot,c=new sn,l=new ig({depthPacking:ep}),u=new ag,d={},p=t.maxTextureSize,g={[Gi]:On,[On]:Gi,[wi]:wi},f=new ji({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ot},radius:{value:4}},vertexShader:sg,fragmentShader:og}),v=f.clone();v.defines.HORIZONTAL_PASS=1;const E=new kn;E.setAttribute("position",new ci(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const C=new Yn(E,f),h=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=$c;let m=this.type;this.render=function(U,z,F){if(h.enabled===!1||h.autoUpdate===!1&&h.needsUpdate===!1||U.length===0)return;const T=i.getRenderTarget(),A=i.getActiveCubeFace(),O=i.getActiveMipmapLevel(),$=i.state;$.setBlending(ki),$.buffers.color.setClear(1,1,1,1),$.buffers.depth.setTest(!0),$.setScissorTest(!1);const J=m!==Ai&&this.type===Ai,Y=m===Ai&&this.type!==Ai;for(let ne=0,oe=U.length;ne<oe;ne++){const de=U[ne],Z=de.shadow;if(Z===void 0){console.warn("THREE.WebGLShadowMap:",de,"has no shadow.");continue}if(Z.autoUpdate===!1&&Z.needsUpdate===!1)continue;a.copy(Z.mapSize);const Ue=Z.getFrameExtents();if(a.multiply(Ue),s.copy(Z.mapSize),(a.x>p||a.y>p)&&(a.x>p&&(s.x=Math.floor(p/Ue.x),a.x=s.x*Ue.x,Z.mapSize.x=s.x),a.y>p&&(s.y=Math.floor(p/Ue.y),a.y=s.y*Ue.y,Z.mapSize.y=s.y)),Z.map===null||J===!0||Y===!0){const ge=this.type!==Ai?{minFilter:Xn,magFilter:Xn}:{};Z.map!==null&&Z.map.dispose(),Z.map=new Ca(a.x,a.y,ge),Z.map.texture.name=de.name+".shadowMap",Z.camera.updateProjectionMatrix()}i.setRenderTarget(Z.map),i.clear();const ie=Z.getViewportCount();for(let ge=0;ge<ie;ge++){const Xe=Z.getViewport(ge);c.set(s.x*Xe.x,s.y*Xe.y,s.x*Xe.z,s.y*Xe.w),$.viewport(c),Z.updateMatrices(de,ge),n=Z.getFrustum(),I(z,F,Z.camera,de,this.type)}Z.isPointLightShadow!==!0&&this.type===Ai&&R(Z,F),Z.needsUpdate=!1}m=this.type,h.needsUpdate=!1,i.setRenderTarget(T,A,O)};function R(U,z){const F=e.update(C);f.defines.VSM_SAMPLES!==U.blurSamples&&(f.defines.VSM_SAMPLES=U.blurSamples,v.defines.VSM_SAMPLES=U.blurSamples,f.needsUpdate=!0,v.needsUpdate=!0),U.mapPass===null&&(U.mapPass=new Ca(a.x,a.y)),f.uniforms.shadow_pass.value=U.map.texture,f.uniforms.resolution.value=U.mapSize,f.uniforms.radius.value=U.radius,i.setRenderTarget(U.mapPass),i.clear(),i.renderBufferDirect(z,null,F,f,C,null),v.uniforms.shadow_pass.value=U.mapPass.texture,v.uniforms.resolution.value=U.mapSize,v.uniforms.radius.value=U.radius,i.setRenderTarget(U.map),i.clear(),i.renderBufferDirect(z,null,F,v,C,null)}function w(U,z,F,T){let A=null;const O=F.isPointLight===!0?U.customDistanceMaterial:U.customDepthMaterial;if(O!==void 0)A=O;else if(A=F.isPointLight===!0?u:l,i.localClippingEnabled&&z.clipShadows===!0&&Array.isArray(z.clippingPlanes)&&z.clippingPlanes.length!==0||z.displacementMap&&z.displacementScale!==0||z.alphaMap&&z.alphaTest>0||z.map&&z.alphaTest>0){const $=A.uuid,J=z.uuid;let Y=d[$];Y===void 0&&(Y={},d[$]=Y);let ne=Y[J];ne===void 0&&(ne=A.clone(),Y[J]=ne,z.addEventListener("dispose",j)),A=ne}if(A.visible=z.visible,A.wireframe=z.wireframe,T===Ai?A.side=z.shadowSide!==null?z.shadowSide:z.side:A.side=z.shadowSide!==null?z.shadowSide:g[z.side],A.alphaMap=z.alphaMap,A.alphaTest=z.alphaTest,A.map=z.map,A.clipShadows=z.clipShadows,A.clippingPlanes=z.clippingPlanes,A.clipIntersection=z.clipIntersection,A.displacementMap=z.displacementMap,A.displacementScale=z.displacementScale,A.displacementBias=z.displacementBias,A.wireframeLinewidth=z.wireframeLinewidth,A.linewidth=z.linewidth,F.isPointLight===!0&&A.isMeshDistanceMaterial===!0){const $=i.properties.get(A);$.light=F}return A}function I(U,z,F,T,A){if(U.visible===!1)return;if(U.layers.test(z.layers)&&(U.isMesh||U.isLine||U.isPoints)&&(U.castShadow||U.receiveShadow&&A===Ai)&&(!U.frustumCulled||n.intersectsObject(U))){U.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,U.matrixWorld);const J=e.update(U),Y=U.material;if(Array.isArray(Y)){const ne=J.groups;for(let oe=0,de=ne.length;oe<de;oe++){const Z=ne[oe],Ue=Y[Z.materialIndex];if(Ue&&Ue.visible){const ie=w(U,Ue,T,A);U.onBeforeShadow(i,U,z,F,J,ie,Z),i.renderBufferDirect(F,null,J,ie,U,Z),U.onAfterShadow(i,U,z,F,J,ie,Z)}}}else if(Y.visible){const ne=w(U,Y,T,A);U.onBeforeShadow(i,U,z,F,J,ne,null),i.renderBufferDirect(F,null,J,ne,U,null),U.onAfterShadow(i,U,z,F,J,ne,null)}}const $=U.children;for(let J=0,Y=$.length;J<Y;J++)I($[J],z,F,T,A)}function j(U){U.target.removeEventListener("dispose",j);for(const F in d){const T=d[F],A=U.target.uuid;A in T&&(T[A].dispose(),delete T[A])}}}function lg(i){function e(){let G=!1;const Ae=new sn;let Me=null;const _e=new sn(0,0,0,0);return{setMask:function(Pe){Me!==Pe&&!G&&(i.colorMask(Pe,Pe,Pe,Pe),Me=Pe)},setLocked:function(Pe){G=Pe},setClear:function(Pe,$e,Qe,lt,ut){ut===!0&&(Pe*=lt,$e*=lt,Qe*=lt),Ae.set(Pe,$e,Qe,lt),_e.equals(Ae)===!1&&(i.clearColor(Pe,$e,Qe,lt),_e.copy(Ae))},reset:function(){G=!1,Me=null,_e.set(-1,0,0,0)}}}function t(){let G=!1,Ae=null,Me=null,_e=null;return{setTest:function(Pe){Pe?Le(i.DEPTH_TEST):Te(i.DEPTH_TEST)},setMask:function(Pe){Ae!==Pe&&!G&&(i.depthMask(Pe),Ae=Pe)},setFunc:function(Pe){if(Me!==Pe){switch(Pe){case qd:i.depthFunc(i.NEVER);break;case Fd:i.depthFunc(i.ALWAYS);break;case Od:i.depthFunc(i.LESS);break;case Po:i.depthFunc(i.LEQUAL);break;case zd:i.depthFunc(i.EQUAL);break;case Bd:i.depthFunc(i.GEQUAL);break;case Hd:i.depthFunc(i.GREATER);break;case kd:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}Me=Pe}},setLocked:function(Pe){G=Pe},setClear:function(Pe){_e!==Pe&&(i.clearDepth(Pe),_e=Pe)},reset:function(){G=!1,Ae=null,Me=null,_e=null}}}function n(){let G=!1,Ae=null,Me=null,_e=null,Pe=null,$e=null,Qe=null,lt=null,ut=null;return{setTest:function(et){G||(et?Le(i.STENCIL_TEST):Te(i.STENCIL_TEST))},setMask:function(et){Ae!==et&&!G&&(i.stencilMask(et),Ae=et)},setFunc:function(et,dt,pt){(Me!==et||_e!==dt||Pe!==pt)&&(i.stencilFunc(et,dt,pt),Me=et,_e=dt,Pe=pt)},setOp:function(et,dt,pt){($e!==et||Qe!==dt||lt!==pt)&&(i.stencilOp(et,dt,pt),$e=et,Qe=dt,lt=pt)},setLocked:function(et){G=et},setClear:function(et){ut!==et&&(i.clearStencil(et),ut=et)},reset:function(){G=!1,Ae=null,Me=null,_e=null,Pe=null,$e=null,Qe=null,lt=null,ut=null}}}const a=new e,s=new t,c=new n,l=new WeakMap,u=new WeakMap;let d={},p={},g=new WeakMap,f=[],v=null,E=!1,C=null,h=null,m=null,R=null,w=null,I=null,j=null,U=new Tt(0,0,0),z=0,F=!1,T=null,A=null,O=null,$=null,J=null;const Y=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let ne=!1,oe=0;const de=i.getParameter(i.VERSION);de.indexOf("WebGL")!==-1?(oe=parseFloat(/^WebGL (\d)/.exec(de)[1]),ne=oe>=1):de.indexOf("OpenGL ES")!==-1&&(oe=parseFloat(/^OpenGL ES (\d)/.exec(de)[1]),ne=oe>=2);let Z=null,Ue={};const ie=i.getParameter(i.SCISSOR_BOX),ge=i.getParameter(i.VIEWPORT),Xe=new sn().fromArray(ie),ke=new sn().fromArray(ge);function te(G,Ae,Me,_e){const Pe=new Uint8Array(4),$e=i.createTexture();i.bindTexture(G,$e),i.texParameteri(G,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(G,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Qe=0;Qe<Me;Qe++)G===i.TEXTURE_3D||G===i.TEXTURE_2D_ARRAY?i.texImage3D(Ae,0,i.RGBA,1,1,_e,0,i.RGBA,i.UNSIGNED_BYTE,Pe):i.texImage2D(Ae+Qe,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Pe);return $e}const Ce={};Ce[i.TEXTURE_2D]=te(i.TEXTURE_2D,i.TEXTURE_2D,1),Ce[i.TEXTURE_CUBE_MAP]=te(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Ce[i.TEXTURE_2D_ARRAY]=te(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Ce[i.TEXTURE_3D]=te(i.TEXTURE_3D,i.TEXTURE_3D,1,1),a.setClear(0,0,0,1),s.setClear(1),c.setClear(0),Le(i.DEPTH_TEST),s.setFunc(Po),Ve(!1),Ie(zl),Le(i.CULL_FACE),Ze(ki);function Le(G){d[G]!==!0&&(i.enable(G),d[G]=!0)}function Te(G){d[G]!==!1&&(i.disable(G),d[G]=!1)}function He(G,Ae){return p[G]!==Ae?(i.bindFramebuffer(G,Ae),p[G]=Ae,G===i.DRAW_FRAMEBUFFER&&(p[i.FRAMEBUFFER]=Ae),G===i.FRAMEBUFFER&&(p[i.DRAW_FRAMEBUFFER]=Ae),!0):!1}function ue(G,Ae){let Me=f,_e=!1;if(G){Me=g.get(Ae),Me===void 0&&(Me=[],g.set(Ae,Me));const Pe=G.textures;if(Me.length!==Pe.length||Me[0]!==i.COLOR_ATTACHMENT0){for(let $e=0,Qe=Pe.length;$e<Qe;$e++)Me[$e]=i.COLOR_ATTACHMENT0+$e;Me.length=Pe.length,_e=!0}}else Me[0]!==i.BACK&&(Me[0]=i.BACK,_e=!0);_e&&i.drawBuffers(Me)}function we(G){return v!==G?(i.useProgram(G),v=G,!0):!1}const at={[_a]:i.FUNC_ADD,[xd]:i.FUNC_SUBTRACT,[bd]:i.FUNC_REVERSE_SUBTRACT};at[yd]=i.MIN,at[Md]=i.MAX;const q={[Sd]:i.ZERO,[Cd]:i.ONE,[Ed]:i.SRC_COLOR,[yr]:i.SRC_ALPHA,[Ld]:i.SRC_ALPHA_SATURATE,[Pd]:i.DST_COLOR,[Ad]:i.DST_ALPHA,[Td]:i.ONE_MINUS_SRC_COLOR,[Mr]:i.ONE_MINUS_SRC_ALPHA,[Rd]:i.ONE_MINUS_DST_COLOR,[wd]:i.ONE_MINUS_DST_ALPHA,[Dd]:i.CONSTANT_COLOR,[Ud]:i.ONE_MINUS_CONSTANT_COLOR,[Id]:i.CONSTANT_ALPHA,[Nd]:i.ONE_MINUS_CONSTANT_ALPHA};function Ze(G,Ae,Me,_e,Pe,$e,Qe,lt,ut,et){if(G===ki){E===!0&&(Te(i.BLEND),E=!1);return}if(E===!1&&(Le(i.BLEND),E=!0),G!==_d){if(G!==C||et!==F){if((h!==_a||w!==_a)&&(i.blendEquation(i.FUNC_ADD),h=_a,w=_a),et)switch(G){case Ga:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Bl:i.blendFunc(i.ONE,i.ONE);break;case Hl:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case kl:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",G);break}else switch(G){case Ga:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Bl:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Hl:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case kl:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",G);break}m=null,R=null,I=null,j=null,U.set(0,0,0),z=0,C=G,F=et}return}Pe=Pe||Ae,$e=$e||Me,Qe=Qe||_e,(Ae!==h||Pe!==w)&&(i.blendEquationSeparate(at[Ae],at[Pe]),h=Ae,w=Pe),(Me!==m||_e!==R||$e!==I||Qe!==j)&&(i.blendFuncSeparate(q[Me],q[_e],q[$e],q[Qe]),m=Me,R=_e,I=$e,j=Qe),(lt.equals(U)===!1||ut!==z)&&(i.blendColor(lt.r,lt.g,lt.b,ut),U.copy(lt),z=ut),C=G,F=!1}function nt(G,Ae){G.side===wi?Te(i.CULL_FACE):Le(i.CULL_FACE);let Me=G.side===On;Ae&&(Me=!Me),Ve(Me),G.blending===Ga&&G.transparent===!1?Ze(ki):Ze(G.blending,G.blendEquation,G.blendSrc,G.blendDst,G.blendEquationAlpha,G.blendSrcAlpha,G.blendDstAlpha,G.blendColor,G.blendAlpha,G.premultipliedAlpha),s.setFunc(G.depthFunc),s.setTest(G.depthTest),s.setMask(G.depthWrite),a.setMask(G.colorWrite);const _e=G.stencilWrite;c.setTest(_e),_e&&(c.setMask(G.stencilWriteMask),c.setFunc(G.stencilFunc,G.stencilRef,G.stencilFuncMask),c.setOp(G.stencilFail,G.stencilZFail,G.stencilZPass)),Fe(G.polygonOffset,G.polygonOffsetFactor,G.polygonOffsetUnits),G.alphaToCoverage===!0?Le(i.SAMPLE_ALPHA_TO_COVERAGE):Te(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ve(G){T!==G&&(G?i.frontFace(i.CW):i.frontFace(i.CCW),T=G)}function Ie(G){G!==md?(Le(i.CULL_FACE),G!==A&&(G===zl?i.cullFace(i.BACK):G===vd?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Te(i.CULL_FACE),A=G}function st(G){G!==O&&(ne&&i.lineWidth(G),O=G)}function Fe(G,Ae,Me){G?(Le(i.POLYGON_OFFSET_FILL),($!==Ae||J!==Me)&&(i.polygonOffset(Ae,Me),$=Ae,J=Me)):Te(i.POLYGON_OFFSET_FILL)}function Oe(G){G?Le(i.SCISSOR_TEST):Te(i.SCISSOR_TEST)}function N(G){G===void 0&&(G=i.TEXTURE0+Y-1),Z!==G&&(i.activeTexture(G),Z=G)}function _(G,Ae,Me){Me===void 0&&(Z===null?Me=i.TEXTURE0+Y-1:Me=Z);let _e=Ue[Me];_e===void 0&&(_e={type:void 0,texture:void 0},Ue[Me]=_e),(_e.type!==G||_e.texture!==Ae)&&(Z!==Me&&(i.activeTexture(Me),Z=Me),i.bindTexture(G,Ae||Ce[G]),_e.type=G,_e.texture=Ae)}function H(){const G=Ue[Z];G!==void 0&&G.type!==void 0&&(i.bindTexture(G.type,null),G.type=void 0,G.texture=void 0)}function ye(){try{i.compressedTexImage2D.apply(i,arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function fe(){try{i.compressedTexImage3D.apply(i,arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function pe(){try{i.texSubImage2D.apply(i,arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function je(){try{i.texSubImage3D.apply(i,arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function Ee(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function De(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function Ke(){try{i.texStorage2D.apply(i,arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function k(){try{i.texStorage3D.apply(i,arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function me(){try{i.texImage2D.apply(i,arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function tt(){try{i.texImage3D.apply(i,arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function K(G){Xe.equals(G)===!1&&(i.scissor(G.x,G.y,G.z,G.w),Xe.copy(G))}function ve(G){ke.equals(G)===!1&&(i.viewport(G.x,G.y,G.z,G.w),ke.copy(G))}function We(G,Ae){let Me=u.get(Ae);Me===void 0&&(Me=new WeakMap,u.set(Ae,Me));let _e=Me.get(G);_e===void 0&&(_e=i.getUniformBlockIndex(Ae,G.name),Me.set(G,_e))}function Je(G,Ae){const _e=u.get(Ae).get(G);l.get(Ae)!==_e&&(i.uniformBlockBinding(Ae,_e,G.__bindingPointIndex),l.set(Ae,_e))}function ct(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),d={},Z=null,Ue={},p={},g=new WeakMap,f=[],v=null,E=!1,C=null,h=null,m=null,R=null,w=null,I=null,j=null,U=new Tt(0,0,0),z=0,F=!1,T=null,A=null,O=null,$=null,J=null,Xe.set(0,0,i.canvas.width,i.canvas.height),ke.set(0,0,i.canvas.width,i.canvas.height),a.reset(),s.reset(),c.reset()}return{buffers:{color:a,depth:s,stencil:c},enable:Le,disable:Te,bindFramebuffer:He,drawBuffers:ue,useProgram:we,setBlending:Ze,setMaterial:nt,setFlipSided:Ve,setCullFace:Ie,setLineWidth:st,setPolygonOffset:Fe,setScissorTest:Oe,activeTexture:N,bindTexture:_,unbindTexture:H,compressedTexImage2D:ye,compressedTexImage3D:fe,texImage2D:me,texImage3D:tt,updateUBOMapping:We,uniformBlockBinding:Je,texStorage2D:Ke,texStorage3D:k,texSubImage2D:pe,texSubImage3D:je,compressedTexSubImage2D:Ee,compressedTexSubImage3D:De,scissor:K,viewport:ve,reset:ct}}function Ic(i,e,t,n){const a=cg(n);switch(t){case Jc:return i*e;case eu:return i*e;case tu:return i*e*2;case nu:return i*e/a.components*a.byteLength;case ll:return i*e/a.components*a.byteLength;case iu:return i*e*2/a.components*a.byteLength;case cl:return i*e*2/a.components*a.byteLength;case Qc:return i*e*3/a.components*a.byteLength;case ei:return i*e*4/a.components*a.byteLength;case ul:return i*e*4/a.components*a.byteLength;case yo:case Mo:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case So:case Co:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case wr:case Rr:return Math.max(i,16)*Math.max(e,8)/4;case Ar:case Pr:return Math.max(i,8)*Math.max(e,8)/2;case Lr:case Dr:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case Ur:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Ir:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Nr:return Math.floor((i+4)/5)*Math.floor((e+3)/4)*16;case qr:return Math.floor((i+4)/5)*Math.floor((e+4)/5)*16;case Fr:return Math.floor((i+5)/6)*Math.floor((e+4)/5)*16;case Or:return Math.floor((i+5)/6)*Math.floor((e+5)/6)*16;case zr:return Math.floor((i+7)/8)*Math.floor((e+4)/5)*16;case Br:return Math.floor((i+7)/8)*Math.floor((e+5)/6)*16;case Hr:return Math.floor((i+7)/8)*Math.floor((e+7)/8)*16;case kr:return Math.floor((i+9)/10)*Math.floor((e+4)/5)*16;case Vr:return Math.floor((i+9)/10)*Math.floor((e+5)/6)*16;case Gr:return Math.floor((i+9)/10)*Math.floor((e+7)/8)*16;case jr:return Math.floor((i+9)/10)*Math.floor((e+9)/10)*16;case Wr:return Math.floor((i+11)/12)*Math.floor((e+9)/10)*16;case $r:return Math.floor((i+11)/12)*Math.floor((e+11)/12)*16;case Eo:case Xr:case Yr:return Math.ceil(i/4)*Math.ceil(e/4)*16;case au:case Zr:return Math.ceil(i/4)*Math.ceil(e/4)*8;case Kr:case Jr:return Math.ceil(i/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function cg(i){switch(i){case Li:case Yc:return{byteLength:1,components:1};case Ps:case Zc:case Ls:return{byteLength:2,components:1};case ol:case rl:return{byteLength:2,components:4};case Sa:case sl:case Pi:return{byteLength:4,components:1};case Kc:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function ug(i,e,t,n,a,s,c){const l=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,u=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),d=new Ot,p=new WeakMap;let g;const f=new WeakMap;let v=!1;try{v=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(N,_){return v?new OffscreenCanvas(N,_):Io("canvas")}function C(N,_,H){let ye=1;const fe=Oe(N);if((fe.width>H||fe.height>H)&&(ye=H/Math.max(fe.width,fe.height)),ye<1)if(typeof HTMLImageElement<"u"&&N instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&N instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&N instanceof ImageBitmap||typeof VideoFrame<"u"&&N instanceof VideoFrame){const pe=Math.floor(ye*fe.width),je=Math.floor(ye*fe.height);g===void 0&&(g=E(pe,je));const Ee=_?E(pe,je):g;return Ee.width=pe,Ee.height=je,Ee.getContext("2d").drawImage(N,0,0,pe,je),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+fe.width+"x"+fe.height+") to ("+pe+"x"+je+")."),Ee}else return"data"in N&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+fe.width+"x"+fe.height+")."),N;return N}function h(N){return N.generateMipmaps&&N.minFilter!==Xn&&N.minFilter!==Qn}function m(N){i.generateMipmap(N)}function R(N,_,H,ye,fe=!1){if(N!==null){if(i[N]!==void 0)return i[N];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+N+"'")}let pe=_;if(_===i.RED&&(H===i.FLOAT&&(pe=i.R32F),H===i.HALF_FLOAT&&(pe=i.R16F),H===i.UNSIGNED_BYTE&&(pe=i.R8)),_===i.RED_INTEGER&&(H===i.UNSIGNED_BYTE&&(pe=i.R8UI),H===i.UNSIGNED_SHORT&&(pe=i.R16UI),H===i.UNSIGNED_INT&&(pe=i.R32UI),H===i.BYTE&&(pe=i.R8I),H===i.SHORT&&(pe=i.R16I),H===i.INT&&(pe=i.R32I)),_===i.RG&&(H===i.FLOAT&&(pe=i.RG32F),H===i.HALF_FLOAT&&(pe=i.RG16F),H===i.UNSIGNED_BYTE&&(pe=i.RG8)),_===i.RG_INTEGER&&(H===i.UNSIGNED_BYTE&&(pe=i.RG8UI),H===i.UNSIGNED_SHORT&&(pe=i.RG16UI),H===i.UNSIGNED_INT&&(pe=i.RG32UI),H===i.BYTE&&(pe=i.RG8I),H===i.SHORT&&(pe=i.RG16I),H===i.INT&&(pe=i.RG32I)),_===i.RGB&&H===i.UNSIGNED_INT_5_9_9_9_REV&&(pe=i.RGB9_E5),_===i.RGBA){const je=fe?Ro:kt.getTransfer(ye);H===i.FLOAT&&(pe=i.RGBA32F),H===i.HALF_FLOAT&&(pe=i.RGBA16F),H===i.UNSIGNED_BYTE&&(pe=je===$t?i.SRGB8_ALPHA8:i.RGBA8),H===i.UNSIGNED_SHORT_4_4_4_4&&(pe=i.RGBA4),H===i.UNSIGNED_SHORT_5_5_5_1&&(pe=i.RGB5_A1)}return(pe===i.R16F||pe===i.R32F||pe===i.RG16F||pe===i.RG32F||pe===i.RGBA16F||pe===i.RGBA32F)&&e.get("EXT_color_buffer_float"),pe}function w(N,_){let H;return N?_===null||_===Sa||_===Qa?H=i.DEPTH24_STENCIL8:_===Pi?H=i.DEPTH32F_STENCIL8:_===Ps&&(H=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===Sa||_===Qa?H=i.DEPTH_COMPONENT24:_===Pi?H=i.DEPTH_COMPONENT32F:_===Ps&&(H=i.DEPTH_COMPONENT16),H}function I(N,_){return h(N)===!0||N.isFramebufferTexture&&N.minFilter!==Xn&&N.minFilter!==Qn?Math.log2(Math.max(_.width,_.height))+1:N.mipmaps!==void 0&&N.mipmaps.length>0?N.mipmaps.length:N.isCompressedTexture&&Array.isArray(N.image)?_.mipmaps.length:1}function j(N){const _=N.target;_.removeEventListener("dispose",j),z(_),_.isVideoTexture&&p.delete(_)}function U(N){const _=N.target;_.removeEventListener("dispose",U),T(_)}function z(N){const _=n.get(N);if(_.__webglInit===void 0)return;const H=N.source,ye=f.get(H);if(ye){const fe=ye[_.__cacheKey];fe.usedTimes--,fe.usedTimes===0&&F(N),Object.keys(ye).length===0&&f.delete(H)}n.remove(N)}function F(N){const _=n.get(N);i.deleteTexture(_.__webglTexture);const H=N.source,ye=f.get(H);delete ye[_.__cacheKey],c.memory.textures--}function T(N){const _=n.get(N);if(N.depthTexture&&N.depthTexture.dispose(),N.isWebGLCubeRenderTarget)for(let ye=0;ye<6;ye++){if(Array.isArray(_.__webglFramebuffer[ye]))for(let fe=0;fe<_.__webglFramebuffer[ye].length;fe++)i.deleteFramebuffer(_.__webglFramebuffer[ye][fe]);else i.deleteFramebuffer(_.__webglFramebuffer[ye]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[ye])}else{if(Array.isArray(_.__webglFramebuffer))for(let ye=0;ye<_.__webglFramebuffer.length;ye++)i.deleteFramebuffer(_.__webglFramebuffer[ye]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let ye=0;ye<_.__webglColorRenderbuffer.length;ye++)_.__webglColorRenderbuffer[ye]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[ye]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const H=N.textures;for(let ye=0,fe=H.length;ye<fe;ye++){const pe=n.get(H[ye]);pe.__webglTexture&&(i.deleteTexture(pe.__webglTexture),c.memory.textures--),n.remove(H[ye])}n.remove(N)}let A=0;function O(){A=0}function $(){const N=A;return N>=a.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+N+" texture units while this GPU supports only "+a.maxTextures),A+=1,N}function J(N){const _=[];return _.push(N.wrapS),_.push(N.wrapT),_.push(N.wrapR||0),_.push(N.magFilter),_.push(N.minFilter),_.push(N.anisotropy),_.push(N.internalFormat),_.push(N.format),_.push(N.type),_.push(N.generateMipmaps),_.push(N.premultiplyAlpha),_.push(N.flipY),_.push(N.unpackAlignment),_.push(N.colorSpace),_.join()}function Y(N,_){const H=n.get(N);if(N.isVideoTexture&&st(N),N.isRenderTargetTexture===!1&&N.version>0&&H.__version!==N.version){const ye=N.image;if(ye===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ye.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{ke(H,N,_);return}}t.bindTexture(i.TEXTURE_2D,H.__webglTexture,i.TEXTURE0+_)}function ne(N,_){const H=n.get(N);if(N.version>0&&H.__version!==N.version){ke(H,N,_);return}t.bindTexture(i.TEXTURE_2D_ARRAY,H.__webglTexture,i.TEXTURE0+_)}function oe(N,_){const H=n.get(N);if(N.version>0&&H.__version!==N.version){ke(H,N,_);return}t.bindTexture(i.TEXTURE_3D,H.__webglTexture,i.TEXTURE0+_)}function de(N,_){const H=n.get(N);if(N.version>0&&H.__version!==N.version){te(H,N,_);return}t.bindTexture(i.TEXTURE_CUBE_MAP,H.__webglTexture,i.TEXTURE0+_)}const Z={[Er]:i.REPEAT,[ba]:i.CLAMP_TO_EDGE,[Tr]:i.MIRRORED_REPEAT},Ue={[Xn]:i.NEAREST,[Jd]:i.NEAREST_MIPMAP_NEAREST,[Xs]:i.NEAREST_MIPMAP_LINEAR,[Qn]:i.LINEAR,[Go]:i.LINEAR_MIPMAP_NEAREST,[ya]:i.LINEAR_MIPMAP_LINEAR},ie={[np]:i.NEVER,[lp]:i.ALWAYS,[ip]:i.LESS,[ou]:i.LEQUAL,[ap]:i.EQUAL,[rp]:i.GEQUAL,[sp]:i.GREATER,[op]:i.NOTEQUAL};function ge(N,_){if(_.type===Pi&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===Qn||_.magFilter===Go||_.magFilter===Xs||_.magFilter===ya||_.minFilter===Qn||_.minFilter===Go||_.minFilter===Xs||_.minFilter===ya)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(N,i.TEXTURE_WRAP_S,Z[_.wrapS]),i.texParameteri(N,i.TEXTURE_WRAP_T,Z[_.wrapT]),(N===i.TEXTURE_3D||N===i.TEXTURE_2D_ARRAY)&&i.texParameteri(N,i.TEXTURE_WRAP_R,Z[_.wrapR]),i.texParameteri(N,i.TEXTURE_MAG_FILTER,Ue[_.magFilter]),i.texParameteri(N,i.TEXTURE_MIN_FILTER,Ue[_.minFilter]),_.compareFunction&&(i.texParameteri(N,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(N,i.TEXTURE_COMPARE_FUNC,ie[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Xn||_.minFilter!==Xs&&_.minFilter!==ya||_.type===Pi&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const H=e.get("EXT_texture_filter_anisotropic");i.texParameterf(N,H.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,a.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function Xe(N,_){let H=!1;N.__webglInit===void 0&&(N.__webglInit=!0,_.addEventListener("dispose",j));const ye=_.source;let fe=f.get(ye);fe===void 0&&(fe={},f.set(ye,fe));const pe=J(_);if(pe!==N.__cacheKey){fe[pe]===void 0&&(fe[pe]={texture:i.createTexture(),usedTimes:0},c.memory.textures++,H=!0),fe[pe].usedTimes++;const je=fe[N.__cacheKey];je!==void 0&&(fe[N.__cacheKey].usedTimes--,je.usedTimes===0&&F(_)),N.__cacheKey=pe,N.__webglTexture=fe[pe].texture}return H}function ke(N,_,H){let ye=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(ye=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(ye=i.TEXTURE_3D);const fe=Xe(N,_),pe=_.source;t.bindTexture(ye,N.__webglTexture,i.TEXTURE0+H);const je=n.get(pe);if(pe.version!==je.__version||fe===!0){t.activeTexture(i.TEXTURE0+H);const Ee=kt.getPrimaries(kt.workingColorSpace),De=_.colorSpace===Hi?null:kt.getPrimaries(_.colorSpace),Ke=_.colorSpace===Hi||Ee===De?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ke);let k=C(_.image,!1,a.maxTextureSize);k=Fe(_,k);const me=s.convert(_.format,_.colorSpace),tt=s.convert(_.type);let K=R(_.internalFormat,me,tt,_.colorSpace,_.isVideoTexture);ge(ye,_);let ve;const We=_.mipmaps,Je=_.isVideoTexture!==!0,ct=je.__version===void 0||fe===!0,G=pe.dataReady,Ae=I(_,k);if(_.isDepthTexture)K=w(_.format===es,_.type),ct&&(Je?t.texStorage2D(i.TEXTURE_2D,1,K,k.width,k.height):t.texImage2D(i.TEXTURE_2D,0,K,k.width,k.height,0,me,tt,null));else if(_.isDataTexture)if(We.length>0){Je&&ct&&t.texStorage2D(i.TEXTURE_2D,Ae,K,We[0].width,We[0].height);for(let Me=0,_e=We.length;Me<_e;Me++)ve=We[Me],Je?G&&t.texSubImage2D(i.TEXTURE_2D,Me,0,0,ve.width,ve.height,me,tt,ve.data):t.texImage2D(i.TEXTURE_2D,Me,K,ve.width,ve.height,0,me,tt,ve.data);_.generateMipmaps=!1}else Je?(ct&&t.texStorage2D(i.TEXTURE_2D,Ae,K,k.width,k.height),G&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,k.width,k.height,me,tt,k.data)):t.texImage2D(i.TEXTURE_2D,0,K,k.width,k.height,0,me,tt,k.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Je&&ct&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Ae,K,We[0].width,We[0].height,k.depth);for(let Me=0,_e=We.length;Me<_e;Me++)if(ve=We[Me],_.format!==ei)if(me!==null)if(Je){if(G)if(_.layerUpdates.size>0){const Pe=Ic(ve.width,ve.height,_.format,_.type);for(const $e of _.layerUpdates){const Qe=ve.data.subarray($e*Pe/ve.data.BYTES_PER_ELEMENT,($e+1)*Pe/ve.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Me,0,0,$e,ve.width,ve.height,1,me,Qe,0,0)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Me,0,0,0,ve.width,ve.height,k.depth,me,ve.data,0,0)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Me,K,ve.width,ve.height,k.depth,0,ve.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Je?G&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,Me,0,0,0,ve.width,ve.height,k.depth,me,tt,ve.data):t.texImage3D(i.TEXTURE_2D_ARRAY,Me,K,ve.width,ve.height,k.depth,0,me,tt,ve.data)}else{Je&&ct&&t.texStorage2D(i.TEXTURE_2D,Ae,K,We[0].width,We[0].height);for(let Me=0,_e=We.length;Me<_e;Me++)ve=We[Me],_.format!==ei?me!==null?Je?G&&t.compressedTexSubImage2D(i.TEXTURE_2D,Me,0,0,ve.width,ve.height,me,ve.data):t.compressedTexImage2D(i.TEXTURE_2D,Me,K,ve.width,ve.height,0,ve.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Je?G&&t.texSubImage2D(i.TEXTURE_2D,Me,0,0,ve.width,ve.height,me,tt,ve.data):t.texImage2D(i.TEXTURE_2D,Me,K,ve.width,ve.height,0,me,tt,ve.data)}else if(_.isDataArrayTexture)if(Je){if(ct&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Ae,K,k.width,k.height,k.depth),G)if(_.layerUpdates.size>0){const Me=Ic(k.width,k.height,_.format,_.type);for(const _e of _.layerUpdates){const Pe=k.data.subarray(_e*Me/k.data.BYTES_PER_ELEMENT,(_e+1)*Me/k.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,_e,k.width,k.height,1,me,tt,Pe)}_.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,k.width,k.height,k.depth,me,tt,k.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,K,k.width,k.height,k.depth,0,me,tt,k.data);else if(_.isData3DTexture)Je?(ct&&t.texStorage3D(i.TEXTURE_3D,Ae,K,k.width,k.height,k.depth),G&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,k.width,k.height,k.depth,me,tt,k.data)):t.texImage3D(i.TEXTURE_3D,0,K,k.width,k.height,k.depth,0,me,tt,k.data);else if(_.isFramebufferTexture){if(ct)if(Je)t.texStorage2D(i.TEXTURE_2D,Ae,K,k.width,k.height);else{let Me=k.width,_e=k.height;for(let Pe=0;Pe<Ae;Pe++)t.texImage2D(i.TEXTURE_2D,Pe,K,Me,_e,0,me,tt,null),Me>>=1,_e>>=1}}else if(We.length>0){if(Je&&ct){const Me=Oe(We[0]);t.texStorage2D(i.TEXTURE_2D,Ae,K,Me.width,Me.height)}for(let Me=0,_e=We.length;Me<_e;Me++)ve=We[Me],Je?G&&t.texSubImage2D(i.TEXTURE_2D,Me,0,0,me,tt,ve):t.texImage2D(i.TEXTURE_2D,Me,K,me,tt,ve);_.generateMipmaps=!1}else if(Je){if(ct){const Me=Oe(k);t.texStorage2D(i.TEXTURE_2D,Ae,K,Me.width,Me.height)}G&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,me,tt,k)}else t.texImage2D(i.TEXTURE_2D,0,K,me,tt,k);h(_)&&m(ye),je.__version=pe.version,_.onUpdate&&_.onUpdate(_)}N.__version=_.version}function te(N,_,H){if(_.image.length!==6)return;const ye=Xe(N,_),fe=_.source;t.bindTexture(i.TEXTURE_CUBE_MAP,N.__webglTexture,i.TEXTURE0+H);const pe=n.get(fe);if(fe.version!==pe.__version||ye===!0){t.activeTexture(i.TEXTURE0+H);const je=kt.getPrimaries(kt.workingColorSpace),Ee=_.colorSpace===Hi?null:kt.getPrimaries(_.colorSpace),De=_.colorSpace===Hi||je===Ee?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,De);const Ke=_.isCompressedTexture||_.image[0].isCompressedTexture,k=_.image[0]&&_.image[0].isDataTexture,me=[];for(let _e=0;_e<6;_e++)!Ke&&!k?me[_e]=C(_.image[_e],!0,a.maxCubemapSize):me[_e]=k?_.image[_e].image:_.image[_e],me[_e]=Fe(_,me[_e]);const tt=me[0],K=s.convert(_.format,_.colorSpace),ve=s.convert(_.type),We=R(_.internalFormat,K,ve,_.colorSpace),Je=_.isVideoTexture!==!0,ct=pe.__version===void 0||ye===!0,G=fe.dataReady;let Ae=I(_,tt);ge(i.TEXTURE_CUBE_MAP,_);let Me;if(Ke){Je&&ct&&t.texStorage2D(i.TEXTURE_CUBE_MAP,Ae,We,tt.width,tt.height);for(let _e=0;_e<6;_e++){Me=me[_e].mipmaps;for(let Pe=0;Pe<Me.length;Pe++){const $e=Me[Pe];_.format!==ei?K!==null?Je?G&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,Pe,0,0,$e.width,$e.height,K,$e.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,Pe,We,$e.width,$e.height,0,$e.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Je?G&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,Pe,0,0,$e.width,$e.height,K,ve,$e.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,Pe,We,$e.width,$e.height,0,K,ve,$e.data)}}}else{if(Me=_.mipmaps,Je&&ct){Me.length>0&&Ae++;const _e=Oe(me[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,Ae,We,_e.width,_e.height)}for(let _e=0;_e<6;_e++)if(k){Je?G&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,0,0,0,me[_e].width,me[_e].height,K,ve,me[_e].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,0,We,me[_e].width,me[_e].height,0,K,ve,me[_e].data);for(let Pe=0;Pe<Me.length;Pe++){const Qe=Me[Pe].image[_e].image;Je?G&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,Pe+1,0,0,Qe.width,Qe.height,K,ve,Qe.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,Pe+1,We,Qe.width,Qe.height,0,K,ve,Qe.data)}}else{Je?G&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,0,0,0,K,ve,me[_e]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,0,We,K,ve,me[_e]);for(let Pe=0;Pe<Me.length;Pe++){const $e=Me[Pe];Je?G&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,Pe+1,0,0,K,ve,$e.image[_e]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,Pe+1,We,K,ve,$e.image[_e])}}}h(_)&&m(i.TEXTURE_CUBE_MAP),pe.__version=fe.version,_.onUpdate&&_.onUpdate(_)}N.__version=_.version}function Ce(N,_,H,ye,fe,pe){const je=s.convert(H.format,H.colorSpace),Ee=s.convert(H.type),De=R(H.internalFormat,je,Ee,H.colorSpace);if(!n.get(_).__hasExternalTextures){const k=Math.max(1,_.width>>pe),me=Math.max(1,_.height>>pe);fe===i.TEXTURE_3D||fe===i.TEXTURE_2D_ARRAY?t.texImage3D(fe,pe,De,k,me,_.depth,0,je,Ee,null):t.texImage2D(fe,pe,De,k,me,0,je,Ee,null)}t.bindFramebuffer(i.FRAMEBUFFER,N),Ie(_)?l.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ye,fe,n.get(H).__webglTexture,0,Ve(_)):(fe===i.TEXTURE_2D||fe>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&fe<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,ye,fe,n.get(H).__webglTexture,pe),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Le(N,_,H){if(i.bindRenderbuffer(i.RENDERBUFFER,N),_.depthBuffer){const ye=_.depthTexture,fe=ye&&ye.isDepthTexture?ye.type:null,pe=w(_.stencilBuffer,fe),je=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Ee=Ve(_);Ie(_)?l.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ee,pe,_.width,_.height):H?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ee,pe,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,pe,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,je,i.RENDERBUFFER,N)}else{const ye=_.textures;for(let fe=0;fe<ye.length;fe++){const pe=ye[fe],je=s.convert(pe.format,pe.colorSpace),Ee=s.convert(pe.type),De=R(pe.internalFormat,je,Ee,pe.colorSpace),Ke=Ve(_);H&&Ie(_)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ke,De,_.width,_.height):Ie(_)?l.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ke,De,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,De,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Te(N,_){if(_&&_.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,N),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(_.depthTexture).__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),Y(_.depthTexture,0);const ye=n.get(_.depthTexture).__webglTexture,fe=Ve(_);if(_.depthTexture.format===ja)Ie(_)?l.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ye,0,fe):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ye,0);else if(_.depthTexture.format===es)Ie(_)?l.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ye,0,fe):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ye,0);else throw new Error("Unknown depthTexture format")}function He(N){const _=n.get(N),H=N.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==N.depthTexture){const ye=N.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),ye){const fe=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,ye.removeEventListener("dispose",fe)};ye.addEventListener("dispose",fe),_.__depthDisposeCallback=fe}_.__boundDepthTexture=ye}if(N.depthTexture&&!_.__autoAllocateDepthBuffer){if(H)throw new Error("target.depthTexture not supported in Cube render targets");Te(_.__webglFramebuffer,N)}else if(H){_.__webglDepthbuffer=[];for(let ye=0;ye<6;ye++)if(t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[ye]),_.__webglDepthbuffer[ye]===void 0)_.__webglDepthbuffer[ye]=i.createRenderbuffer(),Le(_.__webglDepthbuffer[ye],N,!1);else{const fe=N.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,pe=_.__webglDepthbuffer[ye];i.bindRenderbuffer(i.RENDERBUFFER,pe),i.framebufferRenderbuffer(i.FRAMEBUFFER,fe,i.RENDERBUFFER,pe)}}else if(t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),Le(_.__webglDepthbuffer,N,!1);else{const ye=N.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,fe=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,fe),i.framebufferRenderbuffer(i.FRAMEBUFFER,ye,i.RENDERBUFFER,fe)}t.bindFramebuffer(i.FRAMEBUFFER,null)}function ue(N,_,H){const ye=n.get(N);_!==void 0&&Ce(ye.__webglFramebuffer,N,N.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),H!==void 0&&He(N)}function we(N){const _=N.texture,H=n.get(N),ye=n.get(_);N.addEventListener("dispose",U);const fe=N.textures,pe=N.isWebGLCubeRenderTarget===!0,je=fe.length>1;if(je||(ye.__webglTexture===void 0&&(ye.__webglTexture=i.createTexture()),ye.__version=_.version,c.memory.textures++),pe){H.__webglFramebuffer=[];for(let Ee=0;Ee<6;Ee++)if(_.mipmaps&&_.mipmaps.length>0){H.__webglFramebuffer[Ee]=[];for(let De=0;De<_.mipmaps.length;De++)H.__webglFramebuffer[Ee][De]=i.createFramebuffer()}else H.__webglFramebuffer[Ee]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){H.__webglFramebuffer=[];for(let Ee=0;Ee<_.mipmaps.length;Ee++)H.__webglFramebuffer[Ee]=i.createFramebuffer()}else H.__webglFramebuffer=i.createFramebuffer();if(je)for(let Ee=0,De=fe.length;Ee<De;Ee++){const Ke=n.get(fe[Ee]);Ke.__webglTexture===void 0&&(Ke.__webglTexture=i.createTexture(),c.memory.textures++)}if(N.samples>0&&Ie(N)===!1){H.__webglMultisampledFramebuffer=i.createFramebuffer(),H.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,H.__webglMultisampledFramebuffer);for(let Ee=0;Ee<fe.length;Ee++){const De=fe[Ee];H.__webglColorRenderbuffer[Ee]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,H.__webglColorRenderbuffer[Ee]);const Ke=s.convert(De.format,De.colorSpace),k=s.convert(De.type),me=R(De.internalFormat,Ke,k,De.colorSpace,N.isXRRenderTarget===!0),tt=Ve(N);i.renderbufferStorageMultisample(i.RENDERBUFFER,tt,me,N.width,N.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ee,i.RENDERBUFFER,H.__webglColorRenderbuffer[Ee])}i.bindRenderbuffer(i.RENDERBUFFER,null),N.depthBuffer&&(H.__webglDepthRenderbuffer=i.createRenderbuffer(),Le(H.__webglDepthRenderbuffer,N,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(pe){t.bindTexture(i.TEXTURE_CUBE_MAP,ye.__webglTexture),ge(i.TEXTURE_CUBE_MAP,_);for(let Ee=0;Ee<6;Ee++)if(_.mipmaps&&_.mipmaps.length>0)for(let De=0;De<_.mipmaps.length;De++)Ce(H.__webglFramebuffer[Ee][De],N,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Ee,De);else Ce(H.__webglFramebuffer[Ee],N,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Ee,0);h(_)&&m(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(je){for(let Ee=0,De=fe.length;Ee<De;Ee++){const Ke=fe[Ee],k=n.get(Ke);t.bindTexture(i.TEXTURE_2D,k.__webglTexture),ge(i.TEXTURE_2D,Ke),Ce(H.__webglFramebuffer,N,Ke,i.COLOR_ATTACHMENT0+Ee,i.TEXTURE_2D,0),h(Ke)&&m(i.TEXTURE_2D)}t.unbindTexture()}else{let Ee=i.TEXTURE_2D;if((N.isWebGL3DRenderTarget||N.isWebGLArrayRenderTarget)&&(Ee=N.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(Ee,ye.__webglTexture),ge(Ee,_),_.mipmaps&&_.mipmaps.length>0)for(let De=0;De<_.mipmaps.length;De++)Ce(H.__webglFramebuffer[De],N,_,i.COLOR_ATTACHMENT0,Ee,De);else Ce(H.__webglFramebuffer,N,_,i.COLOR_ATTACHMENT0,Ee,0);h(_)&&m(Ee),t.unbindTexture()}N.depthBuffer&&He(N)}function at(N){const _=N.textures;for(let H=0,ye=_.length;H<ye;H++){const fe=_[H];if(h(fe)){const pe=N.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,je=n.get(fe).__webglTexture;t.bindTexture(pe,je),m(pe),t.unbindTexture()}}}const q=[],Ze=[];function nt(N){if(N.samples>0){if(Ie(N)===!1){const _=N.textures,H=N.width,ye=N.height;let fe=i.COLOR_BUFFER_BIT;const pe=N.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,je=n.get(N),Ee=_.length>1;if(Ee)for(let De=0;De<_.length;De++)t.bindFramebuffer(i.FRAMEBUFFER,je.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+De,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,je.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+De,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,je.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,je.__webglFramebuffer);for(let De=0;De<_.length;De++){if(N.resolveDepthBuffer&&(N.depthBuffer&&(fe|=i.DEPTH_BUFFER_BIT),N.stencilBuffer&&N.resolveStencilBuffer&&(fe|=i.STENCIL_BUFFER_BIT)),Ee){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,je.__webglColorRenderbuffer[De]);const Ke=n.get(_[De]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ke,0)}i.blitFramebuffer(0,0,H,ye,0,0,H,ye,fe,i.NEAREST),u===!0&&(q.length=0,Ze.length=0,q.push(i.COLOR_ATTACHMENT0+De),N.depthBuffer&&N.resolveDepthBuffer===!1&&(q.push(pe),Ze.push(pe),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Ze)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,q))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),Ee)for(let De=0;De<_.length;De++){t.bindFramebuffer(i.FRAMEBUFFER,je.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+De,i.RENDERBUFFER,je.__webglColorRenderbuffer[De]);const Ke=n.get(_[De]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,je.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+De,i.TEXTURE_2D,Ke,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,je.__webglMultisampledFramebuffer)}else if(N.depthBuffer&&N.resolveDepthBuffer===!1&&u){const _=N.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function Ve(N){return Math.min(a.maxSamples,N.samples)}function Ie(N){const _=n.get(N);return N.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function st(N){const _=c.render.frame;p.get(N)!==_&&(p.set(N,_),N.update())}function Fe(N,_){const H=N.colorSpace,ye=N.format,fe=N.type;return N.isCompressedTexture===!0||N.isVideoTexture===!0||H!==Wi&&H!==Hi&&(kt.getTransfer(H)===$t?(ye!==ei||fe!==Li)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",H)),_}function Oe(N){return typeof HTMLImageElement<"u"&&N instanceof HTMLImageElement?(d.width=N.naturalWidth||N.width,d.height=N.naturalHeight||N.height):typeof VideoFrame<"u"&&N instanceof VideoFrame?(d.width=N.displayWidth,d.height=N.displayHeight):(d.width=N.width,d.height=N.height),d}this.allocateTextureUnit=$,this.resetTextureUnits=O,this.setTexture2D=Y,this.setTexture2DArray=ne,this.setTexture3D=oe,this.setTextureCube=de,this.rebindTextures=ue,this.setupRenderTarget=we,this.updateRenderTargetMipmap=at,this.updateMultisampleRenderTarget=nt,this.setupDepthRenderbuffer=He,this.setupFrameBufferTexture=Ce,this.useMultisampledRTT=Ie}function dg(i,e){function t(n,a=Hi){let s;const c=kt.getTransfer(a);if(n===Li)return i.UNSIGNED_BYTE;if(n===ol)return i.UNSIGNED_SHORT_4_4_4_4;if(n===rl)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Kc)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Yc)return i.BYTE;if(n===Zc)return i.SHORT;if(n===Ps)return i.UNSIGNED_SHORT;if(n===sl)return i.INT;if(n===Sa)return i.UNSIGNED_INT;if(n===Pi)return i.FLOAT;if(n===Ls)return i.HALF_FLOAT;if(n===Jc)return i.ALPHA;if(n===Qc)return i.RGB;if(n===ei)return i.RGBA;if(n===eu)return i.LUMINANCE;if(n===tu)return i.LUMINANCE_ALPHA;if(n===ja)return i.DEPTH_COMPONENT;if(n===es)return i.DEPTH_STENCIL;if(n===nu)return i.RED;if(n===ll)return i.RED_INTEGER;if(n===iu)return i.RG;if(n===cl)return i.RG_INTEGER;if(n===ul)return i.RGBA_INTEGER;if(n===yo||n===Mo||n===So||n===Co)if(c===$t)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===yo)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Mo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===So)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Co)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===yo)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Mo)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===So)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Co)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Ar||n===wr||n===Pr||n===Rr)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Ar)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===wr)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Pr)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Rr)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Lr||n===Dr||n===Ur)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Lr||n===Dr)return c===$t?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Ur)return c===$t?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Ir||n===Nr||n===qr||n===Fr||n===Or||n===zr||n===Br||n===Hr||n===kr||n===Vr||n===Gr||n===jr||n===Wr||n===$r)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Ir)return c===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Nr)return c===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===qr)return c===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Fr)return c===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Or)return c===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===zr)return c===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Br)return c===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Hr)return c===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===kr)return c===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Vr)return c===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Gr)return c===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===jr)return c===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Wr)return c===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===$r)return c===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Eo||n===Xr||n===Yr)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===Eo)return c===$t?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Xr)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Yr)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===au||n===Zr||n===Kr||n===Jr)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===Eo)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Zr)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Kr)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Jr)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Qa?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class pg extends Wn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class As extends on{constructor(){super(),this.isGroup=!0,this.type="Group"}}const fg={type:"move"};class gr{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new As,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new As,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new be,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new be),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new As,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new be,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new be),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let a=null,s=null,c=null;const l=this._targetRay,u=this._grip,d=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(d&&e.hand){c=!0;for(const C of e.hand.values()){const h=t.getJointPose(C,n),m=this._getHandJoint(d,C);h!==null&&(m.matrix.fromArray(h.transform.matrix),m.matrix.decompose(m.position,m.rotation,m.scale),m.matrixWorldNeedsUpdate=!0,m.jointRadius=h.radius),m.visible=h!==null}const p=d.joints["index-finger-tip"],g=d.joints["thumb-tip"],f=p.position.distanceTo(g.position),v=.02,E=.005;d.inputState.pinching&&f>v+E?(d.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!d.inputState.pinching&&f<=v-E&&(d.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else u!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,n),s!==null&&(u.matrix.fromArray(s.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,s.linearVelocity?(u.hasLinearVelocity=!0,u.linearVelocity.copy(s.linearVelocity)):u.hasLinearVelocity=!1,s.angularVelocity?(u.hasAngularVelocity=!0,u.angularVelocity.copy(s.angularVelocity)):u.hasAngularVelocity=!1));l!==null&&(a=t.getPose(e.targetRaySpace,n),a===null&&s!==null&&(a=s),a!==null&&(l.matrix.fromArray(a.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,a.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(a.linearVelocity)):l.hasLinearVelocity=!1,a.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(a.angularVelocity)):l.hasAngularVelocity=!1,this.dispatchEvent(fg)))}return l!==null&&(l.visible=a!==null),u!==null&&(u.visible=s!==null),d!==null&&(d.visible=c!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new As;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const hg=`
void main() {
...
}`;class vg{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,n){if(this.texture===null){const a=new zn,s=e.properties.get(a);s.__webglTexture=t.texture,(t.depthNear!=n.depthNear||t.depthFar!=n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=a}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new ji({vertexShader:hg,fragmentShader:mg,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Yn(new Bo(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class gg extends ns{constructor(e,t){super();const n=this;let a=null,s=1,c=null,l="local-floor",u=1,d=null,p=null,g=null,f=null,v=null,E=null;const C=new vg,h=t.getContextAttributes();let m=null,R=null;const w=[],I=[],j=new Ot;let U=null;const z=new Wn;z.layers.enable(1),z.viewport=new sn;const F=new Wn;F.layers.enable(2),F.viewport=new sn;const T=[z,F],A=new pg;A.layers.enable(1),A.layers.enable(2);let O=null,$=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(te){let Ce=w[te];return Ce===void 0&&(Ce=new gr,w[te]=Ce),Ce.getTargetRaySpace()},this.getControllerGrip=function(te){let Ce=w[te];return Ce===void 0&&(Ce=new gr,w[te]=Ce),Ce.getGripSpace()},this.getHand=function(te){let Ce=w[te];return Ce===void 0&&(Ce=new gr,w[te]=Ce),Ce.getHandSpace()};function J(te){const Ce=I.indexOf(te.inputSource);if(Ce===-1)return;const Le=w[Ce];Le!==void 0&&(Le.update(te.inputSource,te.frame,d||c),Le.dispatchEvent({type:te.type,data:te.inputSource}))}function Y(){a.removeEventListener("select",J),a.removeEventListener("selectstart",J),a.removeEventListener("selectend",J),a.removeEventListener("squeeze",J),a.removeEventListener("squeezestart",J),a.removeEventListener("squeezeend",J),a.removeEventListener("end",Y),a.removeEventListener("inputsourceschange",ne);for(let te=0;te<w.length;te++){const Ce=I[te];Ce!==null&&(I[te]=null,w[te].disconnect(Ce))}O=null,$=null,C.reset(),e.setRenderTarget(m),v=null,f=null,g=null,a=null,R=null,ke.stop(),n.isPresenting=!1,e.setPixelRatio(U),e.setSize(j.width,j.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(te){s=te,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(te){l=te,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return d||c},this.setReferenceSpace=function(te){d=te},this.getBaseLayer=function(){return f!==null?f:v},this.getBinding=function(){return g},this.getFrame=function(){return E},this.getSession=function(){return a},this.setSession=async function(te){if(a=te,a!==null){if(m=e.getRenderTarget(),a.addEventListener("select",J),a.addEventListener("selectstart",J),a.addEventListener("selectend",J),a.addEventListener("squeeze",J),a.addEventListener("squeezestart",J),a.addEventListener("squeezeend",J),a.addEventListener("end",Y),a.addEventListener("inputsourceschange",ne),h.xrCompatible!==!0&&await t.makeXRCompatible(),U=e.getPixelRatio(),e.getSize(j),a.renderState.layers===void 0){const Ce={antialias:h.antialias,alpha:!0,depth:h.depth,stencil:h.stencil,framebufferScaleFactor:s};v=new XRWebGLLayer(a,t,Ce),a.updateRenderState({baseLayer:v}),e.setPixelRatio(1),e.setSize(v.framebufferWidth,v.framebufferHeight,!1),R=new Ca(v.framebufferWidth,v.framebufferHeight,{format:ei,type:Li,colorSpace:e.outputColorSpace,stencilBuffer:h.stencil})}else{let Ce=null,Le=null,Te=null;h.depth&&(Te=h.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,Ce=h.stencil?es:ja,Le=h.stencil?Qa:Sa);const He={colorFormat:t.RGBA8,depthFormat:Te,scaleFactor:s};g=new XRWebGLBinding(a,t),f=g.createProjectionLayer(He),a.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),R=new Ca(f.textureWidth,f.textureHeight,{format:ei,type:Li,depthTexture:new bu(f.textureWidth,f.textureHeight,Le,void 0,void 0,void 0,void 0,void 0,void 0,Ce),stencilBuffer:h.stencil,colorSpace:e.outputColorSpace,samples:h.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1})}R.isXRRenderTarget=!0,this.setFoveation(u),d=null,c=await a.requestReferenceSpace(l),ke.setContext(a),ke.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(a!==null)return a.environmentBlendMode},this.getDepthTexture=function(){return C.getDepthTexture()};function ne(te){for(let Ce=0;Ce<te.removed.length;Ce++){const Le=te.removed[Ce],Te=I.indexOf(Le);Te>=0&&(I[Te]=null,w[Te].disconnect(Le))}for(let Ce=0;Ce<te.added.length;Ce++){const Le=te.added[Ce];let Te=I.indexOf(Le);if(Te===-1){for(let ue=0;ue<w.length;ue++)if(ue>=I.length){I.push(Le),Te=ue;break}else if(I[ue]===null){I[ue]=Le,Te=ue;break}if(Te===-1)break}const He=w[Te];He&&He.connect(Le)}}const oe=new be,de=new be;function Z(te,Ce,Le){oe.setFromMatrixPosition(Ce.matrixWorld),de.setFromMatrixPosition(Le.matrixWorld);const Te=oe.distanceTo(de),He=Ce.projectionMatrix.elements,ue=Le.projectionMatrix.elements,we=He[14]/(He[10]-1),at=He[14]/(He[10]+1),q=(He[9]+1)/He[5],Ze=(He[9]-1)/He[5],nt=(He[8]-1)/He[0],Ve=(ue[8]+1)/ue[0],Ie=we*nt,st=we*Ve,Fe=Te/(-nt+Ve),Oe=Fe*-nt;if(Ce.matrixWorld.decompose(te.position,te.quaternion,te.scale),te.translateX(Oe),te.translateZ(Fe),te.matrixWorld.compose(te.position,te.quaternion,te.scale),te.matrixWorldInverse.copy(te.matrixWorld).invert(),He[10]===-1)te.projectionMatrix.copy(Ce.projectionMatrix),te.projectionMatrixInverse.copy(Ce.projectionMatrixInverse);else{const N=we+Fe,_=at+Fe,H=Ie-Oe,ye=st+(Te-Oe),fe=q*at/_*N,pe=Ze*at/_*N;te.projectionMatrix.makePerspective(H,ye,fe,pe,N,_),te.projectionMatrixInverse.copy(te.projectionMatrix).invert()}}function Ue(te,Ce){Ce===null?te.matrixWorld.copy(te.matrix):te.matrixWorld.multiplyMatrices(Ce.matrixWorld,te.matrix),te.matrixWorldInverse.copy(te.matrixWorld).invert()}this.updateCamera=function(te){if(a===null)return;let Ce=te.near,Le=te.far;C.texture!==null&&(C.depthNear>0&&(Ce=C.depthNear),C.depthFar>0&&(Le=C.depthFar)),A.near=F.near=z.near=Ce,A.far=F.far=z.far=Le,(O!==A.near||$!==A.far)&&(a.updateRenderState({depthNear:A.near,depthFar:A.far}),O=A.near,$=A.far);const Te=te.parent,He=A.cameras;Ue(A,Te);for(let ue=0;ue<He.length;ue++)Ue(He[ue],Te);He.length===2?Z(A,z,F):A.projectionMatrix.copy(z.projectionMatrix),ie(te,A,Te)};function ie(te,Ce,Le){Le===null?te.matrix.copy(Ce.matrixWorld):(te.matrix.copy(Le.matrixWorld),te.matrix.invert(),te.matrix.multiply(Ce.matrixWorld)),te.matrix.decompose(te.position,te.quaternion,te.scale),te.updateMatrixWorld(!0),te.projectionMatrix.copy(Ce.projectionMatrix),te.projectionMatrixInverse.copy(Ce.projectionMatrixInverse),te.isPerspectiveCamera&&(te.fov=Qr*2*Math.atan(1/te.projectionMatrix.elements[5]),te.zoom=1)}this.getCamera=function(){return A},this.getFoveation=function(){if(!(f===null&&v===null))return u},this.setFoveation=function(te){u=te,f!==null&&(f.fixedFoveation=te),v!==null&&v.fixedFoveation!==void 0&&(v.fixedFoveation=te)},this.hasDepthSensing=function(){return C.texture!==null},this.getDepthSensingMesh=function(){return C.getMesh(A)};let ge=null;function Xe(te,Ce){if(p=Ce.getViewerPose(d||c),E=Ce,p!==null){const Le=p.views;v!==null&&(e.setRenderTargetFramebuffer(R,v.framebuffer),e.setRenderTarget(R));let Te=!1;Le.length!==A.cameras.length&&(A.cameras.length=0,Te=!0);for(let ue=0;ue<Le.length;ue++){const we=Le[ue];let at=null;if(v!==null)at=v.getViewport(we);else{const Ze=g.getViewSubImage(f,we);at=Ze.viewport,ue===0&&(e.setRenderTargetTextures(R,Ze.colorTexture,f.ignoreDepthValues?void 0:Ze.depthStencilTexture),e.setRenderTarget(R))}let q=T[ue];q===void 0&&(q=new Wn,q.layers.enable(ue),q.viewport=new sn,T[ue]=q),q.matrix.fromArray(we.transform.matrix),q.matrix.decompose(q.position,q.quaternion,q.scale),q.projectionMatrix.fromArray(we.projectionMatrix),q.projectionMatrixInverse.copy(q.projectionMatrix).invert(),q.viewport.set(at.x,at.y,at.width,at.height),ue===0&&(A.matrix.copy(q.matrix),A.matrix.decompose(A.position,A.quaternion,A.scale)),Te===!0&&A.cameras.push(q)}const He=a.enabledFeatures;if(He&&He.includes("depth-sensing")){const ue=g.getDepthInformation(Le[0]);ue&&ue.isValid&&ue.texture&&C.init(e,ue,a.renderState)}}for(let Le=0;Le<w.length;Le++){const Te=I[Le],He=w[Le];Te!==null&&He!==void 0&&He.update(Te,Ce,d||c)}ge&&ge(te,Ce),Ce.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:Ce}),E=null}const ke=new _u;ke.setAnimationLoop(Xe),this.setAnimationLoop=function(te){ge=te},this.dispose=function(){}}}const ha=new ui,_g=new tn;function xg(i,e){function t(h,m){h.matrixAutoUpdate===!0&&h.updateMatrix(),m.value.copy(h.matrix)}function n(h,m){m.color.getRGB(h.fogColor.value,vu(i)),m.isFog?(h.fogNear.value=m.near,h.fogFar.value=m.far):m.isFogExp2&&(h.fogDensity.value=m.density)}function a(h,m,R,w,I){m.isMeshBasicMaterial||m.isMeshLambertMaterial?s(h,m):m.isMeshToonMaterial?(s(h,m),g(h,m)):m.isMeshPhongMaterial?(s(h,m),p(h,m)):m.isMeshStandardMaterial?(s(h,m),f(h,m),m.isMeshPhysicalMaterial&&v(h,m,I)):m.isMeshMatcapMaterial?(s(h,m),E(h,m)):m.isMeshDepthMaterial?s(h,m):m.isMeshDistanceMaterial?(s(h,m),C(h,m)):m.isMeshNormalMaterial?s(h,m):m.isLineBasicMaterial?(c(h,m),m.isLineDashedMaterial&&l(h,m)):m.isPointsMaterial?u(h,m,R,w):m.isSpriteMaterial?d(h,m):m.isShadowMaterial?(h.color.value.copy(m.color),h.opacity.value=m.opacity):m.isShaderMaterial&&(m.uniformsNeedUpdate=!1)}function s(h,m){h.opacity.value=m.opacity,m.color&&h.diffuse.value.copy(m.color),m.emissive&&h.emissive.value.copy(m.emissive).multiplyScalar(m.emissiveIntensity),m.map&&(h.map.value=m.map,t(m.map,h.mapTransform)),m.alphaMap&&(h.alphaMap.value=m.alphaMap,t(m.alphaMap,h.alphaMapTransform)),m.bumpMap&&(h.bumpMap.value=m.bumpMap,t(m.bumpMap,h.bumpMapTransform),h.bumpScale.value=m.bumpScale,m.side===On&&(h.bumpScale.value*=-1)),m.normalMap&&(h.normalMap.value=m.normalMap,t(m.normalMap,h.normalMapTransform),h.normalScale.value.copy(m.normalScale),m.side===On&&h.normalScale.value.negate()),m.displacementMap&&(h.displacementMap.value=m.displacementMap,t(m.displacementMap,h.displacementMapTransform),h.displacementScale.value=m.displacementScale,h.displacementBias.value=m.displacementBias),m.emissiveMap&&(h.emissiveMap.value=m.emissiveMap,t(m.emissiveMap,h.emissiveMapTransform)),m.specularMap&&(h.specularMap.value=m.specularMap,t(m.specularMap,h.specularMapTransform)),m.alphaTest>0&&(h.alphaTest.value=m.alphaTest);const R=e.get(m),w=R.envMap,I=R.envMapRotation;w&&(h.envMap.value=w,ha.copy(I),ha.x*=-1,ha.y*=-1,ha.z*=-1,w.isCubeTexture&&w.isRenderTargetTexture===!1&&(ha.y*=-1,ha.z*=-1),h.envMapRotation.value.setFromMatrix4(_g.makeRotationFromEuler(ha)),h.flipEnvMap.value=w.isCubeTexture&&w.isRenderTargetTexture===!1?-1:1,h.reflectivity.value=m.reflectivity,h.ior.value=m.ior,h.refractionRatio.value=m.refractionRatio),m.lightMap&&(h.lightMap.value=m.lightMap,h.lightMapIntensity.value=m.lightMapIntensity,t(m.lightMap,h.lightMapTransform)),m.aoMap&&(h.aoMap.value=m.aoMap,h.aoMapIntensity.value=m.aoMapIntensity,t(m.aoMap,h.aoMapTransform))}function c(h,m){h.diffuse.value.copy(m.color),h.opacity.value=m.opacity,m.map&&(h.map.value=m.map,t(m.map,h.mapTransform))}function l(h,m){h.dashSize.value=m.dashSize,h.totalSize.value=m.dashSize+m.gapSize,h.scale.value=m.scale}function u(h,m,R,w){h.diffuse.value.copy(m.color),h.opacity.value=m.opacity,h.size.value=m.size*R,h.scale.value=w*.5,m.map&&(h.map.value=m.map,t(m.map,h.uvTransform)),m.alphaMap&&(h.alphaMap.value=m.alphaMap,t(m.alphaMap,h.alphaMapTransform)),m.alphaTest>0&&(h.alphaTest.value=m.alphaTest)}function d(h,m){h.diffuse.value.copy(m.color),h.opacity.value=m.opacity,h.rotation.value=m.rotation,m.map&&(h.map.value=m.map,t(m.map,h.mapTransform)),m.alphaMap&&(h.alphaMap.value=m.alphaMap,t(m.alphaMap,h.alphaMapTransform)),m.alphaTest>0&&(h.alphaTest.value=m.alphaTest)}function p(h,m){h.specular.value.copy(m.specular),h.shininess.value=Math.max(m.shininess,1e-4)}function g(h,m){m.gradientMap&&(h.gradientMap.value=m.gradientMap)}function f(h,m){h.metalness.value=m.metalness,m.metalnessMap&&(h.metalnessMap.value=m.metalnessMap,t(m.metalnessMap,h.metalnessMapTransform)),h.roughness.value=m.roughness,m.roughnessMap&&(h.roughnessMap.value=m.roughnessMap,t(m.roughnessMap,h.roughnessMapTransform)),m.envMap&&(h.envMapIntensity.value=m.envMapIntensity)}function v(h,m,R){h.ior.value=m.ior,m.sheen>0&&(h.sheenColor.value.copy(m.sheenColor).multiplyScalar(m.sheen),h.sheenRoughness.value=m.sheenRoughness,m.sheenColorMap&&(h.sheenColorMap.value=m.sheenColorMap,t(m.sheenColorMap,h.sheenColorMapTransform)),m.sheenRoughnessMap&&(h.sheenRoughnessMap.value=m.sheenRoughnessMap,t(m.sheenRoughnessMap,h.sheenRoughnessMapTransform))),m.clearcoat>0&&(h.clearcoat.value=m.clearcoat,h.clearcoatRoughness.value=m.clearcoatRoughness,m.clearcoatMap&&(h.clearcoatMap.value=m.clearcoatMap,t(m.clearcoatMap,h.clearcoatMapTransform)),m.clearcoatRoughnessMap&&(h.clearcoatRoughnessMap.value=m.clearcoatRoughnessMap,t(m.clearcoatRoughnessMap,h.clearcoatRoughnessMapTransform)),m.clearcoatNormalMap&&(h.clearcoatNormalMap.value=m.clearcoatNormalMap,t(m.clearcoatNormalMap,h.clearcoatNormalMapTransform),h.clearcoatNormalScale.value.copy(m.clearcoatNormalScale),m.side===On&&h.clearcoatNormalScale.value.negate())),m.dispersion>0&&(h.dispersion.value=m.dispersion),m.iridescence>0&&(h.iridescence.value=m.iridescence,h.iridescenceIOR.value=m.iridescenceIOR,h.iridescenceThicknessMinimum.value=m.iridescenceThicknessRange[0],h.iridescenceThicknessMaximum.value=m.iridescenceThicknessRange[1],m.iridescenceMap&&(h.iridescenceMap.value=m.iridescenceMap,t(m.iridescenceMap,h.iridescenceMapTransform)),m.iridescenceThicknessMap&&(h.iridescenceThicknessMap.value=m.iridescenceThicknessMap,t(m.iridescenceThicknessMap,h.iridescenceThicknessMapTransform))),m.transmission>0&&(h.transmission.value=m.transmission,h.transmissionSamplerMap.value=R.texture,h.transmissionSamplerSize.value.set(R.width,R.height),m.transmissionMap&&(h.transmissionMap.value=m.transmissionMap,t(m.transmissionMap,h.transmissionMapTransform)),h.thickness.value=m.thickness,m.thicknessMap&&(h.thicknessMap.value=m.thicknessMap,t(m.thicknessMap,h.thicknessMapTransform)),h.attenuationDistance.value=m.attenuationDistance,h.attenuationColor.value.copy(m.attenuationColor)),m.anisotropy>0&&(h.anisotropyVector.value.set(m.anisotropy*Math.cos(m.anisotropyRotation),m.anisotropy*Math.sin(m.anisotropyRotation)),m.anisotropyMap&&(h.anisotropyMap.value=m.anisotropyMap,t(m.anisotropyMap,h.anisotropyMapTransform))),h.specularIntensity.value=m.specularIntensity,h.specularColor.value.copy(m.specularColor),m.specularColorMap&&(h.specularColorMap.value=m.specularColorMap,t(m.specularColorMap,h.specularColorMapTransform)),m.specularIntensityMap&&(h.specularIntensityMap.value=m.specularIntensityMap,t(m.specularIntensityMap,h.specularIntensityMapTransform))}function E(h,m){m.matcap&&(h.matcap.value=m.matcap)}function C(h,m){const R=e.get(m).light;h.referencePosition.value.setFromMatrixPosition(R.matrixWorld),h.nearDistance.value=R.shadow.camera.near,h.farDistance.value=R.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:a}}function bg(i,e,t,n){let a={},s={},c=[];const l=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function u(R,w){const I=w.program;n.uniformBlockBinding(R,I)}function d(R,w){let I=a[R.id];I===void 0&&(E(R),I=p(R),a[R.id]=I,R.addEventListener("dispose",h));const j=w.program;n.updateUBOMapping(R,j);const U=e.render.frame;s[R.id]!==U&&(f(R),s[R.id]=U)}function p(R){const w=g();R.__bindingPointIndex=w;const I=i.createBuffer(),j=R.__size,U=R.usage;return i.bindBuffer(i.UNIFORM_BUFFER,I),i.bufferData(i.UNIFORM_BUFFER,j,U),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,w,I),I}function g(){for(let R=0;R<l;R++)if(c.indexOf(R)===-1)return c.push(R),R;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(R){const w=a[R.id],I=R.uniforms,j=R.__cache;i.bindBuffer(i.UNIFORM_BUFFER,w);for(let U=0,z=I.length;U<z;U++){const F=Array.isArray(I[U])?I[U]:[I[U]];for(let T=0,A=F.length;T<A;T++){const O=F[T];if(v(O,U,T,j)===!0){const $=O.__offset,J=Array.isArray(O.value)?O.value:[O.value];let Y=0;for(let ne=0;ne<J.length;ne++){const oe=J[ne],de=C(oe);typeof oe=="number"||typeof oe=="boolean"?(O.__data[0]=oe,i.bufferSubData(i.UNIFORM_BUFFER,$+Y,O.__data)):oe.isMatrix3?(O.__data[0]=oe.elements[0],O.__data[1]=oe.elements[1],O.__data[2]=oe.elements[2],O.__data[3]=0,O.__data[4]=oe.elements[3],O.__data[5]=oe.elements[4],O.__data[6]=oe.elements[5],O.__data[7]=0,O.__data[8]=oe.elements[6],O.__data[9]=oe.elements[7],O.__data[10]=oe.elements[8],O.__data[11]=0):(oe.toArray(O.__data,Y),Y+=de.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,$,O.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function v(R,w,I,j){const U=R.value,z=w+"_"+I;if(j[z]===void 0)return typeof U=="number"||typeof U=="boolean"?j[z]=U:j[z]=U.clone(),!0;{const F=j[z];if(typeof U=="number"||typeof U=="boolean"){if(F!==U)return j[z]=U,!0}else if(F.equals(U)===!1)return F.copy(U),!0}return!1}function E(R){const w=R.uniforms;let I=0;const j=16;for(let z=0,F=w.length;z<F;z++){const T=Array.isArray(w[z])?w[z]:[w[z]];for(let A=0,O=T.length;A<O;A++){const $=T[A],J=Array.isArray($.value)?$.value:[$.value];for(let Y=0,ne=J.length;Y<ne;Y++){const oe=J[Y],de=C(oe),Z=I%j,Ue=Z%de.boundary,ie=Z+Ue;I+=Ue,ie!==0&&j-ie<de.storage&&(I+=j-ie),$.__data=new Float32Array(de.storage/Float32Array.BYTES_PER_ELEMENT),$.__offset=I,I+=de.storage}}}const U=I%j;return U>0&&(I+=j-U),R.__size=I,R.__cache={},this}function C(R){const w={boundary:0,storage:0};return typeof R=="number"||typeof R=="boolean"?(w.boundary=4,w.storage=4):R.isVector2?(w.boundary=8,w.storage=8):R.isVector3||R.isColor?(w.boundary=16,w.storage=12):R.isVector4?(w.boundary=16,w.storage=16):R.isMatrix3?(w.boundary=48,w.storage=48):R.isMatrix4?(w.boundary=64,w.storage=64):R.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",R),w}function h(R){const w=R.target;w.removeEventListener("dispose",h);const I=c.indexOf(w.__bindingPointIndex);c.splice(I,1),i.deleteBuffer(a[w.id]),delete a[w.id],delete s[w.id]}function m(){for(const R in a)i.deleteBuffer(a[R]);c=[],a={},s={}}return{bind:u,update:d,dispose:m}}class yg{constructor(e={}){const{canvas:t=up(),context:n=null,depth:a=!0,stencil:s=!1,alpha:c=!1,antialias:l=!1,premultipliedAlpha:u=!0,preserveDrawingBuffer:d=!1,powerPreference:p="default",failIfMajorPerformanceCaveat:g=!1}=e;this.isWebGLRenderer=!0;let f;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");f=n.getContextAttributes().alpha}else f=c;const v=new Uint32Array(4),E=new Int32Array(4);let C=null,h=null;const m=[],R=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=oi,this.toneMapping=Vi,this.toneMappingExposure=1;const w=this;let I=!1,j=0,U=0,z=null,F=-1,T=null;const A=new sn,O=new sn;let $=null;const J=new Tt(0);let Y=0,ne=t.width,oe=t.height,de=1,Z=null,Ue=null;const ie=new sn(0,0,ne,oe),ge=new sn(0,0,ne,oe);let Xe=!1;const ke=new fl;let te=!1,Ce=!1;const Le=new tn,Te=new be,He=new sn,ue={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let we=!1;function at(){return z===null?de:1}let q=n;function Ze(P,ee){return t.getContext(P,ee)}try{const P={alpha:!0,depth:a,stencil:s,antialias:l,premultipliedAlpha:u,preserveDrawingBuffer:d,powerPreference:p,failIfMajorPerformanceCaveat:g};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${il}`),t.addEventListener("webglcontextlost",Me,!1),t.addEventListener("webglcontextrestored",_e,!1),t.addEventListener("webglcontextcreationerror",Pe,!1),q===null){const ee="webgl2";if(q=Ze(ee,P),q===null)throw Ze(ee)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(P){throw console.error("THREE.WebGLRenderer: "+P.message),P}let nt,Ve,Ie,st,Fe,Oe,N,_,H,ye,fe,pe,je,Ee,De,Ke,k,me,tt,K,ve,We,Je,ct;function G(){nt=new Am(q),nt.init(),We=new dg(q,nt),Ve=new ym(q,nt,e,We),Ie=new lg(q),st=new Rm(q),Fe=new Xv,Oe=new ug(q,nt,Ie,Fe,Ve,We,st),N=new Sm(w),_=new Tm(w),H=new qp(q),Je=new xm(q,H),ye=new wm(q,H,st,Je),fe=new Dm(q,ye,H,st),tt=new Lm(q,Ve,Oe),Ke=new Mm(Fe),pe=new $v(w,N,_,nt,Ve,Je,Ke),je=new xg(w,Fe),Ee=new Zv,De=new ng(nt),me=new _m(w,N,_,Ie,fe,f,u),k=new rg(w,fe,Ve),ct=new bg(q,st,Ve,Ie),K=new bm(q,nt,st),ve=new Pm(q,nt,st),st.programs=pe.programs,w.capabilities=Ve,w.extensions=nt,w.properties=Fe,w.renderLists=Ee,w.shadowMap=k,w.state=Ie,w.info=st}G();const Ae=new gg(w,q);this.xr=Ae,this.getContext=function(){return q},this.getContextAttributes=function(){return q.getContextAttributes()},this.forceContextLoss=function(){const P=nt.get("WEBGL_lose_context");P&&P.loseContext()},this.forceContextRestore=function(){const P=nt.get("WEBGL_lose_context");P&&P.restoreContext()},this.getPixelRatio=function(){return de},this.setPixelRatio=function(P){P!==void 0&&(de=P,this.setSize(ne,oe,!1))},this.getSize=function(P){return P.set(ne,oe)},this.setSize=function(P,ee,le=!0){if(Ae.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}ne=P,oe=ee,t.width=Math.floor(P*de),t.height=Math.floor(ee*de),le===!0&&(t.style.width=P+"px",t.style.height=ee+"px"),this.setViewport(0,0,P,ee)},this.getDrawingBufferSize=function(P){return P.set(ne*de,oe*de).floor()},this.setDrawingBufferSize=function(P,ee,le){ne=P,oe=ee,de=le,t.width=Math.floor(P*le),t.height=Math.floor(ee*le),this.setViewport(0,0,P,ee)},this.getCurrentViewport=function(P){return P.copy(A)},this.getViewport=function(P){return P.copy(ie)},this.setViewport=function(P,ee,le,re){P.isVector4?ie.set(P.x,P.y,P.z,P.w):ie.set(P,ee,le,re),Ie.viewport(A.copy(ie).multiplyScalar(de).round())},this.getScissor=function(P){return P.copy(ge)},this.setScissor=function(P,ee,le,re){P.isVector4?ge.set(P.x,P.y,P.z,P.w):ge.set(P,ee,le,re),Ie.scissor(O.copy(ge).multiplyScalar(de).round())},this.getScissorTest=function(){return Xe},this.setScissorTest=function(P){Ie.setScissorTest(Xe=P)},this.setOpaqueSort=function(P){Z=P},this.setTransparentSort=function(P){Ue=P},this.getClearColor=function(P){return P.copy(me.getClearColor())},this.setClearColor=function(){me.setClearColor.apply(me,arguments)},this.getClearAlpha=function(){return me.getClearAlpha()},this.setClearAlpha=function(){me.setClearAlpha.apply(me,arguments)},this.clear=function(P=!0,ee=!0,le=!0){let re=0;if(P){let ae=!1;if(z!==null){const ze=z.texture.format;ae=ze===ul||ze===cl||ze===ll}if(ae){const ze=z.texture.type,Be=ze===Li||ze===Sa||ze===Ps||ze===Qa||ze===ol||ze===rl,V=me.getClearColor(),he=me.getClearAlpha(),W=V.r,Re=V.g,it=V.b;Be?(v[0]=W,v[1]=Re,v[2]=it,v[3]=he,q.clearBufferuiv(q.COLOR,0,v)):(E[0]=W,E[1]=Re,E[2]=it,E[3]=he,q.clearBufferiv(q.COLOR,0,E))}else re|=q.COLOR_BUFFER_BIT}ee&&(re|=q.DEPTH_BUFFER_BIT),le&&(re|=q.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),q.clear(re)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",Me,!1),t.removeEventListener("webglcontextrestored",_e,!1),t.removeEventListener("webglcontextcreationerror",Pe,!1),Ee.dispose(),De.dispose(),Fe.dispose(),N.dispose(),_.dispose(),fe.dispose(),Je.dispose(),ct.dispose(),pe.dispose(),Ae.dispose(),Ae.removeEventListener("sessionstart",pt),Ae.removeEventListener("sessionend",Q),Ne.stop()};function Me(P){P.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),I=!0}function _e(){console.log("THREE.WebGLRenderer: Context Restored."),I=!1;const P=st.autoReset,ee=k.enabled,le=k.autoUpdate,re=k.needsUpdate,ae=k.type;G(),st.autoReset=P,k.enabled=ee,k.autoUpdate=le,k.needsUpdate=re,k.type=ae}function Pe(P){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",P.statusMessage)}function $e(P){const ee=P.target;ee.removeEventListener("dispose",$e),Qe(ee)}function Qe(P){lt(P),Fe.remove(P)}function lt(P){const ee=Fe.get(P).programs;ee!==void 0&&(ee.forEach(function(le){pe.releaseProgram(le)}),P.isShaderMaterial&&pe.releaseShaderCache(P))}this.renderBufferDirect=function(P,ee,le,re,ae,ze){ee===null&&(ee=ue);const Be=ae.isMesh&&ae.matrixWorld.determinant()<0,V=qt(P,ee,le,re,ae);Ie.setMaterial(re,Be);let he=le.index,W=1;if(re.wireframe===!0){if(he=ye.getWireframeAttribute(le),he===void 0)return;W=2}const Re=le.drawRange,it=le.attributes.position;let ft=Re.start*W,zt=(Re.start+Re.count)*W;ze!==null&&(ft=Math.max(ft,ze.start*W),zt=Math.min(zt,(ze.start+ze.count)*W)),he!==null?(ft=Math.max(ft,0),zt=Math.min(zt,he.count)):it!=null&&(ft=Math.max(ft,0),zt=Math.min(zt,it.count));const Rt=zt-ft;if(Rt<0||Rt===1/0)return;Je.setup(ae,re,V,le,he);let Bt,wt=K;if(he!==null&&(Bt=H.get(he),wt=ve,wt.setIndex(Bt)),ae.isMesh)re.wireframe===!0?(Ie.setLineWidth(re.wireframeLinewidth*at()),wt.setMode(q.LINES)):wt.setMode(q.TRIANGLES);else if(ae.isLine){let rt=re.linewidth;rt===void 0&&(rt=1),Ie.setLineWidth(rt*at()),ae.isLineSegments?wt.setMode(q.LINES):ae.isLineLoop?wt.setMode(q.LINE_LOOP):wt.setMode(q.LINE_STRIP)}else ae.isPoints?wt.setMode(q.POINTS):ae.isSprite&&wt.setMode(q.TRIANGLES);if(ae.isBatchedMesh)if(ae._multiDrawInstances!==null)wt.renderMultiDrawInstances(ae._multiDrawStarts,ae._multiDrawCounts,ae._multiDrawCount,ae._multiDrawInstances);else if(nt.get("WEBGL_multi_draw"))wt.renderMultiDraw(ae._multiDrawStarts,ae._multiDrawCounts,ae._multiDrawCount);else{const rt=ae._multiDrawStarts,Ut=ae._multiDrawCounts,xt=ae._multiDrawCount,jt=he?H.get(he).bytesPerElement:1,Ht=Fe.get(re).currentProgram.getUniforms();for(let Qt=0;Qt<xt;Qt++)Ht.setValue(q,"_gl_DrawID",Qt),wt.render(rt[Qt]/jt,Ut[Qt])}else if(ae.isInstancedMesh)wt.renderInstances(ft,Rt,ae.count);else if(le.isInstancedBufferGeometry){const rt=le._maxInstanceCount!==void 0?le._maxInstanceCount:1/0,Ut=Math.min(le.instanceCount,rt);wt.renderInstances(ft,Rt,Ut)}else wt.render(ft,Rt)};function ut(P,ee,le){P.transparent===!0&&P.side===wi&&P.forceSinglePass===!1?(P.side=On,P.needsUpdate=!0,B(P,ee,le),P.side=Gi,P.needsUpdate=!0,B(P,ee,le),P.side=wi):B(P,ee,le)}this.compile=function(P,ee,le=null){le===null&&(le=P),h=De.get(le),h.init(ee),R.push(h),le.traverseVisible(function(ae){ae.isLight&&ae.layers.test(ee.layers)&&(h.pushLight(ae),ae.castShadow&&h.pushShadow(ae))}),P!==le&&P.traverseVisible(function(ae){ae.isLight&&ae.layers.test(ee.layers)&&(h.pushLight(ae),ae.castShadow&&h.pushShadow(ae))}),h.setupLights();const re=new Set;return P.traverse(function(ae){const ze=ae.material;if(ze)if(Array.isArray(ze))for(let Be=0;Be<ze.length;Be++){const V=ze[Be];ut(V,le,ae),re.add(V)}else ut(ze,le,ae),re.add(ze)}),R.pop(),h=null,re},this.compileAsync=function(P,ee,le=null){const re=this.compile(P,ee,le);return new Promise(ae=>{function ze(){if(re.forEach(function(Be){Fe.get(Be).currentProgram.isReady()&&re.delete(Be)}),re.size===0){ae(P);return}setTimeout(ze,10)}nt.get("KHR_parallel_shader_compile")!==null?ze():setTimeout(ze,10)})};let et=null;function dt(P){et&&et(P)}function pt(){Ne.stop()}function Q(){Ne.start()}const Ne=new _u;Ne.setAnimationLoop(dt),typeof self<"u"&&Ne.setContext(self),this.setAnimationLoop=function(P){et=P,Ae.setAnimationLoop(P),P===null?Ne.stop():Ne.start()},Ae.addEventListener("sessionstart",pt),Ae.addEventListener("sessionend",Q),this.render=function(P,ee){if(ee!==void 0&&ee.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(I===!0)return;if(P.matrixWorldAutoUpdate===!0&&P.updateMatrixWorld(),ee.parent===null&&ee.matrixWorldAutoUpdate===!0&&ee.updateMatrixWorld(),Ae.enabled===!0&&Ae.isPresenting===!0&&(Ae.cameraAutoUpdate===!0&&Ae.updateCamera(ee),ee=Ae.getCamera()),P.isScene===!0&&P.onBeforeRender(w,P,ee,z),h=De.get(P,R.length),h.init(ee),R.push(h),Le.multiplyMatrices(ee.projectionMatrix,ee.matrixWorldInverse),ke.setFromProjectionMatrix(Le),Ce=this.localClippingEnabled,te=Ke.init(this.clippingPlanes,Ce),C=Ee.get(P,m.length),C.init(),m.push(C),Ae.enabled===!0&&Ae.isPresenting===!0){const ze=w.xr.getDepthSensingMesh();ze!==null&&vt(ze,ee,-1/0,w.sortObjects)}vt(P,ee,0,w.sortObjects),C.finish(),w.sortObjects===!0&&C.sort(Z,Ue),we=Ae.enabled===!1||Ae.isPresenting===!1||Ae.hasDepthSensing()===!1,we&&me.addToRenderList(C,P),this.info.render.frame++,te===!0&&Ke.beginShadows();const le=h.state.shadowsArray;k.render(le,P,ee),te===!0&&Ke.endShadows(),this.info.autoReset===!0&&this.info.reset();const re=C.opaque,ae=C.transmissive;if(h.setupLights(),ee.isArrayCamera){const ze=ee.cameras;if(ae.length>0)for(let Be=0,V=ze.length;Be<V;Be++){const he=ze[Be];qe(re,ae,P,he)}we&&me.render(P);for(let Be=0,V=ze.length;Be<V;Be++){const he=ze[Be];ce(C,P,he,he.viewport)}}else ae.length>0&&qe(re,ae,P,ee),we&&me.render(P),ce(C,P,ee);z!==null&&(Oe.updateMultisampleRenderTarget(z),Oe.updateRenderTargetMipmap(z)),P.isScene===!0&&P.onAfterRender(w,P,ee),Je.resetDefaultState(),F=-1,T=null,R.pop(),R.length>0?(h=R[R.length-1],te===!0&&Ke.setGlobalState(w.clippingPlanes,h.state.camera)):h=null,m.pop(),m.length>0?C=m[m.length-1]:C=null};function vt(P,ee,le,re){if(P.visible===!1)return;if(P.layers.test(ee.layers)){if(P.isGroup)le=P.renderOrder;else if(P.isLOD)P.autoUpdate===!0&&P.update(ee);else if(P.isLight)h.pushLight(P),P.castShadow&&h.pushShadow(P);else if(P.isSprite){if(!P.frustumCulled||ke.intersectsSprite(P)){re&&He.setFromMatrixPosition(P.matrixWorld).applyMatrix4(Le);const Be=fe.update(P),V=P.material;V.visible&&C.push(P,Be,V,le,He.z,null)}}else if((P.isMesh||P.isLine||P.isPoints)&&(!P.frustumCulled||ke.intersectsObject(P))){const Be=fe.update(P),V=P.material;if(re&&(P.boundingSphere!==void 0?(P.boundingSphere===null&&P.computeBoundingSphere(),He.copy(P.boundingSphere.center)):(Be.boundingSphere===null&&Be.computeBoundingSphere(),He.copy(Be.boundingSphere.center)),He.applyMatrix4(P.matrixWorld).applyMatrix4(Le)),Array.isArray(V)){const he=Be.groups;for(let W=0,Re=he.length;W<Re;W++){const it=he[W],ft=V[it.materialIndex];ft&&ft.visible&&C.push(P,Be,ft,le,He.z,it)}}else V.visible&&C.push(P,Be,V,le,He.z,null)}}const ze=P.children;for(let Be=0,V=ze.length;Be<V;Be++)vt(ze[Be],ee,le,re)}function ce(P,ee,le,re){const ae=P.opaque,ze=P.transmissive,Be=P.transparent;h.setupLightsView(le),te===!0&&Ke.setGlobalState(w.clippingPlanes,le),re&&Ie.viewport(A.copy(re)),ae.length>0&&At(ae,ee,le),ze.length>0&&At(ze,ee,le),Be.length>0&&At(Be,ee,le),Ie.buffers.depth.setTest(!0),Ie.buffers.depth.setMask(!0),Ie.buffers.color.setMask(!0),Ie.setPolygonOffset(!1)}function qe(P,ee,le,re){if((le.isScene===!0?le.overrideMaterial:null)!==null)return;h.state.transmissionRenderTarget[re.id]===void 0&&(h.state.transmissionRenderTarget[re.id]=new Ca(1,1,{generateMipmaps:!0,type:nt.has("EXT_color_buffer_half_float")||nt.has("EXT_color_buffer_float")?Ls:Li,minFilter:ya,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:kt.workingColorSpace}));const ze=h.state.transmissionRenderTarget[re.id],Be=re.viewport||A;ze.setSize(Be.z,Be.w);const V=w.getRenderTarget();w.setRenderTarget(ze),w.getClearColor(J),Y=w.getClearAlpha(),Y<1&&w.setClearColor(16777215,.5),w.clear(),we&&me.render(le);const he=w.toneMapping;w.toneMapping=Vi;const W=re.viewport;if(re.viewport!==void 0&&(re.viewport=void 0),h.setupLightsView(re),te===!0&&Ke.setGlobalState(w.clippingPlanes,re),At(P,le,re),Oe.updateMultisampleRenderTarget(ze),Oe.updateRenderTargetMipmap(ze),nt.has("WEBGL_multisampled_render_to_texture")===!1){let Re=!1;for(let it=0,ft=ee.length;it<ft;it++){const zt=ee[it],Rt=zt.object,Bt=zt.geometry,wt=zt.material,rt=zt.group;if(wt.side===wi&&Rt.layers.test(re.layers)){const Ut=wt.side;wt.side=On,wt.needsUpdate=!0,se(Rt,le,re,Bt,wt,rt),wt.side=Ut,wt.needsUpdate=!0,Re=!0}}Re===!0&&(Oe.updateMultisampleRenderTarget(ze),Oe.updateRenderTargetMipmap(ze))}w.setRenderTarget(V),w.setClearColor(J,Y),W!==void 0&&(re.viewport=W),w.toneMapping=he}function At(P,ee,le){const re=ee.isScene===!0?ee.overrideMaterial:null;for(let ae=0,ze=P.length;ae<ze;ae++){const Be=P[ae],V=Be.object,he=Be.geometry,W=re===null?Be.material:re,Re=Be.group;V.layers.test(le.layers)&&se(V,ee,le,he,W,Re)}}function se(P,ee,le,re,ae,ze){P.onBeforeRender(w,ee,le,re,ae,ze),P.modelViewMatrix.multiplyMatrices(le.matrixWorldInverse,P.matrixWorld),P.normalMatrix.getNormalMatrix(P.modelViewMatrix),ae.onBeforeRender(w,ee,le,re,P,ze),ae.transparent===!0&&ae.side===wi&&ae.forceSinglePass===!1?(ae.side=On,ae.needsUpdate=!0,w.renderBufferDirect(le,ee,re,ae,P,ze),ae.side=Gi,ae.needsUpdate=!0,w.renderBufferDirect(le,ee,re,ae,P,ze),ae.side=wi):w.renderBufferDirect(le,ee,re,ae,P,ze),P.onAfterRender(w,ee,le,re,ae,ze)}function B(P,ee,le){ee.isScene!==!0&&(ee=ue);const re=Fe.get(P),ae=h.state.lights,ze=h.state.shadowsArray,Be=ae.state.version,V=pe.getParameters(P,ae.state,ze,ee,le),he=pe.getProgramCacheKey(V);let W=re.programs;re.environment=P.isMeshStandardMaterial?ee.environment:null,re.fog=ee.fog,re.envMap=(P.isMeshStandardMaterial?_:N).get(P.envMap||re.environment),re.envMapRotation=re.environment!==null&&P.envMap===null?ee.environmentRotation:P.envMapRotation,W===void 0&&(P.addEventListener("dispose",$e),W=new Map,re.programs=W);let Re=W.get(he);if(Re!==void 0){if(re.currentProgram===Re&&re.lightsStateVersion===Be)return Nt(P,V),Re}else V.uniforms=pe.getUniforms(P),P.onBeforeCompile(V,w),Re=pe.acquireProgram(V,he),W.set(he,Re),re.uniforms=V.uniforms;const it=re.uniforms;return(!P.isShaderMaterial&&!P.isRawShaderMaterial||P.clipping===!0)&&(it.clippingPlanes=Ke.uniform),Nt(P,V),re.needsLights=Vt(P),re.lightsStateVersion=Be,re.needsLights&&(it.ambientLightColor.value=ae.state.ambient,it.lightProbe.value=ae.state.probe,it.directionalLights.value=ae.state.directional,it.directionalLightShadows.value=ae.state.directionalShadow,it.spotLights.value=ae.state.spot,it.spotLightShadows.value=ae.state.spotShadow,it.rectAreaLights.value=ae.state.rectArea,it.ltc_1.value=ae.state.rectAreaLTC1,it.ltc_2.value=ae.state.rectAreaLTC2,it.pointLights.value=ae.state.point,it.pointLightShadows.value=ae.state.pointShadow,it.hemisphereLights.value=ae.state.hemi,it.directionalShadowMap.value=ae.state.directionalShadowMap,it.directionalShadowMatrix.value=ae.state.directionalShadowMatrix,it.spotShadowMap.value=ae.state.spotShadowMap,it.spotLightMatrix.value=ae.state.spotLightMatrix,it.spotLightMap.value=ae.state.spotLightMap,it.pointShadowMap.value=ae.state.pointShadowMap,it.pointShadowMatrix.value=ae.state.pointShadowMatrix),re.currentProgram=Re,re.uniformsList=null,Re}function Ye(P){if(P.uniformsList===null){const ee=P.currentProgram.getUniforms();P.uniformsList=To.seqWithValue(ee.seq,P.uniforms)}return P.uniformsList}function Nt(P,ee){const le=Fe.get(P);le.outputColorSpace=ee.outputColorSpace,le.batching=ee.batching,le.batchingColor=ee.batchingColor,le.instancing=ee.instancing,le.instancingColor=ee.instancingColor,le.instancingMorph=ee.instancingMorph,le.skinning=ee.skinning,le.morphTargets=ee.morphTargets,le.morphNormals=ee.morphNormals,le.morphColors=ee.morphColors,le.morphTargetsCount=ee.morphTargetsCount,le.numClippingPlanes=ee.numClippingPlanes,le.numIntersection=ee.numClipIntersection,le.vertexAlphas=ee.vertexAlphas,le.vertexTangents=ee.vertexTangents,le.toneMapping=ee.toneMapping}function qt(P,ee,le,re,ae){ee.isScene!==!0&&(ee=ue),Oe.resetTextureUnits();const ze=ee.fog,Be=re.isMeshStandardMaterial?ee.environment:null,V=z===null?w.outputColorSpace:z.isXRRenderTarget===!0?z.texture.colorSpace:Wi,he=(re.isMeshStandardMaterial?_:N).get(re.envMap||Be),W=re.vertexColors===!0&&!!le.attributes.color&&le.attributes.color.itemSize===4,Re=!!le.attributes.tangent&&(!!re.normalMap||re.anisotropy>0),it=!!le.morphAttributes.position,ft=!!le.morphAttributes.normal,zt=!!le.morphAttributes.color;let Rt=Vi;re.toneMapped&&(z===null||z.isXRRenderTarget===!0)&&(Rt=w.toneMapping);const Bt=le.morphAttributes.position||le.morphAttributes.normal||le.morphAttributes.color,wt=Bt!==void 0?Bt.length:0,rt=Fe.get(re),Ut=h.state.lights;if(te===!0&&(Ce===!0||P!==T)){const Ft=P===T&&re.id===F;Ke.setState(re,P,Ft)}let xt=!1;re.version===rt.__version?(rt.needsLights&&rt.lightsStateVersion!==Ut.state.version||rt.outputColorSpace!==V||ae.isBatchedMesh&&rt.batching===!1||!ae.isBatchedMesh&&rt.batching===!0||ae.isBatchedMesh&&rt.batchingColor===!0&&ae.colorTexture===null||ae.isBatchedMesh&&rt.batchingColor===!1&&ae.colorTexture!==null||ae.isInstancedMesh&&rt.instancing===!1||!ae.isInstancedMesh&&rt.instancing===!0||ae.isSkinnedMesh&&rt.skinning===!1||!ae.isSkinnedMesh&&rt.skinning===!0||ae.isInstancedMesh&&rt.instancingColor===!0&&ae.instanceColor===null||ae.isInstancedMesh&&rt.instancingColor===!1&&ae.instanceColor!==null||ae.isInstancedMesh&&rt.instancingMorph===!0&&ae.morphTexture===null||ae.isInstancedMesh&&rt.instancingMorph===!1&&ae.morphTexture!==null||rt.envMap!==he||re.fog===!0&&rt.fog!==ze||rt.numClippingPlanes!==void 0&&(rt.numClippingPlanes!==Ke.numPlanes||rt.numIntersection!==Ke.numIntersection)||rt.vertexAlphas!==W||rt.vertexTangents!==Re||rt.morphTargets!==it||rt.morphNormals!==ft||rt.morphColors!==zt||rt.toneMapping!==Rt||rt.morphTargetsCount!==wt)&&(xt=!0):(xt=!0,rt.__version=re.version);let jt=rt.currentProgram;xt===!0&&(jt=B(re,ee,ae));let Ht=!1,Qt=!1,un=!1;const bt=jt.getUniforms(),hn=rt.uniforms;if(Ie.useProgram(jt.program)&&(Ht=!0,Qt=!0,un=!0),re.id!==F&&(F=re.id,Qt=!0),Ht||T!==P){bt.setValue(q,"projectionMatrix",P.projectionMatrix),bt.setValue(q,"viewMatrix",P.matrixWorldInverse);const Ft=bt.map.cameraPosition;Ft!==void 0&&Ft.setValue(q,Te.setFromMatrixPosition(P.matrixWorld)),Ve.logarithmicDepthBuffer&&bt.setValue(q,"logDepthBufFC",2/(Math.log(P.far+1)/Math.LN2)),(re.isMeshPhongMaterial||re.isMeshToonMaterial||re.isMeshLambertMaterial||re.isMeshBasicMaterial||re.isMeshStandardMaterial||re.isShaderMaterial)&&bt.setValue(q,"isOrthographic",P.isOrthographicCamera===!0),T!==P&&(T=P,Qt=!0,un=!0)}if(ae.isSkinnedMesh){bt.setOptional(q,ae,"bindMatrix"),bt.setOptional(q,ae,"bindMatrixInverse");const Ft=ae.skeleton;Ft&&(Ft.boneTexture===null&&Ft.computeBoneTexture(),bt.setValue(q,"boneTexture",Ft.boneTexture,Oe))}ae.isBatchedMesh&&(bt.setOptional(q,ae,"batchingTexture"),bt.setValue(q,"batchingTexture",ae._matricesTexture,Oe),bt.setOptional(q,ae,"batchingIdTexture"),bt.setValue(q,"batchingIdTexture",ae._indirectTexture,Oe),bt.setOptional(q,ae,"batchingColorTexture"),ae._colorsTexture!==null&&bt.setValue(q,"batchingColorTexture",ae._colorsTexture,Oe));const dn=le.morphAttributes;if((dn.position!==void 0||dn.normal!==void 0||dn.color!==void 0)&&tt.update(ae,le,jt),(Qt||rt.receiveShadow!==ae.receiveShadow)&&(rt.receiveShadow=ae.receiveShadow,bt.setValue(q,"receiveShadow",ae.receiveShadow)),re.isMeshGouraudMaterial&&re.envMap!==null&&(hn.envMap.value=he,hn.flipEnvMap.value=he.isCubeTexture&&he.isRenderTargetTexture===!1?-1:1),re.isMeshStandardMaterial&&re.envMap===null&&ee.environment!==null&&(hn.envMapIntensity.value=ee.environmentIntensity),Qt&&(bt.setValue(q,"toneMappingExposure",w.toneMappingExposure),rt.needsLights&&cn(hn,un),ze&&re.fog===!0&&je.refreshFogUniforms(hn,ze),je.refreshMaterialUniforms(hn,re,de,oe,h.state.transmissionRenderTarget[P.id]),To.upload(q,Ye(rt),hn,Oe)),re.isShaderMaterial&&re.uniformsNeedUpdate===!0&&(To.upload(q,Ye(rt),hn,Oe),re.uniformsNeedUpdate=!1),re.isSpriteMaterial&&bt.setValue(q,"center",ae.center),bt.setValue(q,"modelViewMatrix",ae.modelViewMatrix),bt.setValue(q,"normalMatrix",ae.normalMatrix),bt.setValue(q,"modelMatrix",ae.matrixWorld),re.isShaderMaterial||re.isRawShaderMaterial){const Ft=re.uniformsGroups;for(let Vn=0,mn=Ft.length;Vn<mn;Vn++){const Wt=Ft[Vn];ct.update(Wt,jt),ct.bind(Wt,jt)}}return jt}function cn(P,ee){P.ambientLightColor.needsUpdate=ee,P.lightProbe.needsUpdate=ee,P.directionalLights.needsUpdate=ee,P.directionalLightShadows.needsUpdate=ee,P.pointLights.needsUpdate=ee,P.pointLightShadows.needsUpdate=ee,P.spotLights.needsUpdate=ee,P.spotLightShadows.needsUpdate=ee,P.rectAreaLights.needsUpdate=ee,P.hemisphereLights.needsUpdate=ee}function Vt(P){return P.isMeshLambertMaterial||P.isMeshToonMaterial||P.isMeshPhongMaterial||P.isMeshStandardMaterial||P.isShadowMaterial||P.isShaderMaterial&&P.lights===!0}this.getActiveCubeFace=function(){return j},this.getActiveMipmapLevel=function(){return U},this.getRenderTarget=function(){return z},this.setRenderTargetTextures=function(P,ee,le){Fe.get(P.texture).__webglTexture=ee,Fe.get(P.depthTexture).__webglTexture=le;const re=Fe.get(P);re.__hasExternalTextures=!0,re.__autoAllocateDepthBuffer=le===void 0,re.__autoAllocateDepthBuffer||nt.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),re.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(P,ee){const le=Fe.get(P);le.__webglFramebuffer=ee,le.__useDefaultFramebuffer=ee===void 0},this.setRenderTarget=function(P,ee=0,le=0){z=P,j=ee,U=le;let re=!0,ae=null,ze=!1,Be=!1;if(P){const he=Fe.get(P);if(he.__useDefaultFramebuffer!==void 0)Ie.bindFramebuffer(q.FRAMEBUFFER,null),re=!1;else if(he.__webglFramebuffer===void 0)Oe.setupRenderTarget(P);else if(he.__hasExternalTextures)Oe.rebindTextures(P,Fe.get(P.texture).__webglTexture,Fe.get(P.depthTexture).__webglTexture);else if(P.depthBuffer){const it=P.depthTexture;if(he.__boundDepthTexture!==it){if(it!==null&&Fe.has(it)&&(P.width!==it.image.width||P.height!==it.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");Oe.setupDepthRenderbuffer(P)}}const W=P.texture;(W.isData3DTexture||W.isDataArrayTexture||W.isCompressedArrayTexture)&&(Be=!0);const Re=Fe.get(P).__webglFramebuffer;P.isWebGLCubeRenderTarget?(Array.isArray(Re[ee])?ae=Re[ee][le]:ae=Re[ee],ze=!0):P.samples>0&&Oe.useMultisampledRTT(P)===!1?ae=Fe.get(P).__webglMultisampledFramebuffer:Array.isArray(Re)?ae=Re[le]:ae=Re,A.copy(P.viewport),O.copy(P.scissor),$=P.scissorTest}else A.copy(ie).multiplyScalar(de).floor(),O.copy(ge).multiplyScalar(de).floor(),$=Xe;if(Ie.bindFramebuffer(q.FRAMEBUFFER,ae)&&re&&Ie.drawBuffers(P,ae),Ie.viewport(A),Ie.scissor(O),Ie.setScissorTest($),ze){const he=Fe.get(P.texture);q.framebufferTexture2D(q.FRAMEBUFFER,q.COLOR_ATTACHMENT0,q.TEXTURE_CUBE_MAP_POSITIVE_X+ee,he.__webglTexture,le)}else if(Be){const he=Fe.get(P.texture),W=ee||0;q.framebufferTextureLayer(q.FRAMEBUFFER,q.COLOR_ATTACHMENT0,he.__webglTexture,le||0,W)}F=-1},this.readRenderTargetPixels=function(P,ee,le,re,ae,ze,Be){if(!(P&&P.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let V=Fe.get(P).__webglFramebuffer;if(P.isWebGLCubeRenderTarget&&Be!==void 0&&(V=V[Be]),V){Ie.bindFramebuffer(q.FRAMEBUFFER,V);try{const he=P.texture,W=he.format,Re=he.type;if(!Ve.textureFormatReadable(W)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Ve.textureTypeReadable(Re)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}ee>=0&&ee<=P.width-re&&le>=0&&le<=P.height-ae&&q.readPixels(ee,le,re,ae,We.convert(W),We.convert(Re),ze)}finally{const he=z!==null?Fe.get(z).__webglFramebuffer:null;Ie.bindFramebuffer(q.FRAMEBUFFER,he)}}},this.readRenderTargetPixelsAsync=async function(P,ee,le,re,ae,ze,Be){if(!(P&&P.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let V=Fe.get(P).__webglFramebuffer;if(P.isWebGLCubeRenderTarget&&Be!==void 0&&(V=V[Be]),V){Ie.bindFramebuffer(q.FRAMEBUFFER,V);try{const he=P.texture,W=he.format,Re=he.type;if(!Ve.textureFormatReadable(W))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Ve.textureTypeReadable(Re))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(ee>=0&&ee<=P.width-re&&le>=0&&le<=P.height-ae){const it=q.createBuffer();q.bindBuffer(q.PIXEL_PACK_BUFFER,it),q.bufferData(q.PIXEL_PACK_BUFFER,ze.byteLength,q.STREAM_READ),q.readPixels(ee,le,re,ae,We.convert(W),We.convert(Re),0),q.flush();const ft=q.fenceSync(q.SYNC_GPU_COMMANDS_COMPLETE,0);await dp(q,ft,4);try{q.bindBuffer(q.PIXEL_PACK_BUFFER,it),q.getBufferSubData(q.PIXEL_PACK_BUFFER,0,ze)}finally{q.deleteBuffer(it),q.deleteSync(ft)}return ze}}finally{const he=z!==null?Fe.get(z).__webglFramebuffer:null;Ie.bindFramebuffer(q.FRAMEBUFFER,he)}}},this.copyFramebufferToTexture=function(P,ee=null,le=0){P.isTexture!==!0&&(ws("WebGLRenderer: copyFramebufferToTexture function signature has changed."),ee=arguments[0]||null,P=arguments[1]);const re=Math.pow(2,-le),ae=Math.floor(P.image.width*re),ze=Math.floor(P.image.height*re),Be=ee!==null?ee.x:0,V=ee!==null?ee.y:0;Oe.setTexture2D(P,0),q.copyTexSubImage2D(q.TEXTURE_2D,le,0,0,Be,V,ae,ze),Ie.unbindTexture()},this.copyTextureToTexture=function(P,ee,le=null,re=null,ae=0){P.isTexture!==!0&&(ws("WebGLRenderer: copyTextureToTexture function signature has changed."),re=arguments[0]||null,P=arguments[1],ee=arguments[2],ae=arguments[3]||0,le=null);let ze,Be,V,he,W,Re;le!==null?(ze=le.max.x-le.min.x,Be=le.max.y-le.min.y,V=le.min.x,he=le.min.y):(ze=P.image.width,Be=P.image.height,V=0,he=0),re!==null?(W=re.x,Re=re.y):(W=0,Re=0);const it=We.convert(ee.format),ft=We.convert(ee.type);Oe.setTexture2D(ee,0),q.pixelStorei(q.UNPACK_FLIP_Y_WEBGL,ee.flipY),q.pixelStorei(q.UNPACK_PREMULTIPLY_ALPHA_WEBGL,ee.premultiplyAlpha),q.pixelStorei(q.UNPACK_ALIGNMENT,ee.unpackAlignment);const zt=q.getParameter(q.UNPACK_ROW_LENGTH),Rt=q.getParameter(q.UNPACK_IMAGE_HEIGHT),Bt=q.getParameter(q.UNPACK_SKIP_PIXELS),wt=q.getParameter(q.UNPACK_SKIP_ROWS),rt=q.getParameter(q.UNPACK_SKIP_IMAGES),Ut=P.isCompressedTexture?P.mipmaps[ae]:P.image;q.pixelStorei(q.UNPACK_ROW_LENGTH,Ut.width),q.pixelStorei(q.UNPACK_IMAGE_HEIGHT,Ut.height),q.pixelStorei(q.UNPACK_SKIP_PIXELS,V),q.pixelStorei(q.UNPACK_SKIP_ROWS,he),P.isDataTexture?q.texSubImage2D(q.TEXTURE_2D,ae,W,Re,ze,Be,it,ft,Ut.data):P.isCompressedTexture?q.compressedTexSubImage2D(q.TEXTURE_2D,ae,W,Re,Ut.width,Ut.height,it,Ut.data):q.texSubImage2D(q.TEXTURE_2D,ae,W,Re,ze,Be,it,ft,Ut),q.pixelStorei(q.UNPACK_ROW_LENGTH,zt),q.pixelStorei(q.UNPACK_IMAGE_HEIGHT,Rt),q.pixelStorei(q.UNPACK_SKIP_PIXELS,Bt),q.pixelStorei(q.UNPACK_SKIP_ROWS,wt),q.pixelStorei(q.UNPACK_SKIP_IMAGES,rt),ae===0&&ee.generateMipmaps&&q.generateMipmap(q.TEXTURE_2D),Ie.unbindTexture()},this.copyTextureToTexture3D=function(P,ee,le=null,re=null,ae=0){P.isTexture!==!0&&(ws("WebGLRenderer: copyTextureToTexture3D function signature has changed."),le=arguments[0]||null,re=arguments[1]||null,P=arguments[2],ee=arguments[3],ae=arguments[4]||0);let ze,Be,V,he,W,Re,it,ft,zt;const Rt=P.isCompressedTexture?P.mipmaps[ae]:P.image;le!==null?(ze=le.max.x-le.min.x,Be=le.max.y-le.min.y,V=le.max.z-le.min.z,he=le.min.x,W=le.min.y,Re=le.min.z):(ze=Rt.width,Be=Rt.height,V=Rt.depth,he=0,W=0,Re=0),re!==null?(it=re.x,ft=re.y,zt=re.z):(it=0,ft=0,zt=0);const Bt=We.convert(ee.format),wt=We.convert(ee.type);let rt;if(ee.isData3DTexture)Oe.setTexture3D(ee,0),rt=q.TEXTURE_3D;else if(ee.isDataArrayTexture||ee.isCompressedArrayTexture)Oe.setTexture2DArray(ee,0),rt=q.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}q.pixelStorei(q.UNPACK_FLIP_Y_WEBGL,ee.flipY),q.pixelStorei(q.UNPACK_PREMULTIPLY_ALPHA_WEBGL,ee.premultiplyAlpha),q.pixelStorei(q.UNPACK_ALIGNMENT,ee.unpackAlignment);const Ut=q.getParameter(q.UNPACK_ROW_LENGTH),xt=q.getParameter(q.UNPACK_IMAGE_HEIGHT),jt=q.getParameter(q.UNPACK_SKIP_PIXELS),Ht=q.getParameter(q.UNPACK_SKIP_ROWS),Qt=q.getParameter(q.UNPACK_SKIP_IMAGES);q.pixelStorei(q.UNPACK_ROW_LENGTH,Rt.width),q.pixelStorei(q.UNPACK_IMAGE_HEIGHT,Rt.height),q.pixelStorei(q.UNPACK_SKIP_PIXELS,he),q.pixelStorei(q.UNPACK_SKIP_ROWS,W),q.pixelStorei(q.UNPACK_SKIP_IMAGES,Re),P.isDataTexture||P.isData3DTexture?q.texSubImage3D(rt,ae,it,ft,zt,ze,Be,V,Bt,wt,Rt.data):ee.isCompressedArrayTexture?q.compressedTexSubImage3D(rt,ae,it,ft,zt,ze,Be,V,Bt,Rt.data):q.texSubImage3D(rt,ae,it,ft,zt,ze,Be,V,Bt,wt,Rt),q.pixelStorei(q.UNPACK_ROW_LENGTH,Ut),q.pixelStorei(q.UNPACK_IMAGE_HEIGHT,xt),q.pixelStorei(q.UNPACK_SKIP_PIXELS,jt),q.pixelStorei(q.UNPACK_SKIP_ROWS,Ht),q.pixelStorei(q.UNPACK_SKIP_IMAGES,Qt),ae===0&&ee.generateMipmaps&&q.generateMipmap(rt),Ie.unbindTexture()},this.initRenderTarget=function(P){Fe.get(P).__webglFramebuffer===void 0&&Oe.setupRenderTarget(P)},this.initTexture=function(P){P.isCubeTexture?Oe.setTextureCube(P,0):P.isData3DTexture?Oe.setTexture3D(P,0):P.isDataArrayTexture||P.isCompressedArrayTexture?Oe.setTexture2DArray(P,0):Oe.setTexture2D(P,0),Ie.unbindTexture()},this.resetState=function(){j=0,U=0,z=null,Ie.reset(),Je.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Ri}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===dl?"display-p3":"srgb",t.unpackColorSpace=kt.workingColorSpace===Oo?"display-p3":"srgb"}}class Mg extends on{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new ui,this.environmentIntensity=1,this.environmentRotation=new ui,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(t.object.environmentIntensity=this.environmentIntensity),t.object.environmentRotation=this.environmentRotation.toArray(),t}}class ko extends is{constructor(e){super(),this.isLineBasicMaterial=!0,this.type="LineBasicMaterial",this.color=new Tt(16777215),this.map=null,this.linewidth=1,this.linecap="round",this.linejoin="round",this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.linewidth=e.linewidth,this.linecap=e.linecap,this.linejoin=e.linejoin,this.fog=e.fog,this}}const No=new be,qo=new be,Nc=new tn,Es=new uu,go=new zo,_r=new be,qc=new be;class tl extends on{constructor(e=new kn,t=new ko){super(),this.isLine=!0,this.type="Line",this.geometry=e,this.material=t,this.updateMorphTargets()}copy(e,t){return super.copy(e,t),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}computeLineDistances(){const e=this.geometry;if(e.index===null){const t=e.attributes.position,n=[0];for(let a=1,s=t.count;a<s;a++)No.fromBufferAttribute(t,a-1),qo.fromBufferAttribute(t,a),n[a]=n[a-1],n[a]+=No.distanceTo(qo);e.setAttribute("lineDistance",new fn(n,1))}else console.warn("THREE.Line.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}raycast(e,t){const n=this.geometry,a=this.matrixWorld,s=e.params.Line.threshold,c=n.drawRange;if(n.boundingSphere===null&&n.computeBoundingSphere(),go.copy(n.boundingSphere),go.applyMatrix4(a),go.radius+=s,e.ray.intersectsSphere(go)===!1)return;Nc.copy(a).invert(),Es.copy(e.ray).applyMatrix4(Nc);const l=s/((this.scale.x+this.scale.y+this.scale.z)/3),u=l*l,d=this.isLineSegments?2:1,p=n.index,f=n.attributes.position;if(p!==null){const v=Math.max(0,c.start),E=Math.min(p.count,c.start+c.count);for(let C=v,h=E-1;C<h;C+=d){const m=p.getX(C),R=p.getX(C+1),w=_o(this,e,Es,u,m,R);w&&t.push(w)}if(this.isLineLoop){const C=p.getX(E-1),h=p.getX(v),m=_o(this,e,Es,u,C,h);m&&t.push(m)}}else{const v=Math.max(0,c.start),E=Math.min(f.count,c.start+c.count);for(let C=v,h=E-1;C<h;C+=d){const m=_o(this,e,Es,u,C,C+1);m&&t.push(m)}if(this.isLineLoop){const C=_o(this,e,Es,u,E-1,v);C&&t.push(C)}}}updateMorphTargets(){const t=this.geometry.morphAttributes,n=Object.keys(t);if(n.length>0){const a=t[n[0]];if(a!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let s=0,c=a.length;s<c;s++){const l=a[s].name||String(s);this.morphTargetInfluences.push(0),this.morphTargetDictionary[l]=s}}}}}function _o(i,e,t,n,a,s){const c=i.geometry.attributes.position;if(No.fromBufferAttribute(c,a),qo.fromBufferAttribute(c,s),t.distanceSqToSegment(No,qo,_r,qc)>n)return;_r.applyMatrix4(i.matrixWorld);const u=e.ray.origin.distanceTo(_r);if(!(u<e.near||u>e.far))return{distance:u,point:qc.clone().applyMatrix4(i.matrixWorld),index:a,face:null,faceIndex:null,object:i}}const Fc=new be,Oc=new be;class Eu extends tl{constructor(e,t){super(e,t),this.isLineSegments=!0,this.type="LineSegments"}computeLineDistances(){const e=this.geometry;if(e.index===null){const t=e.attributes.position,n=[];for(let a=0,s=t.count;a<s;a+=2)Fc.fromBufferAttribute(t,a),Oc.fromBufferAttribute(t,a+1),n[a]=a===0?0:n[a-1],n[a+1]=n[a]+Fc.distanceTo(Oc);e.setAttribute("lineDistance",new fn(n,1))}else console.warn("THREE.LineSegments.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}}class ml extends kn{constructor(e=1,t=1,n=1,a=32,s=1,c=!1,l=0,u=Math.PI*2){super(),this.type="CylinderGeometry",this.parameters={radiusTop:e,radiusBottom:t,height:n,radialSegments:a,heightSegments:s,openEnded:c,thetaStart:l,thetaLength:u};const d=this;a=Math.floor(a),s=Math.floor(s);const p=[],g=[],f=[],v=[];let E=0;const C=[],h=n/2;let m=0;R(),c===!1&&(e>0&&w(!0),t>0&&w(!1)),this.setIndex(p),this.setAttribute("position",new fn(g,3)),this.setAttribute("normal",new fn(f,3)),this.setAttribute("uv",new fn(v,2));function R(){const I=new be,j=new be;let U=0;const z=(t-e)/n;for(let F=0;F<=s;F++){const T=[],A=F/s,O=A*(t-e)+e;for(let $=0;$<=a;$++){const J=$/a,Y=J*u+l,ne=Math.sin(Y),oe=Math.cos(Y);j.x=O*ne,j.y=-A*n+h,j.z=O*oe,g.push(j.x,j.y,j.z),I.set(ne,z,oe).normalize(),f.push(I.x,I.y,I.z),v.push(J,1-A),T.push(E++)}C.push(T)}for(let F=0;F<a;F++)for(let T=0;T<s;T++){const A=C[T][F],O=C[T+1][F],$=C[T+1][F+1],J=C[T][F+1];p.push(A,O,J),p.push(O,$,J),U+=6}d.addGroup(m,U,0),m+=U}function w(I){const j=E,U=new Ot,z=new be;let F=0;const T=I===!0?e:t,A=I===!0?1:-1;for(let $=1;$<=a;$++)g.push(0,h*A,0),f.push(0,A,0),v.push(.5,.5),E++;const O=E;for(let $=0;$<=a;$++){const Y=$/a*u+l,ne=Math.cos(Y),oe=Math.sin(Y);z.x=T*oe,z.y=h*A,z.z=T*ne,g.push(z.x,z.y,z.z),f.push(0,A,0),U.x=ne*.5+.5,U.y=oe*.5*A+.5,v.push(U.x,U.y),E++}for(let $=0;$<a;$++){const J=j+$,Y=O+$;I===!0?p.push(Y,Y+1,J):p.push(Y+1,Y,J),F+=3}d.addGroup(m,F,I===!0?1:2),m+=F}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new ml(e.radiusTop,e.radiusBottom,e.height,e.radialSegments,e.heightSegments,e.openEnded,e.thetaStart,e.thetaLength)}}class zc extends is{constructor(e){super(),this.isMeshPhongMaterial=!0,this.type="MeshPhongMaterial",this.color=new Tt(16777215),this.specular=new Tt(1118481),this.shininess=30,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Tt(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=su,this.normalScale=new Ot(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.specularMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new ui,this.combine=al,this.reflectivity=1,this.refractionRatio=.98,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.specular.copy(e.specular),this.shininess=e.shininess,this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.specularMap=e.specularMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapRotation.copy(e.envMapRotation),this.combine=e.combine,this.reflectivity=e.reflectivity,this.refractionRatio=e.refractionRatio,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class Tu extends on{constructor(e,t=1){super(),this.isLight=!0,this.type="Light",this.color=new Tt(e),this.intensity=t}dispose(){}copy(e,t){return super.copy(e,t),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const t=super.toJSON(e);return t.object.color=this.color.getHex(),t.object.intensity=this.intensity,this.groundColor!==void 0&&(t.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(t.object.distance=this.distance),this.angle!==void 0&&(t.object.angle=this.angle),this.decay!==void 0&&(t.object.decay=this.decay),this.penumbra!==void 0&&(t.object.penumbra=this.penumbra),this.shadow!==void 0&&(t.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(t.object.target=this.target.uuid),t}}const xr=new tn,Bc=new be,Hc=new be;class Sg{constructor(e){this.camera=e,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new Ot(512,512),this.map=null,this.mapPass=null,this.matrix=new tn,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new fl,this._frameExtents=new Ot(1,1),this._viewportCount=1,this._viewports=[new sn(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const t=this.camera,n=this.matrix;Bc.setFromMatrixPosition(e.matrixWorld),t.position.copy(Bc),Hc.setFromMatrixPosition(e.target.matrixWorld),t.lookAt(Hc),t.updateMatrixWorld(),xr.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),this._frustum.setFromProjectionMatrix(xr),n.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),n.multiply(xr)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.intensity=e.intensity,this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.intensity!==1&&(e.intensity=this.intensity),this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}class Cg extends Sg{constructor(){super(new xu(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class Eg extends Tu{constructor(e,t){super(e,t),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(on.DEFAULT_UP),this.updateMatrix(),this.target=new on,this.shadow=new Cg}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class Tg extends Tu{constructor(e,t){super(e,t),this.isAmbientLight=!0,this.type="AmbientLight"}}class Ag{constructor(e=!0){this.autoStart=e,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=kc(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let e=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){const t=kc();e=(t-this.oldTime)/1e3,this.oldTime=t,this.elapsedTime+=e}return e}}function kc(){return(typeof performance>"u"?Date:performance).now()}class wg extends Eu{constructor(e=10,t=10,n=4473924,a=8947848){n=new Tt(n),a=new Tt(a);const s=t/2,c=e/t,l=e/2,u=[],d=[];for(let f=0,v=0,E=-l;f<=t;f++,E+=c){u.push(-l,0,E,l,0,E),u.push(E,0,-l,E,0,l);const C=f===s?n:a;C.toArray(d,v),v+=3,C.toArray(d,v),v+=3,C.toArray(d,v),v+=3,C.toArray(d,v),v+=3}const p=new kn;p.setAttribute("position",new fn(u,3)),p.setAttribute("color",new fn(d,3));const g=new ko({vertexColors:!0,toneMapped:!1});super(p,g),this.type="GridHelper"}dispose(){this.geometry.dispose(),this.material.dispose()}}const Vc=new be,xo=new be,Gc=new be;class Pg extends on{constructor(e,t,n){super(),this.light=e,this.matrix=e.matrixWorld,this.matrixAutoUpdate=!1,this.color=n,this.type="DirectionalLightHelper",t===void 0&&(t=1);let a=new kn;a.setAttribute("position",new fn([-t,t,0,t,t,0,t,-t,0,-t,-t,0,-t,t,0],3));const s=new ko({fog:!1,toneMapped:!1});this.lightPlane=new tl(a,s),this.add(this.lightPlane),a=new kn,a.setAttribute("position",new fn([0,0,0,0,0,1],3)),this.targetLine=new tl(a,s),this.add(this.targetLine),this.update()}dispose(){this.lightPlane.geometry.dispose(),this.lightPlane.material.dispose(),this.targetLine.geometry.dispose(),this.targetLine.material.dispose()}update(){this.light.updateWorldMatrix(!0,!1),this.light.target.updateWorldMatrix(!0,!1),Vc.setFromMatrixPosition(this.light.matrixWorld),xo.setFromMatrixPosition(this.light.target.matrixWorld),Gc.subVectors(xo,Vc),this.lightPlane.lookAt(xo),this.color!==void 0?(this.lightPlane.material.color.set(this.color),this.targetLine.material.color.set(this.color)):(this.lightPlane.material.color.copy(this.light.color),this.targetLine.material.color.copy(this.light.color)),this.targetLine.lookAt(xo),this.targetLine.scale.z=Gc.length()}}const bo=new be,en=new pl;class Rg extends Eu{constructor(e){const t=new kn,n=new ko({color:16777215,vertexColors:!0,toneMapped:!1}),a=[],s=[],c={};l("n1","n2"),l("n2","n4"),l("n4","n3"),l("n3","n1"),l("f1","f2"),l("f2","f4"),l("f4","f3"),l("f3","f1"),l("n1","f1"),l("n2","f2"),l("n3","f3"),l("n4","f4"),l("p","n1"),l("p","n2"),l("p","n3"),l("p","n4"),l("u1","u2"),l("u2","u3"),l("u3","u1"),l("c","t"),l("p","c"),l("cn1","cn2"),l("cn3","cn4"),l("cf1","cf2"),l("cf3","cf4");function l(E,C){u(E),u(C)}function u(E){a.push(0,0,0),s.push(0,0,0),c[E]===void 0&&(c[E]=[]),c[E].push(a.length/3-1)}t.setAttribute("position",new fn(a,3)),t.setAttribute("color",new fn(s,3)),super(t,n),this.type="CameraHelper",this.camera=e,this.camera.updateProjectionMatrix&&this.camera.updateProjectionMatrix(),this.matrix=e.matrixWorld,this.matrixAutoUpdate=!1,this.pointMap=c,this.update();const d=new Tt(16755200),p=new Tt(16711680),g=new Tt(43775),f=new Tt(16777215),v=new Tt(3355443);this.setColors(d,p,g,f,v)}setColors(e,t,n,a,s){const l=this.geometry.getAttribute("color");l.setXYZ(0,e.r,e.g,e.b),l.setXYZ(1,e.r,e.g,e.b),l.setXYZ(2,e.r,e.g,e.b),l.setXYZ(3,e.r,e.g,e.b),l.setXYZ(4,e.r,e.g,e.b),l.setXYZ(5,e.r,e.g,e.b),l.setXYZ(6,e.r,e.g,e.b),l.setXYZ(7,e.r,e.g,e.b),l.setXYZ(8,e.r,e.g,e.b),l.setXYZ(9,e.r,e.g,e.b),l.setXYZ(10,e.r,e.g,e.b),l.setXYZ(11,e.r,e.g,e.b),l.setXYZ(12,e.r,e.g,e.b),l.setXYZ(13,e.r,e.g,e.b),l.setXYZ(14,e.r,e.g,e.b),l.setXYZ(15,e.r,e.g,e.b),l.setXYZ(16,e.r,e.g,e.b),l.setXYZ(17,e.r,e.g,e.b),l.setXYZ(18,e.r,e.g,e.b),l.setXYZ(19,e.r,e.g,e.b),l.setXYZ(20,e.r,e.g,e.b),l.setXYZ(21,e.r,e.g,e.b),l.setXYZ(22,e.r,e.g,e.b),l.setXYZ(23,e.r,e.g,e.b),l.setXYZ(24,t.r,t.g,t.b),l.setXYZ(25,t.r,t.g,t.b),l.setXYZ(26,t.r,t.g,t.b),l.setXYZ(27,t.r,t.g,t.b),l.setXYZ(28,t.r,t.g,t.b),l.setXYZ(29,t.r,t.g,t.b),l.setXYZ(30,t.r,t.g,t.b),l.setXYZ(31,t.r,t.g,t.b),l.setXYZ(32,n.r,n.g,n.b),l.setXYZ(33,n.r,n.g,n.b),l.setXYZ(34,n.r,n.g,n.b),l.setXYZ(35,n.r,n.g,n.b),l.setXYZ(36,n.r,n.g,n.b),l.setXYZ(37,n.r,n.g,n.b),l.setXYZ(38,a.r,a.g,a.b),l.setXYZ(39,a.r,a.g,a.b),l.setXYZ(40,s.r,s.g,s.b),l.setXYZ(41,s.r,s.g,s.b),l.setXYZ(42,s.r,s.g,s.b),l.setXYZ(43,s.r,s.g,s.b),l.setXYZ(44,s.r,s.g,s.b),l.setXYZ(45,s.r,s.g,s.b),l.setXYZ(46,s.r,s.g,s.b),l.setXYZ(47,s.r,s.g,s.b),l.setXYZ(48,s.r,s.g,s.b),l.setXYZ(49,s.r,s.g,s.b),l.needsUpdate=!0}update(){const e=this.geometry,t=this.pointMap,n=1,a=1;en.projectionMatrixInverse.copy(this.camera.projectionMatrixInverse),nn("c",t,e,en,0,0,-1),nn("t",t,e,en,0,0,1),nn("n1",t,e,en,-n,-a,-1),nn("n2",t,e,en,n,-a,-1),nn("n3",t,e,en,-n,a,-1),nn("n4",t,e,en,n,a,-1),nn("f1",t,e,en,-n,-a,1),nn("f2",t,e,en,n,-a,1),nn("f3",t,e,en,-n,a,1),nn("f4",t,e,en,n,a,1),nn("u1",t,e,en,n*.7,a*1.1,-1),nn("u2",t,e,en,-n*.7,a*1.1,-1),nn("u3",t,e,en,0,a*2,-1),nn("cf1",t,e,en,-n,0,1),nn("cf2",t,e,en,n,0,1),nn("cf3",t,e,en,0,-a,1),nn("cf4",t,e,en,0,a,1),nn("cn1",t,e,en,-n,0,-1),nn("cn2",t,e,en,n,0,-1),nn("cn3",t,e,en,0,-a,-1),nn("cn4",t,e,en,0,a,-1),e.getAttribute("position").needsUpdate=!0}dispose(){this.geometry.dispose(),this.material.dispose()}}function nn(i,e,t,n,a,s,c){bo.set(a,s,c).unproject(n);const l=e[i];if(l!==void 0){const u=t.getAttribute("position");for(let d=0,p=l.length;d<p;d++)u.setXYZ(l[d],bo.x,bo.y,bo.z)}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:il}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=il);class Lg{constructor(e,t,n){Rn(this,"camera");Rn(this,"canvas");Rn(this,"pivot");this.camera=e,this.pivot=t,this.canvas=n,e.translateZ(30),t.rotateX(-Math.PI/8),window.addEventListener("resize",()=>this.onResize()),this.onResize()}update(e){this.pivot.rotateOnWorldAxis(new be(0,1,0),e/20)}onResize(){const e=this.canvas.getBoundingClientRect();this.camera.aspect=e.width/e.height,this.camera.updateProjectionMatrix()}}class Dg extends Eg{constructor(t,n){super(t,n);Rn(this,"freeRotationTarget");this.freeRotationTarget=new on,this.freeRotationTarget.position.set(0,-1,0),this.add(this.freeRotationTarget),this.target=this.freeRotationTarget}restoreFreeRotation(){this.target=this.freeRotationTarget}}let ma;class Vo{constructor(){Rn(this,"canvas");Rn(this,"scene");Rn(this,"renderer");Rn(this,"cameraControl");Rn(this,"sun");Rn(this,"clock");Rn(this,"hideables",[]);Rn(this,"rafId",-1);Rn(this,"accDelta",0);Rn(this,"resizeListenerRef");this.scene=new Mg,this.canvas=document.querySelector("#free-light-example-canvas"),this.renderer=new yg({canvas:this.canvas,powerPreference:"high-performance",antialias:!0,alpha:!0}),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=2;const e=new Wn,t=new As;t.add(e),this.cameraControl=new Lg(e,t,this.canvas),this.scene.add(t),this.sun=new Dg("#ffffff",2),this.sun.position.setY(9),this.sun.castShadow=!0,this.sun.shadow.camera.left=-8,this.sun.shadow.camera.top=8,this.sun.shadow.camera.right=8,this.sun.shadow.camera.bottom=-8,this.sun.shadow.camera.far=18,this.sun.shadow.bias=1e-4,this.sun.shadow.intensity=.8,this.sun.shadow.mapSize.width=512,this.sun.shadow.mapSize.height=512;const n=new Rg(this.sun.shadow.camera),a=new Pg(this.sun);this.scene.add(n),this.scene.add(a),this.scene.add(this.sun);const s=new Tg("#ffffff",.2);this.scene.add(s);const c=new zc({color:new Tt("#444444")}),l=new zc({color:new Tt("#fd855d")}),u=new Yn(new Ea(20,1,20),c);u.receiveShadow=!0,u.castShadow=!0;const d=new Yn(new Ea(2,2,2),l);d.receiveShadow=!0,d.castShadow=!0,d.position.setY(5.5),this.scene.add(d);const p=new Yn(new ml(3,1.5,4,24),l);p.castShadow=!0,p.receiveShadow=!0,p.position.setY(2.5),this.scene.add(p);const g=new wg(30,30,"#ffb399","#fd855d");g.material.opacity=.2,g.material.transparent=!0,g.position.setY(.51),this.scene.add(g),this.scene.add(u),this.clock=new Ag,this.onResize(),this.initListeners(),this.hideables=[g,n,a]}static isInitialized(){return ma!==void 0}static dispose(){ma&&ma.dispose()}static getInstance(){return ma||(ma=new Vo),ma}onResize(){const e=this.canvas.getBoundingClientRect();this.renderer.setSize(e.width,e.height)}renderLoop(){this.rafId=requestAnimationFrame(this.renderLoop.bind(this));const e=Math.min(120,this.clock.getDelta());this.render(e)}startRenderLoop(){this.renderLoop()}stopRenderLoop(){this.clock.stop(),cancelAnimationFrame(this.rafId)}render(e=33){this.accDelta+=e,this.accDelta>Math.PI*4&&(this.accDelta-=Math.PI*4,console.log("rendering")),this.sun.rotation.set(Math.sin(this.accDelta),0,Math.cos(this.accDelta/2)),this.cameraControl.update(e),this.renderer.render(this.scene,this.cameraControl.camera)}initListeners(){this.resizeListenerRef=this.onResize.bind(this),window.addEventListener("resize",this.resizeListenerRef),window.addEventListener("error",()=>{this.stopRenderLoop()})}dispose(){this.stopRenderLoop(),ma=void 0}showHelpers(e=!0){this.hideables.forEach(t=>t.visible=e)}}function Ug(i){let e;return{c(){e=gt(i[1])},l(t){e=_t(t,i[1])},m(t,n){r(t,e,n)},p:Pt,d(t){t&&o(e)}}}function Ig(i){let e;return{c(){e=gt(i[2])},l(t){e=_t(t,i[2])},m(t,n){r(t,e,n)},p:Pt,d(t){t&&o(e)}}}function Ng(i){let e;return{c(){e=gt("const sun = new RotableDirectionalLight('#ffffff', 2)")},l(t){e=_t(t,"const sun = new RotableDirectionalLight('#ffffff', 2)")},m(t,n){r(t,e,n)},d(t){t&&o(e)}}}function qg(i){let e,t=`Hasta hace unos años me obsesionaba el tiempo, no me dejaba vivir en paz, siempre
...
la original. Describo luego.`,ne,oe,de=`Verás, en casi toda solución de renderizado 3D, los objetos
...
o bien mediante algún método rotate. En Three.js funciona igual.`,Z,Ue,ie=`La primera experiencia de un alumno mío con Three.js fue nefasta. Me contó que tras una hora
...
donde quería (concretamente hacia la dirección 0,0,0).`,ge,Xe,ke=`En Three.js (hasta la fecha, release 168), por defecto, la rotación del objeto
...
Por defecto, hacia las coordenadas 0,0,0, osea, al centro de la escena.`,te,Ce,Le=`En realidad no supone ningún problema: moviendo el target puedes cambiar la
...
libre.`,Te,He,ue=`Aunque se topó con esto, se convenció de que no tenía sentido y que Three.js era
...
depararía el futuro? Atento a esto:`,we,at,q,Ze,nt=`En este caso, <code>sun</code> es una <code>DirectionalLight</code> que como todas, siempre apunta a su
...
de manera acorde.`,Ve,Ie,st=`¿Básicamente en 2 líneas hemos hecho que una luz rote acorde a su propiedad
...
de mero usuario.`,Fe,Oe,N=`Esto es común cuando no están acostumbrados a bibliotecas extensibles, libres y
...
incluso contribuir con sus cambios si son muy útiles para alguien.`,_,H,ye=`Me gusta especialmente Three.js porque la mayoría de clases y funciones son
...
que herede de DirectionalLight:`,Ee,De,Ke,k,me="Y así, cuando necesitemos una luz de rotación libre hacer:",tt,K,ve,We,Je=`Solo hay que tener cuidado con la propiedad target, si se modifica manualmente
...
la rotación libre.`,ct,G,Ae="Independencia tecnológica",Me,_e,Pe=`A lo mejor te preguntas por qué iba a querer alguien hacerse sus propias
...
Por mucho que pagues una licencia, pasarán de ti.`,pt,Q,Ne=`Pero también es muy común hacerse uno mismo herramientas avanzadas pese a que
...
fuegos que haciendo algo útil.`,vt,ce,qe=`Cuando no tienes que esperar por nadie para corregir un problema, sino que
...
que simplemente “ir lento”, no solo en el tiempo, también en la motivación.`,At,se,B=`Además, la complejidad de las características de bibliotecas, frameworks o
...
puede resolver en una tarde o dos.`,ee,le,re=`Por último y no menos importante hay otra razón para querer
...
o competir. A veces es una oportunidad magnífica para mejorar.`,ae,ze,Be;return U=new hd({props:{id:"free-light-example-canvas",sceneManager:Vo}}),at=new Fn({props:{language:"TypeScript",$$slots:{default:[Ug]},$$scope:{ctx:i}}}),De=new Fn({props:{language:"TypeScript",$$slots:{default:[Ig]},$$scope:{ctx:i}}}),K=new Fn({props:{language:"TypeScript",$$slots:{default:[Ng]},$$scope:{ctx:i}}}),{c(){e=x("p"),e.textContent=t,n=y(),a=x("p"),a.textContent=s,c=y(),l=x("p"),l.textContent=u,d=y(),p=x("p"),p.textContent=g,f=y(),v=x("p"),v.textContent=E,C=y(),h=x("p"),h.innerHTML=m,R=y(),w=x("h2"),w.textContent=I,j=y(),Mt(U.$$.fragment),z=y(),F=x("button"),A=gt(T),O=gt(" helpers"),$=y(),J=x("p"),J.innerHTML=Y,ne=y(),oe=x("p"),oe.textContent=de,Z=y(),Ue=x("p"),Ue.textContent=ie,ge=y(),Xe=x("p"),Xe.innerHTML=ke,te=y(),Ce=x("p"),Ce.textContent=Le,Te=y(),He=x("p"),He.textContent=ue,we=y(),Mt(at.$$.fragment),q=y(),Ze=x("p"),Ze.innerHTML=nt,Ve=y(),Ie=x("p"),Ie.textContent=st,Fe=y(),Oe=x("p"),Oe.textContent=N,_=y(),H=x("p"),H.textContent=ye,fe=y(),pe=x("p"),pe.textContent=je,Ee=y(),Mt(De.$$.fragment),Ke=y(),k=x("p"),k.textContent=me,tt=y(),Mt(K.$$.fragment),ve=y(),We=x("p"),We.textContent=Je,ct=y(),G=x("h2"),G.textContent=Ae,Me=y(),_e=x("p"),_e.textContent=Pe,$e=y(),Qe=x("p"),Qe.textContent=lt,ut=y(),et=x("p"),et.textContent=dt,pt=y(),Q=x("p"),Q.textContent=Ne,vt=y(),ce=x("p"),ce.textContent=qe,At=y(),se=x("p"),se.textContent=B,Ye=y(),Nt=x("p"),Nt.textContent=qt,cn=y(),Vt=x("p"),Vt.textContent=P,ee=y(),le=x("p"),le.textContent=re},l(V){e=b(V,"P",{"data-svelte-h":!0}),S(e)!=="svelte-c5t86c"&&(e.textContent=t),n=M(V),a=b(V,"P",{"data-svelte-h":!0}),S(a)!=="svelte-pk5ahq"&&(a.textContent=s),c=M(V),l=b(V,"P",{"data-svelte-h":!0}),S(l)!=="svelte-197l6dv"&&(l.textContent=u),d=M(V),p=b(V,"P",{"data-svelte-h":!0}),S(p)!=="svelte-ib4xxd"&&(p.textContent=g),f=M(V),v=b(V,"P",{"data-svelte-h":!0}),S(v)!=="svelte-1euodzh"&&(v.textContent=E),C=M(V),h=b(V,"P",{"data-svelte-h":!0}),S(h)!=="svelte-zzi0ez"&&(h.innerHTML=m),R=M(V),w=b(V,"H2",{"data-svelte-h":!0}),S(w)!=="svelte-1tmvlw"&&(w.textContent=I),j=M(V),St(U.$$.fragment,V),z=M(V),F=b(V,"BUTTON",{});var he=Gt(F);A=_t(he,T),O=_t(he," helpers"),he.forEach(o),$=M(V),J=b(V,"P",{"data-svelte-h":!0}),S(J)!=="svelte-yx5zak"&&(J.innerHTML=Y),ne=M(V),oe=b(V,"P",{"data-svelte-h":!0}),S(oe)!=="svelte-w5qrkk"&&(oe.textContent=de),Z=M(V),Ue=b(V,"P",{"data-svelte-h":!0}),S(Ue)!=="svelte-10quyp6"&&(Ue.textContent=ie),ge=M(V),Xe=b(V,"P",{"data-svelte-h":!0}),S(Xe)!=="svelte-zy0dfi"&&(Xe.innerHTML=ke),te=M(V),Ce=b(V,"P",{"data-svelte-h":!0}),S(Ce)!=="svelte-1pb2lwd"&&(Ce.textContent=Le),Te=M(V),He=b(V,"P",{"data-svelte-h":!0}),S(He)!=="svelte-f7k36c"&&(He.textContent=ue),we=M(V),St(at.$$.fragment,V),q=M(V),Ze=b(V,"P",{"data-svelte-h":!0}),S(Ze)!=="svelte-1hstxkr"&&(Ze.innerHTML=nt),Ve=M(V),Ie=b(V,"P",{"data-svelte-h":!0}),S(Ie)!=="svelte-1xv2743"&&(Ie.textContent=st),Fe=M(V),Oe=b(V,"P",{"data-svelte-h":!0}),S(Oe)!=="svelte-12h2073"&&(Oe.textContent=N),_=M(V),H=b(V,"P",{"data-svelte-h":!0}),S(H)!=="svelte-wynhgl"&&(H.textContent=ye),fe=M(V),pe=b(V,"P",{"data-svelte-h":!0}),S(pe)!=="svelte-1cjupe8"&&(pe.textContent=je),Ee=M(V),St(De.$$.fragment,V),Ke=M(V),k=b(V,"P",{"data-svelte-h":!0}),S(k)!=="svelte-1k1an1v"&&(k.textContent=me),tt=M(V),St(K.$$.fragment,V),ve=M(V),We=b(V,"P",{"data-svelte-h":!0}),S(We)!=="svelte-15mcduz"&&(We.textContent=Je),ct=M(V),G=b(V,"H2",{"data-svelte-h":!0}),S(G)!=="svelte-19g7tyv"&&(G.textContent=Ae),Me=M(V),_e=b(V,"P",{"data-svelte-h":!0}),S(_e)!=="svelte-1jgn7bv"&&(_e.textContent=Pe),$e=M(V),Qe=b(V,"P",{"data-svelte-h":!0}),S(Qe)!=="svelte-6lsf2o"&&(Qe.textContent=lt),ut=M(V),et=b(V,"P",{"data-svelte-h":!0}),S(et)!=="svelte-ab3ka0"&&(et.textContent=dt),pt=M(V),Q=b(V,"P",{"data-svelte-h":!0}),S(Q)!=="svelte-1rp33dg"&&(Q.textContent=Ne),vt=M(V),ce=b(V,"P",{"data-svelte-h":!0}),S(ce)!=="svelte-1g994jb"&&(ce.textContent=qe),At=M(V),se=b(V,"P",{"data-svelte-h":!0}),S(se)!=="svelte-gjgp1o"&&(se.textContent=B),Ye=M(V),Nt=b(V,"P",{"data-svelte-h":!0}),S(Nt)!=="svelte-6ydtym"&&(Nt.textContent=qt),cn=M(V),Vt=b(V,"P",{"data-svelte-h":!0}),S(Vt)!=="svelte-vjyqrs"&&(Vt.textContent=P),ee=M(V),le=b(V,"P",{"data-svelte-h":!0}),S(le)!=="svelte-11prgsj"&&(le.textContent=re)},m(V,he){r(V,e,he),r(V,n,he),r(V,a,he),r(V,c,he),r(V,l,he),r(V,d,he),r(V,p,he),r(V,f,he),r(V,v,he),r(V,C,he),r(V,h,he),r(V,R,he),r(V,w,he),r(V,j,he),Ct(U,V,he),r(V,z,he),r(V,F,he),It(F,A),It(F,O),r(V,$,he),r(V,J,he),r(V,ne,he),r(V,oe,he),r(V,Z,he),r(V,Ue,he),r(V,ge,he),r(V,Xe,he),r(V,te,he),r(V,Ce,he),r(V,Te,he),r(V,He,he),r(V,we,he),Ct(at,V,he),r(V,q,he),r(V,Ze,he),r(V,Ve,he),r(V,Ie,he),r(V,Fe,he),r(V,Oe,he),r(V,_,he),r(V,H,he),r(V,fe,he),r(V,pe,he),r(V,Ee,he),Ct(De,V,he),r(V,Ke,he),r(V,k,he),r(V,tt,he),Ct(K,V,he),r(V,ve,he),r(V,We,he),r(V,ct,he),r(V,G,he),r(V,Me,he),r(V,_e,he),r(V,$e,he),r(V,Qe,he),r(V,ut,he),r(V,et,he),r(V,pt,he),r(V,Q,he),r(V,vt,he),r(V,ce,he),r(V,At,he),r(V,se,he),r(V,Ye,he),r(V,Nt,he),r(V,cn,he),r(V,Vt,he),r(V,ee,he),r(V,le,he),ae=!0,ze||(Be=nl(F,"click",i[3]),ze=!0)},p(V,[he]){(!ae||he&1)&&T!==(T=V[0]?"Ocultar":"Mostrar")&&Rs(A,T);const W={};he&16&&(W.$$scope={dirty:he,ctx:V}),at.$set(W);const Re={};he&16&&(Re.$$scope={dirty:he,ctx:V}),De.$set(Re);const it={};he&16&&(it.$$scope={dirty:he,ctx:V}),K.$set(it)},i(V){ae||(ht(U.$$.fragment,V),ht(at.$$.fragment,V),ht(De.$$.fragment,V),ht(K.$$.fragment,V),ae=!0)},o(V){mt(U.$$.fragment,V),mt(at.$$.fragment,V),mt(De.$$.fragment,V),mt(K.$$.fragment,V),ae=!1},d(V){V&&(o(e),o(n),o(a),o(c),o(l),o(d),o(p),o(f),o(v),o(C),o(h),o(R),o(w),o(j),o(z),o(F),o($),o(J),o(ne),o(oe),o(Z),o(Ue),o(ge),o(Xe),o(te),o(Ce),o(Te),o(He),o(we),o(q),o(Ze),o(Ve),o(Ie),o(Fe),o(Oe),o(_),o(H),o(fe),o(pe),o(Ee),o(Ke),o(k),o(tt),o(ve),o(We),o(ct),o(G),o(Me),o(_e),o($e),o(Qe),o(ut),o(et),o(pt),o(Q),o(vt),o(ce),o(At),o(se),o(Ye),o(Nt),o(cn),o(Vt),o(ee),o(le)),Et(U,V),Et(at,V),Et(De,V),Et(K,V),ze=!1,Be()}}}const Fg={title:"Deja de esperar por otros",slug:"deja-esperar-otros",coverImage:"/src/assets/posts-covers/jon-tyson.jpg",coverPosition:"normal",coverAuthor:"Jon Tyson",excerpt:"Hacerte tus propias herramientas puede acelerar tu trabajo, explico por qué.",date:"2024-09-13T13:00:23.177Z",updated:"2024-09-13T13:00:23.903Z",hidden:!1,tags:["Tooling","Three.js","DX"],keywords:["herramientas","esperar","Three"],type:"default",fullReload:!1};function Og(i,e,t){let n;const a=`const sun = new DirectionalLight('#ffffff', 2)
...
algo que siempre he considerado aterrador.`,Y,ne,oe=`Tengo un problema que hace años manejaba de forma extraña. Implicaba esconder
...
me dejaría como un fraude.`,de,Z,Ue=`Hoy día le he encontrado un sentido más justificado. Me he topado
...
esquemas de la RTDB eran más reducidos que ahora.`,oe,de,Z,Ue,ie=`Pero Cloud Functions en realidad sí estaba disponible, lo único que limitaba
eran las llamadas a la API de manera externa, vamos, justamente lo que más
necesita alguien que quiera usar el servicio.`,ge,Xe,ke=`Lo que exploté es que sí permitía definir “triggers” o disparadores.
Funciones que se ejecutaran ante situaciones concretas en la base de datos,
como que un usuario escribe un dato en determinado nodo.`,te,Ce,Le=`El servicio no garantizaba que la ejecución de esos disparadores fuera
inmediata. Además, solo se podía comunicar con la base de datos,
no podía responder hacia fuera de ninguna manera… ¿o sí? 🙂`,Te,He,ue="Los observables",we,at,q=`La gracia de la RTDB es que es en tiempo real como su nombre indica. Esto
...
refrescar.`,Ze,nt,Ve=`Ahora supongamos una base de datos en la que se reserva para cada usuario un
nodo con 2 subnodos a los que coherentemente llamamos request y response:`,Ie,st,Fe,Oe,N=`Cuando un usuario quiere hacer una petición POST, en lugar de hacer una petición
...
usuario— puede establecer los datos de la petición.`,_,H,ye=`El exploit reside en la configuración de un trigger que se disparará cuando un
...
contexto siendo, en efecto, una forma de invocar una función con argumentos.`,fe,pe,je,Ee,De=`Si se quiere crear una sala de chat, el usuario solo tendría que escribir en su
...
En este ejemplo el único parámetro se trataba de una contraseña para la sala.`,Ke,k,me=`En resumen: hice una API a través de una base de datos. La forma de recibir
...
actualmente Meets)`,tt,K,ve,We,Je=`Todo este proceso es transparente a la aplicación. Podemos abstraer una interfaz
...
barata que Cloud Functions en sí misma.`,Me,_e,Pe="Las consecuencias",$e,Qe,lt=`Las consecuencias no fueron más que gotas a un vaso a punto
...
señalización. Para ello especifiqué la siguiente función:`,$,J,Y,ne,oe=`<code>ShapeName</code> se trata de una string, un tipo de unión ‘rect’ | ‘image’, aunque
en un primer momento solo existe ‘rect’. La opción target es un selector CSS
o una referencia directa al elemento objetivo.`,de,Z,Ue=`<li>Si es un selector, trabajará con el primer elemento que encuentre con ese selector, o lanzará excepción si no encuentra nada.</li> <li>Creará un elemento SVG que añadirá como hijo al body.</li> <li>Dicho SVG debe estar posicionado absolutamente sobre el elemento a señalar.</li> <li>Dicho SVG debe tener un tamaño similar al elemento a señalar.
<ul><li>Digo similar porque podría ser más grande, si quiere rodearse sin taparlo.</li></ul></li>`,ie,ge,Xe="En las primeras iteraciones de herramientas gráficas me gusta centrarme en la exploración tecnológica. Hacer un caso mínimo funcional que dé un resultado visual inmediato.",ke,te,Ce="Especificaciones formales con algún framework de testing",Le,Te,He=`Aquí empieza lo realmente interesante. Hay que testar visualmente, eso está
...
Considera la siguiente spec:`,ue,we,at,q,Ze=`Esto no requiere renderizado. Vale con un DOM virtual, comprobar que se crea
un nuevo nodo y si queda colgando del body. Hacer una prueba E2E para esto es
matar moscas a cañonazos.`,nt,Ve,Ie="Especificación visual",st,Fe,Oe=`Me gusta la <em>regresión visual</em>, pero tiene un pequeño problema. Por si no sabes
...
metodologías de diseño y <strong>la regresión visual no aporta nada en la fase de diseño o para definir especificaciones preimplementación.</strong>`,ye,fe,pe="Buscando la alternativa a la regresión visual",je,Ee,De,Ke,k,me,tt,K=`El proceso que he realizado es el siguiente: adaptar una biblioteca o framework
...
y centrándonos solo en el resultado visual.`,ve,We,Je="Supongamos la siguiente especificacion:",ct,G,Ae,Me,_e="Nuestro escenario de pruebas podría contener, entre otras cosas, lo siguiente:",Pe,$e,Qe,lt,ut,et,dt="Y por otra parte, una página copia modificada con el resultado VISUAL esperado",pt,Q,Ne,vt,ce,qe,At=`SÉ LO QUE ESTÁS PENSANDO (o deberías): “pero Alexander, en el esperado no hay
ningún SVG, ¡solo le has puesto un borde naranja de 4 píxeles al elemento!”`,se,B,Ye=`A esto es a lo que me refiero con especificación visual. Podría haber un SVG
...
forma más sencilla que se me ha ocurrido de conseguir lo que se busca visualmente.`,le,re,ae=`En una clásica “especificación por ejemplo” con GIVEN-WHEN-THEN, esta parte
...
estos tests).`,ze,Be,V=`Veamos un test similar al del Mundo Real™. El original y funcional lo tienes
en el repositorio (enlace al final). Es un test parametrizado, se genera con variaciones de
expectedWidth (xW) y expectedHeight (xH).`,he,W,Re,it,ft=`NOTA: que veas tanta especificidad como
...
sospecha y la duda.`),me=y(),tt=x("p"),tt.textContent=K,ve=y(),We=x("p"),We.textContent=Je,ct=y(),Mt(G.$$.fragment),Ae=y(),Me=x("p"),Me.textContent=_e,Pe=y(),Mt($e.$$.fragment),Qe=y(),Mt(lt.$$.fragment),ut=y(),et=x("p"),et.textContent=dt,pt=y(),Mt(Q.$$.fragment),Ne=y(),Mt(vt.$$.fragment),ce=y(),qe=x("p"),qe.textContent=At,se=y(),B=x("p"),B.textContent=Ye,Nt=y(),qt=x("p"),qt.textContent=cn,Vt=y(),P=x("p"),P.textContent=ee,le=y(),re=x("p"),re.textContent=ae,ze=y(),Be=x("p"),Be.textContent=V,he=y(),Mt(W.$$.fragment),Re=y(),it=x("small"),it.textContent=ft,zt=y(),Rt=x("p"),Rt.textContent=Bt,wt=y(),Mt(rt.$$.fragment),Ut=y(),Mt(xt.$$.fragment),jt=y(),Ht=x("h4"),Ht.textContent=Qt,un=y(),bt=x("p"),bt.textContent=hn,dn=y(),Ft=x("p"),Ft.innerHTML=Vn,mn=y(),Wt=x("p"),Wt.textContent=Di,Dn=y(),Kt=x("h3"),Kt.textContent=Ui,Un=y(),Jt=x("p"),Jt.textContent=Ii,In=y(),X=x("p"),X.textContent=Ge,Gn=y(),_n=x("p"),_n.textContent=ss,di=y(),xn=x("p"),xn.textContent=os,pi=y(),bn=x("h3"),bn.textContent=rs,fi=y(),yn=x("p"),yn.textContent=ls,hi=y(),Mn=x("p"),Mn.textContent=cs,mi=y(),Sn=x("p"),Sn.textContent=us,vi=y(),Cn=x("p"),Cn.textContent=ds,gi=y(),En=x("p"),En.textContent=ps,_i=y(),Tn=x("h2"),Tn.textContent=fs,xi=y(),An=x("p"),An.innerHTML=hs,bi=y(),wn=x("p"),wn.textContent=ms,yi=y(),Mt(Pn.$$.fragment)},l(D){e=b(D,"P",{"data-svelte-h":!0}),S(e)!=="svelte-kz757p"&&(e.textContent=t),n=M(D),a=b(D,"P",{"data-svelte-h":!0}),S(a)!=="svelte-yr62zz"&&(a.innerHTML=s),c=M(D),l=b(D,"P",{"data-svelte-h":!0}),S(l)!=="svelte-1ajb8gz"&&(l.textContent=u),d=M(D),p=b(D,"P",{"data-svelte-h":!0}),S(p)!=="svelte-10jjd54"&&(p.innerHTML=g),f=M(D),v=b(D,"H2",{"data-svelte-h":!0}),S(v)!=="svelte-jzlcfs"&&(v.textContent=E),C=M(D),h=b(D,"P",{});var xe=Gt(h);m=_t(xe,`Por ejemplo, ¿qué podría hacer si quisiera
señalizar `),St(R.$$.fragment,xe),w=_t(xe,`?
Si todo funciona bien deberías estar viendo un rectángulo verde sobre las palabras indicadas.`),xe.forEach(o),I=M(D),j=b(D,"P",{"data-svelte-h":!0}),S(j)!=="svelte-h9dgi1"&&(j.textContent=U),z=M(D),St(F.$$.fragment,D),T=M(D),A=b(D,"P",{"data-svelte-h":!0}),S(A)!=="svelte-wn3vay"&&(A.textContent=O),$=M(D),St(J.$$.fragment,D),Y=M(D),ne=b(D,"P",{"data-svelte-h":!0}),S(ne)!=="svelte-rz0i50"&&(ne.innerHTML=oe),de=M(D),Z=b(D,"UL",{"data-svelte-h":!0}),S(Z)!=="svelte-ts57wb"&&(Z.innerHTML=Ue),ie=M(D),ge=b(D,"P",{"data-svelte-h":!0}),S(ge)!=="svelte-1li2hkb"&&(ge.textContent=Xe),ke=M(D),te=b(D,"H3",{"data-svelte-h":!0}),S(te)!=="svelte-1cetu9r"&&(te.textContent=Ce),Le=M(D),Te=b(D,"P",{"data-svelte-h":!0}),S(Te)!=="svelte-nv0msx"&&(Te.textContent=He),ue=M(D),St(we.$$.fragment,D),at=M(D),q=b(D,"P",{"data-svelte-h":!0}),S(q)!=="svelte-86gsr"&&(q.textContent=Ze),nt=M(D),Ve=b(D,"H2",{"data-svelte-h":!0}),S(Ve)!=="svelte-1jmchc1"&&(Ve.textContent=Ie),st=M(D),Fe=b(D,"P",{"data-svelte-h":!0}),S(Fe)!=="svelte-18ctydr"&&(Fe.innerHTML=Oe),N=M(D),_=b(D,"P",{"data-svelte-h":!0}),S(_)!=="svelte-13avi2k"&&(_.innerHTML=H),ye=M(D),fe=b(D,"H3",{"data-svelte-h":!0}),S(fe)!=="svelte-1gxnwn7"&&(fe.textContent=pe),je=M(D),Ee=b(D,"P",{});var ni=Gt(Ee);De=_t(ni,"La siguiente forma de proceder y opiniones son, hasta donde sé, de "),St(Ke.$$.fragment,ni),k=_t(ni,`. No he hecho una investigación exhaustiva ni
sé si hay autores que han escrito sobre esto a favor o en contra. Por eso no
asumas nada de lo que expongo aquí, evita todo prejuicio positivo y afila la
sospecha y la duda.`),ni.forEach(o),me=M(D),tt=b(D,"P",{"data-svelte-h":!0}),S(tt)!=="svelte-evd6ah"&&(tt.textContent=K),ve=M(D),We=b(D,"P",{"data-svelte-h":!0}),S(We)!=="svelte-1usqu0d"&&(We.textContent=Je),ct=M(D),St(G.$$.fragment,D),Ae=M(D),Me=b(D,"P",{"data-svelte-h":!0}),S(Me)!=="svelte-13cl2ob"&&(Me.textContent=_e),Pe=M(D),St($e.$$.fragment,D),Qe=M(D),St(lt.$$.fragment,D),ut=M(D),et=b(D,"P",{"data-svelte-h":!0}),S(et)!=="svelte-1pvoef4"&&(et.textContent=dt),pt=M(D),St(Q.$$.fragment,D),Ne=M(D),St(vt.$$.fragment,D),ce=M(D),qe=b(D,"P",{"data-svelte-h":!0}),S(qe)!=="svelte-s99gcn"&&(qe.textContent=At),se=M(D),B=b(D,"P",{"data-svelte-h":!0}),S(B)!=="svelte-xp8med"&&(B.textContent=Ye),Nt=M(D),qt=b(D,"P",{"data-svelte-h":!0}),S(qt)!=="svelte-1qkk97s"&&(qt.textContent=cn),Vt=M(D),P=b(D,"P",{"data-svelte-h":!0}),S(P)!=="svelte-lro4l7"&&(P.textContent=ee),le=M(D),re=b(D,"P",{"data-svelte-h":!0}),S(re)!=="svelte-1hghbyz"&&(re.textContent=ae),ze=M(D),Be=b(D,"P",{"data-svelte-h":!0}),S(Be)!=="svelte-1n9drh4"&&(Be.textContent=V),he=M(D),St(W.$$.fragment,D),Re=M(D),it=b(D,"SMALL",{"data-svelte-h":!0}),S(it)!=="svelte-og0ogg"&&(it.textContent=ft),zt=M(D),Rt=b(D,"P",{"data-svelte-h":!0}),S(Rt)!=="svelte-1u74y51"&&(Rt.textContent=Bt),wt=M(D),St(rt.$$.fragment,D),Ut=M(D),St(xt.$$.fragment,D),jt=M(D),Ht=b(D,"H4",{"data-svelte-h":!0}),S(Ht)!=="svelte-ftmlr4"&&(Ht.textContent=Qt),un=M(D),bt=b(D,"P",{"data-svelte-h":!0}),S(bt)!=="svelte-1dxwr9q"&&(bt.textContent=hn),dn=M(D),Ft=b(D,"P",{"data-svelte-h":!0}),S(Ft)!=="svelte-1t2sbdi"&&(Ft.innerHTML=Vn),mn=M(D),Wt=b(D,"P",{"data-svelte-h":!0}),S(Wt)!=="svelte-1d5db4w"&&(Wt.textContent=Di),Dn=M(D),Kt=b(D,"H3",{"data-svelte-h":!0}),S(Kt)!=="svelte-xnqpfg"&&(Kt.textContent=Ui),Un=M(D),Jt=b(D,"P",{"data-svelte-h":!0}),S(Jt)!=="svelte-10rlsf7"&&(Jt.textContent=Ii),In=M(D),X=b(D,"P",{"data-svelte-h":!0}),S(X)!=="svelte-1t9pwnw"&&(X.textContent=Ge),Gn=M(D),_n=b(D,"P",{"data-svelte-h":!0}),S(_n)!=="svelte-dp70ds"&&(_n.textContent=ss),di=M(D),xn=b(D,"P",{"data-svelte-h":!0}),S(xn)!=="svelte-hpg0ix"&&(xn.textContent=os),pi=M(D),bn=b(D,"H3",{"data-svelte-h":!0}),S(bn)!=="svelte-12fyqdo"&&(bn.textContent=rs),fi=M(D),yn=b(D,"P",{"data-svelte-h":!0}),S(yn)!=="svelte-1lhdzti"&&(yn.textContent=ls),hi=M(D),Mn=b(D,"P",{"data-svelte-h":!0}),S(Mn)!=="svelte-1rh7odk"&&(Mn.textContent=cs),mi=M(D),Sn=b(D,"P",{"data-svelte-h":!0}),S(Sn)!=="svelte-urr5oj"&&(Sn.textContent=us),vi=M(D),Cn=b(D,"P",{"data-svelte-h":!0}),S(Cn)!=="svelte-1appavq"&&(Cn.textContent=ds),gi=M(D),En=b(D,"P",{"data-svelte-h":!0}),S(En)!=="svelte-zv5b0r"&&(En.textContent=ps),_i=M(D),Tn=b(D,"H2",{"data-svelte-h":!0}),S(Tn)!=="svelte-tboj21"&&(Tn.textContent=fs),xi=M(D),An=b(D,"P",{"data-svelte-h":!0}),S(An)!=="svelte-1yr7544"&&(An.innerHTML=hs),bi=M(D),wn=b(D,"P",{"data-svelte-h":!0}),S(wn)!=="svelte-hh4l2w"&&(wn.textContent=ms),yi=M(D),St(Pn.$$.fragment,D)},m(D,xe){r(D,e,xe),r(D,n,xe),r(D,a,xe),r(D,c,xe),r(D,l,xe),r(D,d,xe),r(D,p,xe),r(D,f,xe),r(D,v,xe),r(D,C,xe),r(D,h,xe),It(h,m),Ct(R,h,null),It(h,w),r(D,I,xe),r(D,j,xe),r(D,z,xe),Ct(F,D,xe),r(D,T,xe),r(D,A,xe),r(D,$,xe),Ct(J,D,xe),r(D,Y,xe),r(D,ne,xe),r(D,de,xe),r(D,Z,xe),r(D,ie,xe),r(D,ge,xe),r(D,ke,xe),r(D,te,xe),r(D,Le,xe),r(D,Te,xe),r(D,ue,xe),Ct(we,D,xe),r(D,at,xe),r(D,q,xe),r(D,nt,xe),r(D,Ve,xe),r(D,st,xe),r(D,Fe,xe),r(D,N,xe),r(D,_,xe),r(D,ye,xe),r(D,fe,xe),r(D,je,xe),r(D,Ee,xe),It(Ee,De),Ct(Ke,Ee,null),It(Ee,k),r(D,me,xe),r(D,tt,xe),r(D,ve,xe),r(D,We,xe),r(D,ct,xe),Ct(G,D,xe),r(D,Ae,xe),r(D,Me,xe),r(D,Pe,xe),Ct($e,D,xe),r(D,Qe,xe),Ct(lt,D,xe),r(D,ut,xe),r(D,et,xe),r(D,pt,xe),Ct(Q,D,xe),r(D,Ne,xe),Ct(vt,D,xe),r(D,ce,xe),r(D,qe,xe),r(D,se,xe),r(D,B,xe),r(D,Nt,xe),r(D,qt,xe),r(D,Vt,xe),r(D,P,xe),r(D,le,xe),r(D,re,xe),r(D,ze,xe),r(D,Be,xe),r(D,he,xe),Ct(W,D,xe),r(D,Re,xe),r(D,it,xe),r(D,zt,xe),r(D,Rt,xe),r(D,wt,xe),Ct(rt,D,xe),r(D,Ut,xe),Ct(xt,D,xe),r(D,jt,xe),r(D,Ht,xe),r(D,un,xe),r(D,bt,xe),r(D,dn,xe),r(D,Ft,xe),r(D,mn,xe),r(D,Wt,xe),r(D,Dn,xe),r(D,Kt,xe),r(D,Un,xe),r(D,Jt,xe),r(D,In,xe),r(D,X,xe),r(D,Gn,xe),r(D,_n,xe),r(D,di,xe),r(D,xn,xe),r(D,pi,xe),r(D,bn,xe),r(D,fi,xe),r(D,yn,xe),r(D,hi,xe),r(D,Mn,xe),r(D,mi,xe),r(D,Sn,xe),r(D,vi,xe),r(D,Cn,xe),r(D,gi,xe),r(D,En,xe),r(D,_i,xe),r(D,Tn,xe),r(D,xi,xe),r(D,An,xe),r(D,bi,xe),r(D,wn,xe),r(D,yi,xe),Ct(Pn,D,xe),$i=!0},p(D,[xe]){const ni={};xe&8&&(ni.$$scope={dirty:xe,ctx:D}),R.$set(ni);const Xi={};xe&8&&(Xi.$$scope={dirty:xe,ctx:D}),F.$set(Xi);const ii={};xe&8&&(ii.$$scope={dirty:xe,ctx:D}),J.$set(ii);const vs={};xe&8&&(vs.$$scope={dirty:xe,ctx:D}),we.$set(vs);const Yi={};xe&8&&(Yi.$$scope={dirty:xe,ctx:D}),Ke.$set(Yi);const ai={};xe&8&&(ai.$$scope={dirty:xe,ctx:D}),G.$set(ai);const gs={};xe&8&&(gs.$$scope={dirty:xe,ctx:D}),$e.$set(gs);const Zi={};xe&8&&(Zi.$$scope={dirty:xe,ctx:D}),Q.$set(Zi);const si={};xe&8&&(si.$$scope={dirty:xe,ctx:D}),W.$set(si);const _s={};xe&8&&(_s.$$scope={dirty:xe,ctx:D}),xt.$set(_s)},i(D){$i||(ht(R.$$.fragment,D),ht(F.$$.fragment,D),ht(J.$$.fragment,D),ht(we.$$.fragment,D),ht(Ke.$$.fragment,D),ht(G.$$.fragment,D),ht($e.$$.fragment,D),ht(lt.$$.fragment,D),ht(Q.$$.fragment,D),ht(vt.$$.fragment,D),ht(W.$$.fragment,D),ht(rt.$$.fragment,D),ht(xt.$$.fragment,D),ht(Pn.$$.fragment,D),$i=!0)},o(D){mt(R.$$.fragment,D),mt(F.$$.fragment,D),mt(J.$$.fragment,D),mt(we.$$.fragment,D),mt(Ke.$$.fragment,D),mt(G.$$.fragment,D),mt($e.$$.fragment,D),mt(lt.$$.fragment,D),mt(Q.$$.fragment,D),mt(vt.$$.fragment,D),mt(W.$$.fragment,D),mt(rt.$$.fragment,D),mt(xt.$$.fragment,D),mt(Pn.$$.fragment,D),$i=!1},d(D){D&&(o(e),o(n),o(a),o(c),o(l),o(d),o(p),o(f),o(v),o(C),o(h),o(I),o(j),o(z),o(T),o(A),o($),o(Y),o(ne),o(de),o(Z),o(ie),o(ge),o(ke),o(te),o(Le),o(Te),o(ue),o(at),o(q),o(nt),o(Ve),o(st),o(Fe),o(N),o(_),o(ye),o(fe),o(je),o(Ee),o(me),o(tt),o(ve),o(We),o(ct),o(Ae),o(Me),o(Pe),o(Qe),o(ut),o(et),o(pt),o(Ne),o(ce),o(qe),o(se),o(B),o(Nt),o(qt),o(Vt),o(P),o(le),o(re),o(ze),o(Be),o(he),o(Re),o(it),o(zt),o(Rt),o(wt),o(Ut),o(jt),o(Ht),o(un),o(bt),o(dn),o(Ft),o(mn),o(Wt),o(Dn),o(Kt),o(Un),o(Jt),o(In),o(X),o(Gn),o(_n),o(di),o(xn),o(pi),o(bn),o(fi),o(yn),o(hi),o(Mn),o(mi),o(Sn),o(vi),o(Cn),o(gi),o(En),o(_i),o(Tn),o(xi),o(An),o(bi),o(wn),o(yi)),Et(R),Et(F,D),Et(J,D),Et(we,D),Et(Ke),Et(G,D),Et($e,D),Et(lt,D),Et(Q,D),Et(vt,D),Et(W,D),Et(rt,D),Et(xt,D),Et(Pn,D)}}}const b_={title:"Especificación visual. Caso Point it out!",slug:"especificacion-visual-caso-point-it-out",coverImage:"/src/assets/posts-covers/pio-round-fail-test.png",coverAuthor:"",excerpt:"Caso de un proyecto en activo para el que repaso el concepto de regresión visual y especificación visual. Contenido denso.",date:"2024-07-25T15:06:23.177Z",updated:"2024-07-25T15:06:23.903Z",hidden:!1,tags:["TDD/BDD/ATDD","Tooling","DX"],keywords:["svg","regresión visual","visual testing"],type:"default",coverPosition:"top"};function y_(i){return jc(()=>{Uu("rect",{target:"#example-target",strokeWidth:4,strokeColor:"#3f37",padding:2})}),[]}class M_ extends Yt{constructor(e){super(),Zt(this,e,y_,x_,Xt,{})}}const S_=Object.freeze(Object.defineProperty({__proto__:null,default:M_,metadata:b_},Symbol.toStringTag,{value:"Module"}));function C_(i){let e,t=`Me aconsejaba un compañero, preocupado, que no debería atreverme a exponer aquí
...
en el tiempo invertido si finalmente son descartadas.`,J,Y,ne="Roles y responsabilidades",oe,de,Z=`Hace un año, David Heinemeier Hansson (DHH), creador de Ruby on Rails,
...
cómo abandonaron TypeScript en su proyecto Turbo tras pasar infiernos con él.`,Ue,ie,ge=`DHH señalaba, entre tantas quejas, a la enorme necesidad de usar any que tenían
...
ni sabían usarlo.`,Xe,ke,te=`Y no es que yo me considerara un experto en esta tecnología entonces, ni ahora,
...
se aprende en minutos.`,Ce,Le,Te=`Entender correctamente sus flujos de análisis y sus características
avanzadas no es algo trivial, y casi diría que es muy vocacional: aquellos que
disfrutan el tooling y la DX tienen una mayor inclinación natural hacia él.`,He,ue,we=`Al principio uno puede estar horas, y no exagero, dando vueltas a cómo conseguir
...
una persona centrada en la experiencia de desarrollo y profundizar en esto.`,nt,Ve,Ie=`JavaScript puede migrarse a TypeScript, y durante un proyecto puede trabajarse
...
mundos de cara al futuro del proyecto.`,st,Fe,Oe=`Con este enfoque y con el tiempo, el conocimiento de los expertos
...
el destruir tu productividad con spam de vídeos de gatitos y Milei dando cringe.`,Y,ne,oe=`Pero lo mejor de todo es que en este formato tienes el control de tu contenido,
...
sobre tu contenido es un privilegio.`,de,Z,Ue="Por qué no tengo una sección de comentarios",ie,ge,Xe=`Quitando que es un rollo integrar un sistema de comentarios dinámicos externo
...
sobre esto en una futura entrada).`,ke,te,Ce=`Entre las razones más evidentes para no incluirlos está evitarme
...
comentarios: la obtención de feedback constructivo, correcciones y sugerencias.`,Le,Te,He=`A ver, existe el correo electrónico, pero nadie lo usa
...
y ni lo sepas.`,ue,we,at=`La razón de peso más típica para incluir comentarios suele estar relacionada con
el SEO. Los comentarios cuentan como nuevo
contenido y pueden atraer visitas por sí mismos. Todo eso me da igual, no busco
visibilidad ni posicionamiento con este blog.`,q,Ze,nt="SvelteKit como generador de blogs estáticos",Ve,Ie,st,Fe,Oe=`No estoy usando ningún framework específico para blogs sino <strong>SvelteKit</strong> como
...
pilló más popularidad.`,ye,fe,pe=`Entre 2022 y 2023 comencé un proyecto un poco más ambicioso al que llamé
...
de templates.`,je,Ee,De=`Aunque utilizaba herramientas modernas, integrar con frameworks de SPA,
...
para no darle una oportunidad, y no me arrepiento.`,Ke,k,me=`SvelteKit es a Svelte lo que Next a React o Nuxt a Vue, aunque con soporte
oficial; digamos que SvelteKit/Svelte son parte del mismo proyecto
en manos de la misma comunidad y se desarrollan completamente a la vez.`,tt,K,ve=`Quizás seas como yo y no te guste este tipo de frameworks “todo en uno”
...
justo está este blog.`,G,Ae,Me=`En términos de seguridad, los sitios estáticos son más seguros por naturaleza.
...
complica, especialmente con capas gratuitas.`,_e,Pe,$e,Qe,lt="(y contras)",ut,et,dt="más",pt,Q,Ne,vt;return e=new ti({props:{$$slots:{default:[U_]},$$scope:{ctx:i}}}),s=new br({props:{$$slots:{default:[I_]},$$scope:{ctx:i}}}),Ie=new ti({props:{$$slots:{default:[N_]},$$scope:{ctx:i}}}),Q=new Wc({props:{$$slots:{default:[q_]},$$scope:{ctx:i}}}),{c(){Mt(e.$$.fragment),t=y(),n=x("p"),a=gt(`Esta es la primera entrada de un blog en el que controlo todo su proceso
generativo y contenido. Detalles
técnicos `),Mt(s.$$.fragment),c=y(),l=x("p"),l.textContent=u,d=y(),p=x("p"),p.textContent=g,f=y(),v=x("p"),v.textContent=E,C=y(),h=x("h2"),h.textContent=m,R=y(),w=x("p"),w.innerHTML=I,j=y(),U=x("p"),U.textContent=z,F=y(),T=x("p"),T.textContent=A,O=y(),$=x("p"),$.textContent=J,Y=y(),ne=x("p"),ne.textContent=oe,de=y(),Z=x("h2"),Z.textContent=Ue,ie=y(),ge=x("p"),ge.innerHTML=Xe,ke=y(),te=x("p"),te.textContent=Ce,Le=y(),Te=x("p"),Te.textContent=He,ue=y(),we=x("p"),we.textContent=at,q=y(),Ze=x("h2"),Ze.textContent=nt,Ve=y(),Mt(Ie.$$.fragment),st=y(),Fe=x("p"),Fe.innerHTML=Oe,N=y(),_=x("p"),_.textContent=H,ye=y(),fe=x("p"),fe.textContent=pe,je=y(),Ee=x("p"),Ee.textContent=De,Ke=y(),k=x("p"),k.textContent=me,tt=y(),K=x("p"),K.innerHTML=ve,We=y(),Je=x("p"),Je.textContent=ct,G=y(),Ae=x("p"),Ae.textContent=Me,_e=y(),Pe=x("p"),$e=gt("Hay otros beneficios "),Qe=x("small"),Qe.textContent=lt,ut=gt(`, pero no voy a
...
empezar `),Mt(Q.$$.fragment),Ne=gt(" mándame un correo."),this.h()},l(ce){St(e.$$.fragment,ce),t=M(ce),n=b(ce,"P",{});var qe=Gt(n);a=_t(qe,`Esta es la primera entrada de un blog en el que controlo todo su proceso
generativo y contenido. Detalles
técnicos `),St(s.$$.fragment,qe),qe.forEach(o),c=M(ce),l=b(ce,"P",{"data-svelte-h":!0}),S(l)!=="svelte-gel1sl"&&(l.textContent=u),d=M(ce),p=b(ce,"P",{"data-svelte-h":!0}),S(p)!=="svelte-14h9b1d"&&(p.textContent=g),f=M(ce),v=b(ce,"P",{"data-svelte-h":!0}),S(v)!=="svelte-w90q66"&&(v.textContent=E),C=M(ce),h=b(ce,"H2",{"data-svelte-h":!0}),S(h)!=="svelte-1dd0thw"&&(h.textContent=m),R=M(ce),w=b(ce,"P",{"data-svelte-h":!0}),S(w)!=="svelte-10c8ry6"&&(w.innerHTML=I),j=M(ce),U=b(ce,"P",{"data-svelte-h":!0}),S(U)!=="svelte-18rmamq"&&(U.textContent=z),F=M(ce),T=b(ce,"P",{"data-svelte-h":!0}),S(T)!=="svelte-1u3loif"&&(T.textContent=A),O=M(ce),$=b(ce,"P",{"data-svelte-h":!0}),S($)!=="svelte-gfynom"&&($.textContent=J),Y=M(ce),ne=b(ce,"P",{"data-svelte-h":!0}),S(ne)!=="svelte-1owvlqx"&&(ne.textContent=oe),de=M(ce),Z=b(ce,"H2",{"data-svelte-h":!0}),S(Z)!=="svelte-5qf7jp"&&(Z.textContent=Ue),ie=M(ce),ge=b(ce,"P",{"data-svelte-h":!0}),S(ge)!=="svelte-1xwjm58"&&(ge.innerHTML=Xe),ke=M(ce),te=b(ce,"P",{"data-svelte-h":!0}),S(te)!=="svelte-1obppyr"&&(te.textContent=Ce),Le=M(ce),Te=b(ce,"P",{"data-svelte-h":!0}),S(Te)!=="svelte-1e7wgil"&&(Te.textContent=He),ue=M(ce),we=b(ce,"P",{"data-svelte-h":!0}),S(we)!=="svelte-lv4okb"&&(we.textContent=at),q=M(ce),Ze=b(ce,"H2",{id:!0,"data-svelte-h":!0}),S(Ze)!=="svelte-809ml2"&&(Ze.textContent=nt),Ve=M(ce),St(Ie.$$.fragment,ce),st=M(ce),Fe=b(ce,"P",{"data-svelte-h":!0}),S(Fe)!=="svelte-1c01o13"&&(Fe.innerHTML=Oe),N=M(ce),_=b(ce,"P",{"data-svelte-h":!0}),S(_)!=="svelte-1u01tjt"&&(_.textContent=H),ye=M(ce),fe=b(ce,"P",{"data-svelte-h":!0}),S(fe)!=="svelte-r8zxp3"&&(fe.textContent=pe),je=M(ce),Ee=b(ce,"P",{"data-svelte-h":!0}),S(Ee)!=="svelte-avlmxs"&&(Ee.textContent=De),Ke=M(ce),k=b(ce,"P",{"data-svelte-h":!0}),S(k)!=="svelte-10ibczo"&&(k.textContent=me),tt=M(ce),K=b(ce,"P",{"data-svelte-h":!0}),S(K)!=="svelte-zmfge8"&&(K.innerHTML=ve),We=M(ce),Je=b(ce,"P",{"data-svelte-h":!0}),S(Je)!=="svelte-wmnnp"&&(Je.textContent=ct),G=M(ce),Ae=b(ce,"P",{"data-svelte-h":!0}),S(Ae)!=="svelte-oa6bid"&&(Ae.textContent=Me),_e=M(ce),Pe=b(ce,"P",{});var At=Gt(Pe);$e=_t(At,"Hay otros beneficios "),Qe=b(At,"SMALL",{"data-svelte-h":!0}),S(Qe)!=="svelte-12yc462"&&(Qe.textContent=lt),ut=_t(At,`, pero no voy a
dar `),et=b(At,"SMALL",{"data-svelte-h":!0}),S(et)!=="svelte-ohh2xh"&&(et.textContent=dt),pt=_t(At,` la chapa en esta entrada. Si tienes dudas
concretas sobre implementación o quieres hacerte tu propio sitio
estático con estas tecnologías y no sabes ni por dónde
empezar `),St(Q.$$.fragment,At),Ne=_t(At," mándame un correo."),At.forEach(o),this.h()},h(){yt(Ze,"id","detalles-tecnicos")},m(ce,qe){Ct(e,ce,qe),r(ce,t,qe),r(ce,n,qe),It(n,a),Ct(s,n,null),r(ce,c,qe),r(ce,l,qe),r(ce,d,qe),r(ce,p,qe),r(ce,f,qe),r(ce,v,qe),r(ce,C,qe),r(ce,h,qe),r(ce,R,qe),r(ce,w,qe),r(ce,j,qe),r(ce,U,qe),r(ce,F,qe),r(ce,T,qe),r(ce,O,qe),r(ce,$,qe),r(ce,Y,qe),r(ce,ne,qe),r(ce,de,qe),r(ce,Z,qe),r(ce,ie,qe),r(ce,ge,qe),r(ce,ke,qe),r(ce,te,qe),r(ce,Le,qe),r(ce,Te,qe),r(ce,ue,qe),r(ce,we,qe),r(ce,q,qe),r(ce,Ze,qe),r(ce,Ve,qe),Ct(Ie,ce,qe),r(ce,st,qe),r(ce,Fe,qe),r(ce,N,qe),r(ce,_,qe),r(ce,ye,qe),r(ce,fe,qe),r(ce,je,qe),r(ce,Ee,qe),r(ce,Ke,qe),r(ce,k,qe),r(ce,tt,qe),r(ce,K,qe),r(ce,We,qe),r(ce,Je,qe),r(ce,G,qe),r(ce,Ae,qe),r(ce,_e,qe),r(ce,Pe,qe),It(Pe,$e),It(Pe,Qe),It(Pe,ut),It(Pe,et),It(Pe,pt),Ct(Q,Pe,null),It(Pe,Ne),vt=!0},p(ce,[qe]){const At={};qe&1&&(At.$$scope={dirty:qe,ctx:ce}),e.$set(At);const se={};qe&1&&(se.$$scope={dirty:qe,ctx:ce}),s.$set(se);const B={};qe&1&&(B.$$scope={dirty:qe,ctx:ce}),Ie.$set(B);const Ye={};qe&1&&(Ye.$$scope={dirty:qe,ctx:ce}),Q.$set(Ye)},i(ce){vt||(ht(e.$$.fragment,ce),ht(s.$$.fragment,ce),ht(Ie.$$.fragment,ce),ht(Q.$$.fragment,ce),vt=!0)},o(ce){mt(e.$$.fragment,ce),mt(s.$$.fragment,ce),mt(Ie.$$.fragment,ce),mt(Q.$$.fragment,ce),vt=!1},d(ce){ce&&(o(t),o(n),o(c),o(l),o(d),o(p),o(f),o(v),o(C),o(h),o(R),o(w),o(j),o(U),o(F),o(T),o(O),o($),o(Y),o(ne),o(de),o(Z),o(ie),o(ge),o(ke),o(te),o(Le),o(Te),o(ue),o(we),o(q),o(Ze),o(Ve),o(st),o(Fe),o(N),o(_),o(ye),o(fe),o(je),o(Ee),o(Ke),o(k),o(tt),o(K),o(We),o(Je),o(G),o(Ae),o(_e),o(Pe)),Et(e,ce),Et(s),Et(Ie,ce),Et(Q)}}}const O_={title:"Por qué un blog en 2024",slug:"por-que-un-blog-en-2024",coverImage:"/src/assets/posts-covers/maquina-escribir.jpg",coverPosition:"normal",coverAuthor:"Patrick Fore",excerpt:"Esta es la primera entrada de un un blog en el que controlo todo su proceso generativo y contenido.",date:"2024-06-24T15:06:23.177Z",updated:"2024-06-24T15:06:23.903Z",hidden:!1,tags:["Personal"],keywords:["estático","blog"],type:"default"};class z_ extends Yt{constructor(e){super(),Zt(this,e,null,F_,Xt,{})}}const B_=Object.freeze(Object.defineProperty({__proto__:null,default:z_,metadata:O_},Symbol.toStringTag,{value:"Module"}));function H_(i){let e,t=`Actualmente un conocido se está enfrentando a consecuencias de actos que le
perseguirán y atormentarán hasta sus últimos días. No son pocas las personas que
están o estarán en situaciones similares, y entre las que me incluyo.`,n,a,s="Hay errores que cruzan líneas invisibles, sociales, morales, emocionales, …",c,l,u=`El daño de cruzar esas líneas no siempre se repara con tiempo o justicia. Lo que
...
sino del estigma.`,d,p,g=`Es terriblemente cruel el modo en que la sociedad, incluso en nombre de la moral
o la prudencia, ejerce esa vigilancia eterna; el modo en el que el pasado se
convierte en presente renovado.`,f,v,E=`Y luego está la consecuencia más silenciosa pero más corrosiva: la
...
con los módulos ES tenemos)</em>. De hecho Lodash tiene una versión tree-shakeable en ESM.`,J,Y,ne="En qué consiste el tree shaking y los tree-shakeables",oe,de,Z=`Cuando generas el bundle de tu web, aplicación, librería o lo que sea que estés
bundleando, los bundlers modernos tiran de herramientas como rollup para
minificar el resultado y de paso realizar “dead code elimination”.`,Ue,ie,ge=`La “dead code elimination” es autoexplicativa. Elimina el código que nunca es
...
bibliotecas modulares orientadas a esto.`,Xe,ke,te=`En el mundo de JavaScript y aplicado especialmente a dependencias externas,
...
mandarle al usuario todo el tocho.`,Ce,Le,Te="Diseño, DX y Tree Shaking",He,ue,we=`No todos los módulos ES son automáticamente tree-shakeables, deben separar muy
...
(en la versión 0.1.11 al menos), una string, te daría dos opciones:`,nt,Ve,Ie,st,Fe=`Esto ya me permite un mecanismo que me evite crear dos funciones por
...
de responsabilidad única (SRP)?“.`,Oe,N,_=`Internamente no se está rompiendo el SRP, existen las dos funciones (en realidad
...
configurables con muy pocas opciones obligatorias.`,H,ye,fe=`El segundo parámetro de la función son sus opciones. Tanto
...
por ser SVGs:`,pe,je,Ee,De,Ke=`Vemos que la única opción obligatoria es target, por eso aparece la primera, las
otras están en orden alfabético. Si en lugar de ‘rect’ hubiéramos escrito ‘arrow’,
las opciones serían:`,k,me,tt,K,ve=`Nótese que han desaparecido las opciones de rect y han aparecido otras exclusivas
...
simple de momento:`,G,Ae,Me,_e,Pe="Espera… ¿y el tree shaking cómo se lleva con esto?",$e,Qe,lt=`Y ahí es a donde quería llegar. Creí que no tendría más remedio que pasar por
...
ejecutan el código, y al fin y al cabo TypeScript “no existe”.`,pt,Q,Ne=`Pues resulta que he creado un proyecto de JavaScript vanilla con Vite,
...
Repito el proceso con solo arrows y veo que ni rastro de rect.`,vt,ce,qe=`Así que funciona asombrosamente bien, parece que esto es más avanzado de lo que
creía. No tengo ni idea de qué estrategia seguirá, pero de momento el poder
continuar con mi diseño sin consecuencias técnicas es una muy buena noticia.`,At;return C=new Wc({props:{$$slots:{default:[X_]},$$scope:{ctx:i}}}),Ve=new Ma({props:{src:j_,alt:"Sugerencia de VSCode al empezar a escribir la función create(). Se aprecia que sugiere tanto arrow como rect."}}),je=new Ma({props:{src:W_,alt:"Sugerencia de VSCode al escribir las opciones de la función create para el tipo rect",figCaption:"Opciones comunes para todos los punteros y para aquellos de tipo SVG, además de las opciones exclusivas de 'rect'. <small>NOTA: los simbolitos son de accesibilidad para personas con algún tipo de deficiencia de visión de color.</small>"}}),me=new Ma({props:{src:$_,alt:"Sugerencia de VSCode al escribir las opciones de la función create para el tipo rect",figCaption:"Opciones comunes además de las opciones exclusivas de 'arrow'."}}),Ae=new Fn({props:{language:"TypeScript",$$slots:{default:[Y_]},$$scope:{ctx:i}}}),{c(){e=x("p"),e.innerHTML=t,n=y(),a=x("p"),a.innerHTML=s,c=y(),l=x("p"),l.textContent=u,d=y(),p=x("h2"),p.textContent=g,f=y(),v=x("p"),E=gt("Estaba acordándome de la vieja Lodash. "),Mt(C.$$.fragment),h=gt(` Es una
famosa biblioteca que brinda utilidades para aplicar programación
funcional a muchas partes de JavaScript.`),m=y(),R=x("p"),R.textContent=w,I=y(),j=x("p"),j.textContent=U,z=y(),F=x("p"),F.textContent=T,A=y(),O=x("p"),O.innerHTML=$,J=y(),Y=x("h3"),Y.textContent=ne,oe=y(),de=x("p"),de.textContent=Z,Ue=y(),ie=x("p"),ie.textContent=ge,Xe=y(),ke=x("p"),ke.textContent=te,Ce=y(),Le=x("h2"),Le.textContent=Te,He=y(),ue=x("p"),ue.textContent=we,at=y(),q=x("p"),q.textContent=Ze,nt=y(),Mt(Ve.$$.fragment),Ie=y(),st=x("p"),st.textContent=Fe,Oe=y(),N=x("p"),N.textContent=_,H=y(),ye=x("p"),ye.textContent=fe,pe=y(),Mt(je.$$.fragment),Ee=y(),De=x("p"),De.textContent=Ke,k=y(),Mt(me.$$.fragment),tt=y(),K=x("p"),K.textContent=ve,We=y(),Je=x("p"),Je.textContent=ct,G=y(),Mt(Ae.$$.fragment),Me=y(),_e=x("h3"),_e.textContent=Pe,$e=y(),Qe=x("p"),Qe.textContent=lt,ut=y(),et=x("p"),et.textContent=dt,pt=y(),Q=x("p"),Q.textContent=Ne,vt=y(),ce=x("p"),ce.textContent=qe},l(se){e=b(se,"P",{"data-svelte-h":!0}),S(e)!=="svelte-1fujiav"&&(e.innerHTML=t),n=M(se),a=b(se,"P",{"data-svelte-h":!0}),S(a)!=="svelte-pu5b15"&&(a.innerHTML=s),c=M(se),l=b(se,"P",{"data-svelte-h":!0}),S(l)!=="svelte-1twu8y9"&&(l.textContent=u),d=M(se),p=b(se,"H2",{"data-svelte-h":!0}),S(p)!=="svelte-g7u8rd"&&(p.textContent=g),f=M(se),v=b(se,"P",{});var B=Gt(v);E=_t(B,"Estaba acordándome de la vieja Lodash. "),St(C.$$.fragment,B),h=_t(B,` Es una
famosa biblioteca que brinda utilidades para aplicar programación
funcional a muchas partes de JavaScript.`),B.forEach(o),m=M(se),R=b(se,"P",{"data-svelte-h":!0}),S(R)!=="svelte-1kopbf0"&&(R.textContent=w),I=M(se),j=b(se,"P",{"data-svelte-h":!0}),S(j)!=="svelte-1fyk4rs"&&(j.textContent=U),z=M(se),F=b(se,"P",{"data-svelte-h":!0}),S(F)!=="svelte-6x6eyz"&&(F.textContent=T),A=M(se),O=b(se,"P",{"data-svelte-h":!0}),S(O)!=="svelte-9ajmea"&&(O.innerHTML=$),J=M(se),Y=b(se,"H3",{"data-svelte-h":!0}),S(Y)!=="svelte-wkrciz"&&(Y.textContent=ne),oe=M(se),de=b(se,"P",{"data-svelte-h":!0}),S(de)!=="svelte-1av9y9e"&&(de.textContent=Z),Ue=M(se),ie=b(se,"P",{"data-svelte-h":!0}),S(ie)!=="svelte-135wybo"&&(ie.textContent=ge),Xe=M(se),ke=b(se,"P",{"data-svelte-h":!0}),S(ke)!=="svelte-hd5dc4"&&(ke.textContent=te),Ce=M(se),Le=b(se,"H2",{"data-svelte-h":!0}),S(Le)!=="svelte-168zpit"&&(Le.textContent=Te),He=M(se),ue=b(se,"P",{"data-svelte-h":!0}),S(ue)!=="svelte-1phfsg3"&&(ue.textContent=we),at=M(se),q=b(se,"P",{"data-svelte-h":!0}),S(q)!=="svelte-fiagbg"&&(q.textContent=Ze),nt=M(se),St(Ve.$$.fragment,se),Ie=M(se),st=b(se,"P",{"data-svelte-h":!0}),S(st)!=="svelte-rqe7j"&&(st.textContent=Fe),Oe=M(se),N=b(se,"P",{"data-svelte-h":!0}),S(N)!=="svelte-1pv97ce"&&(N.textContent=_),H=M(se),ye=b(se,"P",{"data-svelte-h":!0}),S(ye)!=="svelte-kmg0ao"&&(ye.textContent=fe),pe=M(se),St(je.$$.fragment,se),Ee=M(se),De=b(se,"P",{"data-svelte-h":!0}),S(De)!=="svelte-8ubglo"&&(De.textContent=Ke),k=M(se),St(me.$$.fragment,se),tt=M(se),K=b(se,"P",{"data-svelte-h":!0}),S(K)!=="svelte-yj2hnq"&&(K.textContent=ve),We=M(se),Je=b(se,"P",{"data-svelte-h":!0}),S(Je)!=="svelte-1ebwcib"&&(Je.textContent=ct),G=M(se),St(Ae.$$.fragment,se),Me=M(se),_e=b(se,"H3",{"data-svelte-h":!0}),S(_e)!=="svelte-sek9rw"&&(_e.textContent=Pe),$e=M(se),Qe=b(se,"P",{"data-svelte-h":!0}),S(Qe)!=="svelte-1lpsewo"&&(Qe.textContent=lt),ut=M(se),et=b(se,"P",{"data-svelte-h":!0}),S(et)!=="svelte-1sw6anc"&&(et.textContent=dt),pt=M(se),Q=b(se,"P",{"data-svelte-h":!0}),S(Q)!=="svelte-1dizd6g"&&(Q.textContent=Ne),vt=M(se),ce=b(se,"P",{"data-svelte-h":!0}),S(ce)!=="svelte-1d7x851"&&(ce.textContent=qe)},m(se,B){r(se,e,B),r(se,n,B),r(se,a,B),r(se,c,B),r(se,l,B),r(se,d,B),r(se,p,B),r(se,f,B),r(se,v,B),It(v,E),Ct(C,v,null),It(v,h),r(se,m,B),r(se,R,B),r(se,I,B),r(se,j,B),r(se,z,B),r(se,F,B),r(se,A,B),r(se,O,B),r(se,J,B),r(se,Y,B),r(se,oe,B),r(se,de,B),r(se,Ue,B),r(se,ie,B),r(se,Xe,B),r(se,ke,B),r(se,Ce,B),r(se,Le,B),r(se,He,B),r(se,ue,B),r(se,at,B),r(se,q,B),r(se,nt,B),Ct(Ve,se,B),r(se,Ie,B),r(se,st,B),r(se,Oe,B),r(se,N,B),r(se,H,B),r(se,ye,B),r(se,pe,B),Ct(je,se,B),r(se,Ee,B),r(se,De,B),r(se,k,B),Ct(me,se,B),r(se,tt,B),r(se,K,B),r(se,We,B),r(se,Je,B),r(se,G,B),Ct(Ae,se,B),r(se,Me,B),r(se,_e,B),r(se,$e,B),r(se,Qe,B),r(se,ut,B),r(se,et,B),r(se,pt,B),r(se,Q,B),r(se,vt,B),r(se,ce,B),At=!0},p(se,[B]){const Ye={};B&1&&(Ye.$$scope={dirty:B,ctx:se}),C.$set(Ye);const Nt={};B&1&&(Nt.$$scope={dirty:B,ctx:se}),Ae.$set(Nt)},i(se){At||(ht(C.$$.fragment,se),ht(Ve.$$.fragment,se),ht(je.$$.fragment,se),ht(me.$$.fragment,se),ht(Ae.$$.fragment,se),At=!0)},o(se){mt(C.$$.fragment,se),mt(Ve.$$.fragment,se),mt(je.$$.fragment,se),mt(me.$$.fragment,se),mt(Ae.$$.fragment,se),At=!1},d(se){se&&(o(e),o(n),o(a),o(c),o(l),o(d),o(p),o(f),o(v),o(m),o(R),o(I),o(j),o(z),o(F),o(A),o(O),o(J),o(Y),o(oe),o(de),o(Ue),o(ie),o(Xe),o(ke),o(Ce),o(Le),o(He),o(ue),o(at),o(q),o(nt),o(Ie),o(st),o(Oe),o(N),o(H),o(ye),o(pe),o(Ee),o(De),o(k),o(tt),o(K),o(We),o(Je),o(G),o(Me),o(_e),o($e),o(Qe),o(ut),o(et),o(pt),o(Q),o(vt),o(ce)),Et(C),Et(Ve,se),Et(je,se),Et(me,se),Et(Ae,se)}}}const K_={title:"Tamaños que no importan: tree-shakeables",slug:"tamano-no-importa-tree-shakeables",coverImage:"/src/assets/posts-covers/tree-shaking.jpg",coverAuthor:"Edoardo Botez",excerpt:"Arrojo un poco de luz a esto del tree-shaking en módulos ECMAScript.",date:"2024-08-11T15:06:23.177Z",updated:"2024-08-11T15:06:23.903Z",hidden:!1,tags:["DX","Front end"],keywords:["tree-shake","side-effects","biblioteca"],type:"default"};class J_ extends Yt{constructor(e){super(),Zt(this,e,null,Z_,Xt,{})}}const Q_=Object.freeze(Object.defineProperty({__proto__:null,default:J_,metadata:K_},Symbol.toStringTag,{value:"Module"}));function ex(i){let e,t="Proyectos y sitios que no podré continuar, mantener, guardar o lo que sea. Algunos públicos, otros sin repositorio y otros en repos privados en GitHub o GitLab. Muchos son tonterías y otros los conservaba más por razones históricas.",n,a,s="Si te interesa algo de esto para lo que sea, avísame:",c,l,u=`<li>El código fuente de este sitio web (el repo con SvelteKit), incluyendo de este blog y toda la configuración de CI/CD en Github Actions. Si lo vas usar, evidentemente cambia el nombre y contenido.</li> <li>El código fuente y todo el repo de lo que haya en <a href="https://alexvgjm.github.io" rel="nofollow">alexvgjm.github.io</a></li> <li>El sitio <a href="https://d2runewords.com" rel="nofollow">d2runewords.com</a> (si quieres también el dominio eso ya corre de tu cuenta).</li> <li>Un intento de motor de videojuegos 2D con PixiJS como motor de renderizado.</li> <li>Un recién iniciado sistema de partículas custom en WebGL para Three.js</li> <li><a href="https://alexvgjm.github.io/point-it-out-docs" rel="nofollow">Point it out</a>. NOTA: recibió recientemente un refactoring muy duro en local y se aleja más de lo actualmente publicado. Tiene más características y una arquitectura distinta a la publicada. Ya se acerca más a una alpha.</li> <li>Prototipos de aplicaciones orientadas a terapia visual / fototerapia (vanilla js y ts).</li> <li>Distintos prototipos de aplicaciones interactivas en Vue, incluyendo una especie de juego roguelike y un idle.</li> <li>Viejos plugins de IRC de por lo menos 2007 ya obsoletos e innecesarios, que tenían de propósito evadir el escudo dorado chino de manera simple.</li> <li>Viejo código en C y en otro extraño lenguaje híbrido muy similar a Objective-C. Principalmente homebrew para PSP y otro material de pruebas. También incluye
...
necesidades de una empresa (incluyendo al estado).`,Y,ne,oe=`Suena muy bonito, pero aunque hay consultoras excelentes con personal muy
...
decenas, centenas o incluso millares (“por kilos”), como si de carne se tratara.`,de,Z,Ue=`Por lo general hacen muchos convenios con academias y les importa poco el nivel
y el desarrollo que puedan obtener sus profesionales, pues en realidad el que
sean o no productivos a veces ni importa.`,ie,ge,Xe=`Entre los objetivos de esta contratación masiva se encuentra el de manifestar 
...
resultados 🙂).</small>`,ke,te,Ce=`Hay otras razones, como hacer un filtrado masivo como quien filtra kilos
...
entradas.`,Le,Te,He=`Esto es una realidad bastante obvia cuando te acercas a puestos de dirección o
si como autónomo has estado pendiente al BOE y licitaciones, pero es como si a
nadie le gustara hablar de ello 🤷‍♂️.`,ue,we,at="La consultoría profesional",q,Ze,nt=`No sé cómo llamarla. Algunos la llaman consultoría clásica sin más, y otros
defienden que debería llamarse “formación especializada” y ya.`,Ve,Ie,st=`Es a lo que me dedico. No se aleja de la definición de la primera, con la
diferencia de que por lo general te integras al entorno del cliente y tu
actividad tiene lugar en él o al menos compromete a su plantilla.`,Fe,Oe,N=`En esta actividad se ofrecen los mismos servicios de consultoría pero es más
...
experiencias previas ante problemas similares.`,_,H,ye=`Es un trabajo excelente porque conoces a mucha gente, te obligas a cargarte
...
se fue en búsqueda de desafíos mayores, dejando su legado.`,Ee,De,Ke=`Es la forma más directa de asumir desafíos continuos y de crecer hasta cierto
...
gurú extranjero de turno que en sus propios empleados.`,k,me,tt=`Es por esto que mi actividad suele centrarse en directivos sin formación técnica.
Pero no es fácil
...
pensar ni por un segundo que el problema de un proyecto pueden ser ellos mismos.`,K,ve,We="Tratamiento para directivos",Je,ct,G,Ae,Me=`Un directivo (o jefe de proyecto) de software sin nociones técnicas no comprende que el error
...
aún así seguirá siendo necesario la monitorización y seguirá habiendo errores.`,_e,Pe,$e=`Un directivo que no comprende los procesos de desarrollo solo ve que el producto
...
haber en los procesos de desarrollo.`,Q,Ne,vt=`Un directivo así solo mete presiones y no tiene capacidad para determinar el
estado ni el rumbo del proyecto, no le salva ni el delegar porque nunca
podrá comprender el feedback que pueda recibir de la persona en la que delega.`,ce,qe,At=`Lo mejor que puede pasar con un directivo así es que delegue completamente y con
...
que además suele cobrar más.`,se,B,Ye=`Pero cuando no delegan es mucho peor, ya no solo son dispensables, entorpecen a
...
humanos que en su caso han estado en posiciones de poder, a veces demasiado tiempo.`,le,re,ae=`Es muy frecuente que en su trayectoria profesional coman discusiones muy absurdas con
...
esto acaba por generar conductas a veces algo poco empáticas.`,ze,Be,V=`El trabajo de un
...
por tu servicio para mejorar la situación laboral.`,he;return ct=new ti({props:{$$slots:{default:[ax]},$$scope:{ctx:i}}}),{c(){e=x("p"),e.innerHTML=t,n=y(),a=x("p"),a.textContent=s,c=y(),l=x("p"),l.textContent=u,d=y(),p=x("p"),p.textContent=g,f=y(),v=x("p"),v.textContent=E,C=y(),h=x("h2"),h.textContent=m,R=y(),w=x("p"),w.textContent=I,j=y(),U=x("p"),U.textContent=z,F=y(),T=x("h3"),T.textContent=A,O=y(),$=x("p"),$.textContent=J,Y=y(),ne=x("p"),ne.textContent=oe,de=y(),Z=x("p"),Z.textContent=Ue,ie=y(),ge=x("p"),ge.innerHTML=Xe,ke=y(),te=x("p"),te.textContent=Ce,Le=y(),Te=x("p"),Te.textContent=He,ue=y(),we=x("h3"),we.textContent=at,q=y(),Ze=x("p"),Ze.textContent=nt,Ve=y(),Ie=x("p"),Ie.textContent=st,Fe=y(),Oe=x("p"),Oe.textContent=N,_=y(),H=x("p"),H.textContent=ye,fe=y(),pe=x("p"),pe.textContent=je,Ee=y(),De=x("p"),De.textContent=Ke,k=y(),me=x("p"),me.textContent=tt,K=y(),ve=x("h2"),ve.textContent=We,Je=y(),Mt(ct.$$.fragment),G=y(),Ae=x("p"),Ae.textContent=Me,_e=y(),Pe=x("p"),Pe.textContent=$e,Qe=y(),lt=x("p"),lt.textContent=ut,et=y(),dt=x("p"),dt.textContent=pt,Q=y(),Ne=x("p"),Ne.textContent=vt,ce=y(),qe=x("p"),qe.textContent=At,se=y(),B=x("p"),B.textContent=Ye,Nt=y(),qt=x("p"),qt.textContent=cn,Vt=y(),P=x("p"),P.textContent=ee,le=y(),re=x("p"),re.textContent=ae,ze=y(),Be=x("p"),Be.textContent=V},l(W){e=b(W,"P",{"data-svelte-h":!0}),S(e)!=="svelte-1iiakgo"&&(e.innerHTML=t),n=M(W),a=b(W,"P",{"data-svelte-h":!0}),S(a)!=="svelte-12tujuj"&&(a.textContent=s),c=M(W),l=b(W,"P",{"data-svelte-h":!0}),S(l)!=="svelte-10ktz68"&&(l.textContent=u),d=M(W),p=b(W,"P",{"data-svelte-h":!0}),S(p)!=="svelte-15vlnlv"&&(p.textContent=g),f=M(W),v=b(W,"P",{"data-svelte-h":!0}),S(v)!=="svelte-mqtgny"&&(v.textContent=E),C=M(W),h=b(W,"H2",{"data-svelte-h":!0}),S(h)!=="svelte-1j7xnh3"&&(h.textContent=m),R=M(W),w=b(W,"P",{"data-svelte-h":!0}),S(w)!=="svelte-1hn486m"&&(w.textContent=I),j=M(W),U=b(W,"P",{"data-svelte-h":!0}),S(U)!=="svelte-1u70d73"&&(U.textContent=z),F=M(W),T=b(W,"H3",{"data-svelte-h":!0}),S(T)!=="svelte-14ihzmv"&&(T.textContent=A),O=M(W),$=b(W,"P",{"data-svelte-h":!0}),S($)!=="svelte-1kugems"&&($.textContent=J),Y=M(W),ne=b(W,"P",{"data-svelte-h":!0}),S(ne)!=="svelte-1cy21h5"&&(ne.textContent=oe),de=M(W),Z=b(W,"P",{"data-svelte-h":!0}),S(Z)!=="svelte-1cme0t5"&&(Z.textContent=Ue),ie=M(W),ge=b(W,"P",{"data-svelte-h":!0}),S(ge)!=="svelte-g1skft"&&(ge.innerHTML=Xe),ke=M(W),te=b(W,"P",{"data-svelte-h":!0}),S(te)!=="svelte-b22wq9"&&(te.textContent=Ce),Le=M(W),Te=b(W,"P",{"data-svelte-h":!0}),S(Te)!=="svelte-1wtdicu"&&(Te.textContent=He),ue=M(W),we=b(W,"H3",{"data-svelte-h":!0}),S(we)!=="svelte-175l5aq"&&(we.textContent=at),q=M(W),Ze=b(W,"P",{"data-svelte-h":!0}),S(Ze)!=="svelte-1rac4fd"&&(Ze.textContent=nt),Ve=M(W),Ie=b(W,"P",{"data-svelte-h":!0}),S(Ie)!=="svelte-134t9a7"&&(Ie.textContent=st),Fe=M(W),Oe=b(W,"P",{"data-svelte-h":!0}),S(Oe)!=="svelte-9jnm7l"&&(Oe.textContent=N),_=M(W),H=b(W,"P",{"data-svelte-h":!0}),S(H)!=="svelte-1a30uqh"&&(H.textContent=ye),fe=M(W),pe=b(W,"P",{"data-svelte-h":!0}),S(pe)!=="svelte-z6pw4r"&&(pe.textContent=je),Ee=M(W),De=b(W,"P",{"data-svelte-h":!0}),S(De)!=="svelte-11vlw5e"&&(De.textContent=Ke),k=M(W),me=b(W,"P",{"data-svelte-h":!0}),S(me)!=="svelte-t0fih4"&&(me.textContent=tt),K=M(W),ve=b(W,"H2",{"data-svelte-h":!0}),S(ve)!=="svelte-pcnb56"&&(ve.textContent=We),Je=M(W),St(ct.$$.fragment,W),G=M(W),Ae=b(W,"P",{"data-svelte-h":!0}),S(Ae)!=="svelte-18d246z"&&(Ae.textContent=Me),_e=M(W),Pe=b(W,"P",{"data-svelte-h":!0}),S(Pe)!=="svelte-99tjnl"&&(Pe.textContent=$e),Qe=M(W),lt=b(W,"P",{"data-svelte-h":!0}),S(lt)!=="svelte-l9x7lv"&&(lt.textContent=ut),et=M(W),dt=b(W,"P",{"data-svelte-h":!0}),S(dt)!=="svelte-ahiizd"&&(dt.textContent=pt),Q=M(W),Ne=b(W,"P",{"data-svelte-h":!0}),S(Ne)!=="svelte-8qowcd"&&(Ne.textContent=vt),ce=M(W),qe=b(W,"P",{"data-svelte-h":!0}),S(qe)!=="svelte-oa0pwp"&&(qe.textContent=At),se=M(W),B=b(W,"P",{"data-svelte-h":!0}),S(B)!=="svelte-11i1gv6"&&(B.textContent=Ye),Nt=M(W),qt=b(W,"P",{"data-svelte-h":!0}),S(qt)!=="svelte-yml7fg"&&(qt.textContent=cn),Vt=M(W),P=b(W,"P",{"data-svelte-h":!0}),S(P)!=="svelte-1kgj6vx"&&(P.textContent=ee),le=M(W),re=b(W,"P",{"data-svelte-h":!0}),S(re)!=="svelte-1khq7r0"&&(re.textContent=ae),ze=M(W),Be=b(W,"P",{"data-svelte-h":!0}),S(Be)!=="svelte-tlkjpl"&&(Be.textContent=V)},m(W,Re){r(W,e,Re),r(W,n,Re),r(W,a,Re),r(W,c,Re),r(W,l,Re),r(W,d,Re),r(W,p,Re),r(W,f,Re),r(W,v,Re),r(W,C,Re),r(W,h,Re),r(W,R,Re),r(W,w,Re),r(W,j,Re),r(W,U,Re),r(W,F,Re),r(W,T,Re),r(W,O,Re),r(W,$,Re),r(W,Y,Re),r(W,ne,Re),r(W,de,Re),r(W,Z,Re),r(W,ie,Re),r(W,ge,Re),r(W,ke,Re),r(W,te,Re),r(W,Le,Re),r(W,Te,Re),r(W,ue,Re),r(W,we,Re),r(W,q,Re),r(W,Ze,Re),r(W,Ve,Re),r(W,Ie,Re),r(W,Fe,Re),r(W,Oe,Re),r(W,_,Re),r(W,H,Re),r(W,fe,Re),r(W,pe,Re),r(W,Ee,Re),r(W,De,Re),r(W,k,Re),r(W,me,Re),r(W,K,Re),r(W,ve,Re),r(W,Je,Re),Ct(ct,W,Re),r(W,G,Re),r(W,Ae,Re),r(W,_e,Re),r(W,Pe,Re),r(W,Qe,Re),r(W,lt,Re),r(W,et,Re),r(W,dt,Re),r(W,Q,Re),r(W,Ne,Re),r(W,ce,Re),r(W,qe,Re),r(W,se,Re),r(W,B,Re),r(W,Nt,Re),r(W,qt,Re),r(W,Vt,Re),r(W,P,Re),r(W,le,Re),r(W,re,Re),r(W,ze,Re),r(W,Be,Re),he=!0},p(W,[Re]){const it={};Re&1&&(it.$$scope={dirty:Re,ctx:W}),ct.$set(it)},i(W){he||(ht(ct.$$.fragment,W),he=!0)},o(W){mt(ct.$$.fragment,W),he=!1},d(W){W&&(o(e),o(n),o(a),o(c),o(l),o(d),o(p),o(f),o(v),o(C),o(h),o(R),o(w),o(j),o(U),o(F),o(T),o(O),o($),o(Y),o(ne),o(de),o(Z),o(ie),o(ge),o(ke),o(te),o(Le),o(Te),o(ue),o(we),o(q),o(Ze),o(Ve),o(Ie),o(Fe),o(Oe),o(_),o(H),o(fe),o(pe),o(Ee),o(De),o(k),o(me),o(K),o(ve),o(Je),o(G),o(Ae),o(_e),o(Pe),o(Qe),o(lt),o(et),o(dt),o(Q),o(Ne),o(ce),o(qe),o(se),o(B),o(Nt),o(qt),o(Vt),o(P),o(le),o(re),o(ze),o(Be)),Et(ct,W)}}}const ox={title:"Autonomía y ajenidad (parte 2)",slug:"autonomia-ajenidad-2",coverImage:"/src/assets/posts-covers/starfish.jpg",coverPosition:"normal",coverAuthor:"Pedro Lastra",excerpt:"Segunda parte. Analizo la consultoría y el mentoring.",date:"2024-09-05T13:06:23.177Z",updated:"2024-09-05T13:06:23.903Z",hidden:!0,tags:["Personal","Laboral","Consultoría"],keywords:["trabajo","autónomo"],type:"default"};class rx extends Yt{constructor(e){super(),Zt(this,e,null,sx,Xt,{})}}const lx=Object.freeze(Object.defineProperty({__proto__:null,default:rx,metadata:ox},Symbol.toStringTag,{value:"Module"}));function cx(i){let e;return{c(){e=gt(`NOTA: no he notado diferencias de género en este ámbito, más allá de
una mayor cantidad hombres. Asume que cuando digo directivo digo también 
directiva/e.`)},l(t){e=_t(t,`NOTA: no he notado diferencias de género en este ámbito, más allá de
una mayor cantidad hombres. Asume que cuando digo directivo digo también 
...
y el desarrollo que puedan obtener sus profesionales, pues en realidad el que
sean o no productivos a veces ni importa.`,Y,ne,oe=`Entre los objetivos de esta contratación masiva se encuentra el de manifestar 
poder de contratación. En procesos de 
adjudicación de proyectos con oferta pública (licitaciones), cuando surgen del
estado o empresas asociadas a él, tiene mucho valor la capacidad para 
generar empleo, así sea de manera artificial y aunque esto luego implique
...
vivimos en una socialdemocracia donde es impensable la posibilidad de manipular
resultados 🙂).</small>`,de,Z,Ue=`Hay otras razones, como hacer un filtrado masivo como quien filtra kilos
de tierra de río para sacar cantidades insignificantes de oro, una estrategia
de búsqueda de talento habitual en grandes tecnológicas, pero eso da para otras
entradas.`,ie,ge,Xe=`Esto es una realidad bastante obvia cuando te acercas a puestos de dirección o
si como autónomo has estado pendiente al BOE y licitaciones, pero es como si a
nadie le gustara hablar de ello 🤷‍♂️.`,ke,te,Ce="Consultoría para profesionales en IT",Le,Te,He=`No sé cómo llamarla. Algunos la llaman consultoría sin más, y otros
defienden que debería llamarse “formación especializada” y ya.`,ue,we,at=`Es a lo que me dedico. No se aleja de la definición de la primera, con la
...
integras a un grupo profesional, acabas ejerciendo de mentor y comunicándote
directamente con todos transmitiendo como mejor puedas tus conocimientos y
experiencias previas ante problemas similares.`,Ve,Ie,st=`Es un trabajo excelente porque conoces a mucha gente, te obligas a cargarte
prejuicios, a volverte más tolerante y a buscar el mejor lado de toda persona.
A nivel técnico perfilas tus habilidades de análisis al extremo, dado que cada
nuevo entorno implica auditar y analizar soluciones custom que llevan
desarrollando años otras personas, a fin de identificar los puntos críticos y
qué está produciendo los problemas por los que te requieren.`,Fe,Oe,N=`Por otra parte, no pocas veces eres tú quien más aprende. Conocer tantos nuevos
entornos y soluciones desarrolladas por otros hace que empieces a ver patrones
continuos y a identificar aquello que está fuera de la norma para bien, a
toparte con soluciones brillantes y excepcionales, normalmente provenientes de
alguna persona muy ingeniosa que ya no forma parte del equipo, alguien que
se fue en búsqueda de desafíos mayores y que ha dejado su legado.`,_,H,ye=`Es la forma más directa de asumir desafíos continuos y de crecer hasta cierto
punto. Eso sí, con una responsabilidad que puede ser muy estresante. No es
especialmente cómodo llegar a un equipo como un supuesto experto y saber que
todos esperan que muestres soluciones a problemas que llevan teniendo durante
...
profesionales que no tienen un nivel inferior a ti y que ciertamente no te
necesitan, sino que tienen a directivos incompetentes que confían antes en el
gurú extranjero de turno que en sus propios empleados.`,Ee,De,Ke=`Es por esto que mi actividad suele centrarse en directivos sin formación técnica.
Pero no es fácil
hacer comprender la naturaleza de este trabajo a personas que no han picado una
sola línea de código y lleva a cargo de programadores más de una década,
creyendo que conocen muy bien cómo funciona el desarrollo de software y sin
pensar ni por un segundo que el problema de un proyecto pueden ser ellos mismos.`,k,me,tt="Tratamiento para directivos",K,ve,We,Je,ct=`Un directivo (o jefe de proyecto) de software sin nociones técnicas no comprende que el error
es una parte natural de este arte. No comprende que es necesario dedicar el tiempo
...
aún así seguirá siendo necesario la monitorización y seguirá habiendo errores.`,G,Ae,Me=`Un directivo que no comprende los procesos de desarrollo solo ve que el producto
no está cambiando de cara al usuario, no tiene capacidad para saber si los
empleados están haciendo realmente algo o les están mintiendo en su cara mientras
dicen que están mejorando el código.`,_e,Pe,$e=`Aún peor, muchos asumen que si su equipo lleva una semana haciendo refactoring
creen que es porque hicieron cosas mal y que ahora están corrigiendo errores,
...
estado ni el rumbo del proyecto, no le salva ni el delegar porque nunca
podrá comprender el feedback que pueda recibir de la persona en la que delega.`,Q,Ne,vt=`Lo mejor que puede pasar con un directivo así es que delegue completamente y con
fé ciega, pero entonces se acaba dando cuenta de que su papel es
completamente irrelevante, y no solo él se da cuenta de ello. Cuando nadie
necesita un capitán, el capitán solo es un estorbo, un imbécil con autoridad
que además suele cobrar más.`,ce,qe,At=`Pero cuando no delegan es mucho peor, ya no solo son dispensables, entorpecen a
todo el equipo, fomentan malas prácticas por exigir resultados visibles cuanto
antes y generan una fuerte sensación de impotencia, ansiedad y estancamiento
profesional en todos los desarrolladores. Por no decir que no suelen asumir ni una
sola de las responsabilidades que deben asumir como directivos de un proyecto
de software, porque la mayoría requiere algunos conocimientos técnicos base.`,se,B,Ye=`Por suerte, hasta ahora todos los directivos con los que he llegado a toparme
en mi actividad han podido comprender la importancia y los problemas que
supone su incompetencia técnica, y todos han podido ver los errores y tremendas
estupideces que estaban diciendo y cometiendo tras una correcta formación, pero
...
personas que se quejan sin dar soluciones. Es frecuente que sean ellos los que
deban decir “hasta aquí” y zanjar asuntos aún ante el descontento de alguien, y
esto acaba por generar conductas a veces algo poco empáticas.`,le,re,ae=`Una postura típica es considerar que los conocimientos técnicos no son parte
...
y acercarse a la realidad de sus empleados a cargo.`,ze,Be,V=`El trabajo de un
consultor cuando debe tratar con directivos se acerca a partes iguales al de
consejero real y al de dom/dominatrix: tener la sutileza para provocar cambios
sin cuestionar su autoridad delante del equipo, y tener la firmeza para darle
algunos latigazos en privado cuando sea necesario, a lo que suelen estar
sorprendentemente dispuestos, especialmente cuando son ellos los que han pagado
por tu servicio para mejorar la situación laboral.`,he,W,Re="El miedo a mostrar código y al juicio ajeno",it,ft,zt=`Establezco una regla muy directa en mi trabajo: no expongo a nadie, o no por la
...
y menos distracciones, también se evita realizar tantas malas prácticas.`,D,xe,ni=`Solo hay que evitar el error común de imponer esta práctica en toda la jornada,
...
funcionar.`,$s;return ve=new ti({props:{$$slots:{default:[cx]},$$scope:{ctx:i}}}),{c(){e=x("p"),e.innerHTML=t,n=y(),a=x("p"),a.textContent=s,c=y(),l=x("p"),l.textContent=u,d=y(),p=x("h2"),p.textContent=g,f=y(),v=x("p"),v.textContent=E,C=y(),h=x("p"),h.textContent=m,R=y(),w=x("h3"),w.textContent=I,j=y(),U=x("p"),U.textContent=z,F=y(),T=x("p"),T.textContent=A,O=y(),$=x("p"),$.textContent=J,Y=y(),ne=x("p"),ne.innerHTML=oe,de=y(),Z=x("p"),Z.textContent=Ue,ie=y(),ge=x("p"),ge.textContent=Xe,ke=y(),te=x("h3"),te.textContent=Ce,Le=y(),Te=x("p"),Te.textContent=He,ue=y(),we=x("p"),we.textContent=at,q=y(),Ze=x("p"),Ze.textContent=nt,Ve=y(),Ie=x("p"),Ie.textContent=st,Fe=y(),Oe=x("p"),Oe.textContent=N,_=y(),H=x("p"),H.textContent=ye,fe=y(),pe=x("p"),pe.textContent=je,Ee=y(),De=x("p"),De.textContent=Ke,k=y(),me=x("h2"),me.textContent=tt,K=y(),Mt(ve.$$.fragment),We=y(),Je=x("p"),Je.textContent=ct,G=y(),Ae=x("p"),Ae.textContent=Me,_e=y(),Pe=x("p"),Pe.textContent=$e,Qe=y(),lt=x("p"),lt.textContent=ut,et=y(),dt=x("p"),dt.textContent=pt,Q=y(),Ne=x("p"),Ne.textContent=vt,ce=y(),qe=x("p"),qe.textContent=At,se=y(),B=x("p"),B.textContent=Ye,Nt=y(),qt=x("p"),qt.textContent=cn,Vt=y(),P=x("p"),P.textContent=ee,le=y(),re=x("p"),re.textContent=ae,ze=y(),Be=x("p"),Be.textContent=V,he=y(),W=x("h2"),W.textContent=Re,it=y(),ft=x("p"),ft.textContent=zt,Rt=y(),Bt=x("p"),Bt.textContent=wt,rt=y(),Ut=x("h3"),Ut.textContent=xt,jt=y(),Ht=x("p"),Ht.textContent=Qt,un=y(),bt=x("p"),bt.textContent=hn,dn=y(),Ft=x("p"),Ft.textContent=Vn,mn=y(),Wt=x("p"),Wt.textContent=Di,Dn=y(),Kt=x("p"),Kt.textContent=Ui,Un=y(),Jt=x("h2"),Jt.textContent=Ii,In=y(),X=x("p"),X.textContent=Ge,Gn=y(),_n=x("p"),_n.textContent=ss,di=y(),xn=x("p"),xn.textContent=os,pi=y(),bn=x("h3"),bn.textContent=rs,fi=y(),yn=x("p"),yn.textContent=ls,hi=y(),Mn=x("p"),Mn.textContent=cs,mi=y(),Sn=x("p"),Sn.textContent=us,vi=y(),Cn=x("p"),Cn.textContent=ds,gi=y(),En=x("p"),En.innerHTML=ps,_i=y(),Tn=x("p"),Tn.innerHTML=fs,xi=y(),An=x("p"),An.textContent=hs,bi=y(),wn=x("p"),wn.textContent=ms,yi=y(),Pn=x("p"),Pn.textContent=$i,D=y(),xe=x("p"),xe.textContent=ni,Xi=y(),ii=x("h3"),ii.textContent=vs,Yi=y(),ai=x("p"),ai.textContent=gs,Zi=y(),si=x("p"),si.textContent=_s,Ns=y(),Ki=x("p"),Ki.textContent=vl,qs=y(),Ji=x("h3"),Ji.textContent=gl,Fs=y(),Qi=x("p"),Qi.textContent=_l,Os=y(),ea=x("p"),ea.textContent=xl,zs=y(),ta=x("p"),ta.textContent=bl,Bs=y(),na=x("p"),na.textContent=yl,Hs=y(),ia=x("p"),ia.textContent=Ml,ks=y(),aa=x("p"),aa.textContent=Sl,Vs=y(),sa=x("p"),sa.textContent=Cl,Gs=y(),oa=x("p"),oa.textContent=El,js=y(),ra=x("p"),ra.textContent=Tl,Ws=y(),la=x("p"),la.textContent=Al},l(L){e=b(L,"P",{"data-svelte-h":!0}),S(e)!=="svelte-1pq7vyw"&&(e.innerHTML=t),n=M(L),a=b(L,"P",{"data-svelte-h":!0}),S(a)!=="svelte-abxeo0"&&(a.textContent=s),c=M(L),l=b(L,"P",{"data-svelte-h":!0}),S(l)!=="svelte-mqtgny"&&(l.textContent=u),d=M(L),p=b(L,"H2",{"data-svelte-h":!0}),S(p)!=="svelte-1j7xnh3"&&(p.textContent=g),f=M(L),v=b(L,"P",{"data-svelte-h":!0}),S(v)!=="svelte-yxjwvv"&&(v.textContent=E),C=M(L),h=b(L,"P",{"data-svelte-h":!0}),S(h)!=="svelte-1u70d73"&&(h.textContent=m),R=M(L),w=b(L,"H3",{"data-svelte-h":!0}),S(w)!=="svelte-1m6w651"&&(w.textContent=I),j=M(L),U=b(L,"P",{"data-svelte-h":!0}),S(U)!=="svelte-1ilp7u3"&&(U.textContent=z),F=M(L),T=b(L,"P",{"data-svelte-h":!0}),S(T)!=="svelte-1e17jd4"&&(T.textContent=A),O=M(L),$=b(L,"P",{"data-svelte-h":!0}),S($)!=="svelte-1hwpnf5"&&($.textContent=J),Y=M(L),ne=b(L,"P",{"data-svelte-h":!0}),S(ne)!=="svelte-yxfdwh"&&(ne.innerHTML=oe),de=M(L),Z=b(L,"P",{"data-svelte-h":!0}),S(Z)!=="svelte-b22wq9"&&(Z.textContent=Ue),ie=M(L),ge=b(L,"P",{"data-svelte-h":!0}),S(ge)!=="svelte-1wtdicu"&&(ge.textContent=Xe),ke=M(L),te=b(L,"H3",{"data-svelte-h":!0}),S(te)!=="svelte-1nvx6i9"&&(te.textContent=Ce),Le=M(L),Te=b(L,"P",{"data-svelte-h":!0}),S(Te)!=="svelte-1f5x6pb"&&(Te.textContent=He),ue=M(L),we=b(L,"P",{"data-svelte-h":!0}),S(we)!=="svelte-1x1p4km"&&(we.textContent=at),q=M(L),Ze=b(L,"P",{"data-svelte-h":!0}),S(Ze)!=="svelte-9jnm7l"&&(Ze.textContent=nt),Ve=M(L),Ie=b(L,"P",{"data-svelte-h":!0}),S(Ie)!=="svelte-1a30uqh"&&(Ie.textContent=st),Fe=M(L),Oe=b(L,"P",{"data-svelte-h":!0}),S(Oe)!=="svelte-kxw3c"&&(Oe.textContent=N),_=M(L),H=b(L,"P",{"data-svelte-h":!0}),S(H)!=="svelte-88ec34"&&(H.textContent=ye),fe=M(L),pe=b(L,"P",{"data-svelte-h":!0}),S(pe)!=="svelte-b0jvnw"&&(pe.textContent=je),Ee=M(L),De=b(L,"P",{"data-svelte-h":!0}),S(De)!=="svelte-t0fih4"&&(De.textContent=Ke),k=M(L),me=b(L,"H2",{"data-svelte-h":!0}),S(me)!=="svelte-pcnb56"&&(me.textContent=tt),K=M(L),St(ve.$$.fragment,L),We=M(L),Je=b(L,"P",{"data-svelte-h":!0}),S(Je)!=="svelte-159kbjq"&&(Je.textContent=ct),G=M(L),Ae=b(L,"P",{"data-svelte-h":!0}),S(Ae)!=="svelte-99tjnl"&&(Ae.textContent=Me),_e=M(L),Pe=b(L,"P",{"data-svelte-h":!0}),S(Pe)!=="svelte-l9x7lv"&&(Pe.textContent=$e),Qe=M(L),lt=b(L,"P",{"data-svelte-h":!0}),S(lt)!=="svelte-1kethm3"&&(lt.textContent=ut),et=M(L),dt=b(L,"P",{"data-svelte-h":!0}),S(dt)!=="svelte-8qowcd"&&(dt.textContent=pt),Q=M(L),Ne=b(L,"P",{"data-svelte-h":!0}),S(Ne)!=="svelte-oa0pwp"&&(Ne.textContent=vt),ce=M(L),qe=b(L,"P",{"data-svelte-h":!0}),S(qe)!=="svelte-11i1gv6"&&(qe.textContent=At),se=M(L),B=b(L,"P",{"data-svelte-h":!0}),S(B)!=="svelte-yml7fg"&&(B.textContent=Ye),Nt=M(L),qt=b(L,"P",{"data-svelte-h":!0}),S(qt)!=="svelte-1kgj6vx"&&(qt.textContent=cn),Vt=M(L),P=b(L,"P",{"data-svelte-h":!0}),S(P)!=="svelte-1khq7r0"&&(P.textContent=ee),le=M(L),re=b(L,"P",{"data-svelte-h":!0}),S(re)!=="svelte-nfhhac"&&(re.textContent=ae),ze=M(L),Be=b(L,"P",{"data-svelte-h":!0}),S(Be)!=="svelte-tlkjpl"&&(Be.textContent=V),he=M(L),W=b(L,"H2",{"data-svelte-h":!0}),S(W)!=="svelte-mspdjd"&&(W.textContent=Re),it=M(L),ft=b(L,"P",{"data-svelte-h":!0}),S(ft)!=="svelte-1i64b7z"&&(ft.textContent=zt),Rt=M(L),Bt=b(L,"P",{"data-svelte-h":!0}),S(Bt)!=="svelte-ox7h5v"&&(Bt.textContent=wt),rt=M(L),Ut=b(L,"H3",{"data-svelte-h":!0}),S(Ut)!=="svelte-1mfbf1j"&&(Ut.textContent=xt),jt=M(L),Ht=b(L,"P",{"data-svelte-h":!0}),S(Ht)!=="svelte-1cg3q6t"&&(Ht.textContent=Qt),un=M(L),bt=b(L,"P",{"data-svelte-h":!0}),S(bt)!=="svelte-12rk8x8"&&(bt.textContent=hn),dn=M(L),Ft=b(L,"P",{"data-svelte-h":!0}),S(Ft)!=="svelte-1np96pv"&&(Ft.textContent=Vn),mn=M(L),Wt=b(L,"P",{"data-svelte-h":!0}),S(Wt)!=="svelte-15kxlz3"&&(Wt.textContent=Di),Dn=M(L),Kt=b(L,"P",{"data-svelte-h":!0}),S(Kt)!=="svelte-1qwsq7u"&&(Kt.textContent=Ui),Un=M(L),Jt=b(L,"H2",{"data-svelte-h":!0}),S(Jt)!=="svelte-1p3a73p"&&(Jt.textContent=Ii),In=M(L),X=b(L,"P",{"data-svelte-h":!0}),S(X)!=="svelte-19yh2ox"&&(X.textContent=Ge),Gn=M(L),_n=b(L,"P",{"data-svelte-h":!0}),S(_n)!=="svelte-lc891x"&&(_n.textContent=ss),di=M(L),xn=b(L,"P",{"data-svelte-h":!0}),S(xn)!=="svelte-absoyy"&&(xn.textContent=os),pi=M(L),bn=b(L,"H3",{"data-svelte-h":!0}),S(bn)!=="svelte-1k48gpz"&&(bn.textContent=rs),fi=M(L),yn=b(L,"P",{"data-svelte-h":!0}),S(yn)!=="svelte-p03p28"&&(yn.textContent=ls),hi=M(L),Mn=b(L,"P",{"data-svelte-h":!0}),S(Mn)!=="svelte-1p619ai"&&(Mn.textContent=cs),mi=M(L),Sn=b(L,"P",{"data-svelte-h":!0}),S(Sn)!=="svelte-ywz4kq"&&(Sn.textContent=us),vi=M(L),Cn=b(L,"P",{"data-svelte-h":!0}),S(Cn)!=="svelte-1279eml"&&(Cn.textContent=ds),gi=M(L),En=b(L,"P",{"data-svelte-h":!0}),S(En)!=="svelte-c5j9dk"&&(En.innerHTML=ps),_i=M(L),Tn=b(L,"P",{"data-svelte-h":!0}),S(Tn)!=="svelte-uple9a"&&(Tn.innerHTML=fs),xi=M(L),An=b(L,"P",{"data-svelte-h":!0}),S(An)!=="svelte-1gem8j1"&&(An.textContent=hs),bi=M(L),wn=b(L,"P",{"data-svelte-h":!0}),S(wn)!=="svelte-1os79ly"&&(wn.textContent=ms),yi=M(L),Pn=b(L,"P",{"data-svelte-h":!0}),S(Pn)!=="svelte-13v7s8d"&&(Pn.textContent=$i),D=M(L),xe=b(L,"P",{"data-svelte-h":!0}),S(xe)!=="svelte-ny6vqa"&&(xe.textContent=ni),Xi=M(L),ii=b(L,"H3",{"data-svelte-h":!0}),S(ii)!=="svelte-qy87mf"&&(ii.textContent=vs),Yi=M(L),ai=b(L,"P",{"data-svelte-h":!0}),S(ai)!=="svelte-n6i6w7"&&(ai.textContent=gs),Zi=M(L),si=b(L,"P",{"data-svelte-h":!0}),S(si)!=="svelte-1h0m0ej"&&(si.textContent=_s),Ns=M(L),Ki=b(L,"P",{"data-svelte-h":!0}),S(Ki)!=="svelte-19dp3u7"&&(Ki.textContent=vl),qs=M(L),Ji=b(L,"H3",{"data-svelte-h":!0}),S(Ji)!=="svelte-15fddhw"&&(Ji.textContent=gl),Fs=M(L),Qi=b(L,"P",{"data-svelte-h":!0}),S(Qi)!=="svelte-sr6kct"&&(Qi.textContent=_l),Os=M(L),ea=b(L,"P",{"data-svelte-h":!0}),S(ea)!=="svelte-a3sp9u"&&(ea.textContent=xl),zs=M(L),ta=b(L,"P",{"data-svelte-h":!0}),S(ta)!=="svelte-1gjch7e"&&(ta.textContent=bl),Bs=M(L),na=b(L,"P",{"data-svelte-h":!0}),S(na)!=="svelte-1wwy3oo"&&(na.textContent=yl),Hs=M(L),ia=b(L,"P",{"data-svelte-h":!0}),S(ia)!=="svelte-1bvhbmc"&&(ia.textContent=Ml),ks=M(L),aa=b(L,"P",{"data-svelte-h":!0}),S(aa)!=="svelte-jd2b3q"&&(aa.textContent=Sl),Vs=M(L),sa=b(L,"P",{"data-svelte-h":!0}),S(sa)!=="svelte-1dk0rdk"&&(sa.textContent=Cl),Gs=M(L),oa=b(L,"P",{"data-svelte-h":!0}),S(oa)!=="svelte-lon14c"&&(oa.textContent=El),js=M(L),ra=b(L,"P",{"data-svelte-h":!0}),S(ra)!=="svelte-1bfitb4"&&(ra.textContent=Tl),Ws=M(L),la=b(L,"P",{"data-svelte-h":!0}),S(la)!=="svelte-15kh5zk"&&(la.textContent=Al)},m(L,Se){r(L,e,Se),r(L,n,Se),r(L,a,Se),r(L,c,Se),r(L,l,Se),r(L,d,Se),r(L,p,Se),r(L,f,Se),r(L,v,Se),r(L,C,Se),r(L,h,Se),r(L,R,Se),r(L,w,Se),r(L,j,Se),r(L,U,Se),r(L,F,Se),r(L,T,Se),r(L,O,Se),r(L,$,Se),r(L,Y,Se),r(L,ne,Se),r(L,de,Se),r(L,Z,Se),r(L,ie,Se),r(L,ge,Se),r(L,ke,Se),r(L,te,Se),r(L,Le,Se),r(L,Te,Se),r(L,ue,Se),r(L,we,Se),r(L,q,Se),r(L,Ze,Se),r(L,Ve,Se),r(L,Ie,Se),r(L,Fe,Se),r(L,Oe,Se),r(L,_,Se),r(L,H,Se),r(L,fe,Se),r(L,pe,Se),r(L,Ee,Se),r(L,De,Se),r(L,k,Se),r(L,me,Se),r(L,K,Se),Ct(ve,L,Se),r(L,We,Se),r(L,Je,Se),r(L,G,Se),r(L,Ae,Se),r(L,_e,Se),r(L,Pe,Se),r(L,Qe,Se),r(L,lt,Se),r(L,et,Se),r(L,dt,Se),r(L,Q,Se),r(L,Ne,Se),r(L,ce,Se),r(L,qe,Se),r(L,se,Se),r(L,B,Se),r(L,Nt,Se),r(L,qt,Se),r(L,Vt,Se),r(L,P,Se),r(L,le,Se),r(L,re,Se),r(L,ze,Se),r(L,Be,Se),r(L,he,Se),r(L,W,Se),r(L,it,Se),r(L,ft,Se),r(L,Rt,Se),r(L,Bt,Se),r(L,rt,Se),r(L,Ut,Se),r(L,jt,Se),r(L,Ht,Se),r(L,un,Se),r(L,bt,Se),r(L,dn,Se),r(L,Ft,Se),r(L,mn,Se),r(L,Wt,Se),r(L,Dn,Se),r(L,Kt,Se),r(L,Un,Se),r(L,Jt,Se),r(L,In,Se),r(L,X,Se),r(L,Gn,Se),r(L,_n,Se),r(L,di,Se),r(L,xn,Se),r(L,pi,Se),r(L,bn,Se),r(L,fi,Se),r(L,yn,Se),r(L,hi,Se),r(L,Mn,Se),r(L,mi,Se),r(L,Sn,Se),r(L,vi,Se),r(L,Cn,Se),r(L,gi,Se),r(L,En,Se),r(L,_i,Se),r(L,Tn,Se),r(L,xi,Se),r(L,An,Se),r(L,bi,Se),r(L,wn,Se),r(L,yi,Se),r(L,Pn,Se),r(L,D,Se),r(L,xe,Se),r(L,Xi,Se),r(L,ii,Se),r(L,Yi,Se),r(L,ai,Se),r(L,Zi,Se),r(L,si,Se),r(L,Ns,Se),r(L,Ki,Se),r(L,qs,Se),r(L,Ji,Se),r(L,Fs,Se),r(L,Qi,Se),r(L,Os,Se),r(L,ea,Se),r(L,zs,Se),r(L,ta,Se),r(L,Bs,Se),r(L,na,Se),r(L,Hs,Se),r(L,ia,Se),r(L,ks,Se),r(L,aa,Se),r(L,Vs,Se),r(L,sa,Se),r(L,Gs,Se),r(L,oa,Se),r(L,js,Se),r(L,ra,Se),r(L,Ws,Se),r(L,la,Se),$s=!0},p(L,[Se]){const wl={};Se&1&&(wl.$$scope={dirty:Se,ctx:L}),ve.$set(wl)},i(L){$s||(ht(ve.$$.fragment,L),$s=!0)},o(L){mt(ve.$$.fragment,L),$s=!1},d(L){L&&(o(e),o(n),o(a),o(c),o(l),o(d),o(p),o(f),o(v),o(C),o(h),o(R),o(w),o(j),o(U),o(F),o(T),o(O),o($),o(Y),o(ne),o(de),o(Z),o(ie),o(ge),o(ke),o(te),o(Le),o(Te),o(ue),o(we),o(q),o(Ze),o(Ve),o(Ie),o(Fe),o(Oe),o(_),o(H),o(fe),o(pe),o(Ee),o(De),o(k),o(me),o(K),o(We),o(Je),o(G),o(Ae),o(_e),o(Pe),o(Qe),o(lt),o(et),o(dt),o(Q),o(Ne),o(ce),o(qe),o(se),o(B),o(Nt),o(qt),o(Vt),o(P),o(le),o(re),o(ze),o(Be),o(he),o(W),o(it),o(ft),o(Rt),o(Bt),o(rt),o(Ut),o(jt),o(Ht),o(un),o(bt),o(dn),o(Ft),o(mn),o(Wt),o(Dn),o(Kt),o(Un),o(Jt),o(In),o(X),o(Gn),o(_n),o(di),o(xn),o(pi),o(bn),o(fi),o(yn),o(hi),o(Mn),o(mi),o(Sn),o(vi),o(Cn),o(gi),o(En),o(_i),o(Tn),o(xi),o(An),o(bi),o(wn),o(yi),o(Pn),o(D),o(xe),o(Xi),o(ii),o(Yi),o(ai),o(Zi),o(si),o(Ns),o(Ki),o(qs),o(Ji),o(Fs),o(Qi),o(Os),o(ea),o(zs),o(ta),o(Bs),o(na),o(Hs),o(ia),o(ks),o(aa),o(Vs),o(sa),o(Gs),o(oa),o(js),o(ra),o(Ws),o(la)),Et(ve,L)}}}const dx={title:"Relaciones interpersonales en la consultoría",slug:"relaciones-interpersonales-consultoria",coverImage:"/src/assets/posts-covers/mono-espejo.jpg",coverPosition:"normal",coverAuthor:"Pedro Lastra",excerpt:"Un análisis sobre la consultoría y la formación a directivos de software.",date:"2024-09-05T13:06:23.177Z",updated:"2024-09-05T13:06:23.903Z",hidden:!0,tags:["Personal","Laboral","Consultoría"],keywords:["trabajo","consultor","consultoría"],type:"default"};class px extends Yt{constructor(e){super(),Zt(this,e,null,ux,Xt,{})}}const fx=Object.freeze(Object.defineProperty({__proto__:null,default:px,metadata:dx},Symbol.toStringTag,{value:"Module"}));function hx(i){let e;return{c(){e=gt("Por si para alguien es importante que lo recalque, cuando digo directivo digo también directiva/e.")},l(t){e=_t(t,"Por si para alguien es importante que lo recalque, cuando digo directivo digo también directiva/e.")},m(t,n){r(t,e,n)},d(t){t&&o(e)}}}function mx(i){let e,t=`Siempre es una buena señal y honra a una persona el que entienda que hay
...
algo, planificarlo y hacerlo “bien”, no comprenden la naturaleza del error, la
deuda técnica, la flexibilidad y dinamismo que debe
haber en los procesos de desarrollo.`,oe,de,Z=`Un directivo así solo mete presiones y no tiene capacidad para determinar el
estado ni el rumbo del proyecto, no le salva ni el delegar porque nunca
podrá comprender el feedback que pueda recibir de la persona en la que delega.`,Ue,ie,ge=`Lo mejor que puede pasar con un directivo así es que delegue completamente y con
...
completamente irrelevante, y no solo él se da cuenta de ello. Cuando nadie
necesita un capitán, el capitán solo es un estorbo, un imbécil con autoridad
que además suele cobrar más.`,Xe,ke,te=`Pero cuando no delegan es mucho peor. No solo son dispensables, también entorpecen a
todo el equipo, fomentan malas prácticas por exigir resultados visibles cuanto
antes y generan una fuerte sensación de impotencia, ansiedad y estancamiento
...
de software, porque muchas requieren algunos conocimientos técnicos base.`,Ce,Le,Te="Tratando con directivos",He,ue,we=`Por suerte, hasta ahora todos los directivos con los que he llegado a toparme
...
serio ese “poder” y a veces demasiado tiempo.`,nt,Ve,Ie=`Es muy frecuente que en su trayectoria profesional hayan comido discusiones muy absurdas con
personas que se quejan sin dar soluciones. Es frecuente que sean ellos los que
...
cabezotas, también algo menos empáticos.`,st,Fe,Oe=`Una postura típica es considerar que los conocimientos técnicos no son parte
...
algunos latigazos en privado cuando sea necesario, a lo que suelen estar
sorprendentemente dispuestos, especialmente cuando son ellos los que han pagado
por tu servicio para mejorar la situación laboral.`,ye,fe,pe=`Por lo demás, no se aleja de trabajar junto a cualquier otro miembro de la
...
mínimo no sienta que está leyendo chino al ver código.`,je,Ee,De=`Por otra parte, es un buen trabajo de empatía, porque muchos saben que sus
...
complejidad de un ejercicio de introducción de una FP.`,Ke,k,me=`También ayuda a acercarse a la realidad de la explosión tecnológica, saber
